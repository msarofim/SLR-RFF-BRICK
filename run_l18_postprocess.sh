...
## started while the chains are still running.  bash run_l18_postprocess.sh
##
...
T=L18
LOG=outputs/log_l18_postprocess_driver.txt
...
: > "$LOG"
say "waiting for the L18 chains to finish..."
...
say "  EXPECT amp ~ N(1.090, 0.180); four DISTINCT over-dispersed starts ~ +222..+229;"
say "  EXPECT [MAP start = -644.51] — the SAME objective as L16/L17. If it differs, STOP."
...
say "       near L14  0.531 / 0.406 / 0.949  => the START was the confound"
say "       near L16MID 0.815 / 1.601 / 1.908 => the AMP PRIOR is the lever (provenance call)"
