...
| ar1_prof | Ladrillo L24 | 58 | 246.1 | 227.6 | -376.1 | -360.7 | -131.4 |
...
- **ar1_prof**: Δln L (Ladrillo − BRICK 2.0) = **97.8** for Δk = 23. ΔAIC (BRICK − Ladrillo) = **149.7**, ΔBIC = **52.7**. The likelihood gain is worth 98 parameters under AIC and 31 under BIC (ln N = 6.22); Ladrillo has 23 more.
...
|---|---|---|---|---|---|---|---|
| ais | 120.6 | 0.013 | 0.764 | 110.5 | 0.024 | 0.950 | 10.1 |
| gsic | 8.5 | 0.000 | 0.121 | -44.4 | 0.169 | 0.950 | 52.9 |
| gis | 110.2 | 0.015 | 0.937 | 75.1 | 0.065 | 0.950 | 35.1 |
| steric | 6.8 | 0.091 | 0.950 | 7.0 | 0.090 | 0.950 | -0.3 |
...
| ar1_prof | -163.4 | -166.3 | -165.3 | -183.1 |
