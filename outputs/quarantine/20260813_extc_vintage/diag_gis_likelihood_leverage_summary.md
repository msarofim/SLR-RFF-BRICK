...
| dang | 1900-2024 | 125 | 0.453 | 1.3 | **47.09** | 0.068 | 2.021 |
...
| dang | step | 2.34 | 2.34 | 748.62 | 1x |
| dang | ramp | 0.82 | 0.83 | 258.24 | 1x |
...
Net over both channels: **+14.38 log-likelihood units** in favour of the Greenland correction.

Net log-likelihood available to the Greenland fix, as calibrated: **+27.71** gained on gis against **-2.34** paid on dang = **+25.37 net** (step), **+6.71 net** (smooth ramp).
