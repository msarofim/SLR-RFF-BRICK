# Ladrillo benchmark — `L29`

*benchmark v1.0, 2026-09-22, repo `a539557`. Champion arm: **L27**.*
...
|---|---|---|---|---|---|
| **AIS** | WARN | UNRESOLVED | WARN | WARN | WORSE |
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L29 | 0.2433 | 1.45 | bias -0.1778 cm = -1.06 sd; cov90 39%; n=126 |
...
| AIS | 0.1674 | 1920-1949 | L29 | 0.3092 | 1.85 | bias -0.3050 cm = -1.82 sd; cov90 0%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L29 | 0.1073 | 0.64 | bias -0.0725 cm = -0.43 sd; cov90 70%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L29 | 0.0865 | 0.52 | bias -0.0416 cm = -0.25 sd; cov90 48%; n=33 |
...
| glaciers | 0.4593 | full | L29 | 0.3181 | 0.69 | bias +0.0586 cm = +0.13 sd; cov90 69%; n=124 |
...
| glaciers | 0.4593 | 1920-1949 | L29 | 0.1822 | 0.40 | bias -0.0057 cm = -0.01 sd; cov90 100%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L29 | 0.2317 | 0.50 | bias -0.1181 cm = -0.26 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L29 | 0.0456 | 0.10 | bias -0.0204 cm = -0.04 sd; cov90 39%; n=31 |
...
| Greenland | 0.1832 | full | L29 | 0.1963 | 1.07 | bias -0.1446 cm = -0.79 sd; cov90 35%; n=126 |
...
| Greenland | 0.1832 | 1920-1949 | L29 | 0.2003 | 1.09 | bias -0.1547 cm = -0.84 sd; cov90 60%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L29 | 0.2681 | 1.46 | bias -0.2498 cm = -1.36 sd; cov90 0%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L29 | 0.1232 | 0.67 | bias -0.0836 cm = -0.46 sd; cov90 18%; n=33 |
...
| thermal exp. | 0.3091 | full | L29 | 0.4638 | 1.50 | bias +0.2606 cm = +0.84 sd; cov90 40%; n=126 |
...
| thermal exp. | 0.3091 | 1920-1949 | L29 | 0.6108 | 1.98 | bias +0.4881 cm = +1.58 sd; cov90 37%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L29 | 0.1966 | 0.64 | bias -0.0588 cm = -0.19 sd; cov90 70%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L29 | 0.3809 | 1.23 | bias +0.2485 cm = +0.80 sd; cov90 18%; n=33 |
...
| TOTAL | 1.5380 | full | L29 | 0.3235 | 0.21 | bias -0.0017 cm = -0.00 sd; cov90 80%; n=125 |
...
| TOTAL | 1.5380 | 1920-1949 | L29 | 0.3668 | 0.24 | bias -0.1290 cm = -0.08 sd; cov90 97%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L29 | 0.2839 | 0.18 | bias -0.1243 cm = -0.08 sd; cov90 91%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L29 | 0.3571 | 0.23 | bias +0.1813 cm = +0.12 sd; cov90 38%; n=32 |
...
| AIS | rate | L29 | 0.03865 | cm/yr | -0.56 | 0.92x obs; z=-0.56 vs the obs error bar |
...
| glaciers | rate | L29 | 0.066754 | cm/yr | -0.14 | 0.98x obs; z=-0.14 vs the obs error bar |
...
| Greenland | rate | L29 | 0.058784 | cm/yr | -0.69 | 0.89x obs; z=-0.69 vs the obs error bar |
...
| TOTAL | rate | L29 | 0.34782 | cm/yr | +0.78 | 1.07x obs; z=+0.78 vs the obs error bar |
...
| AIS | accel | L29 | 0.00022628 | cm/yr2 | -0.34 | ratio NOT INTERPRETABLE (obs is 1.21 se from zero); z=-0.34 vs the obs error bar |
...
| glaciers | accel | L29 | -0.00016404 | cm/yr2 | +0.86 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.86 vs the obs error bar |
...
| Greenland | accel | L29 | -0.0001308 | cm/yr2 | +0.28 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.28 vs the obs error bar |
...
| thermal exp. | accel | L29 | 0.0012419 | cm/yr2 | +1.64 | 1.47x obs; z=+1.64 vs the obs error bar |
...
| TOTAL | accel | L29 | 0.0013487 | cm/yr2 | +0.39 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.39 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.618 x lit median | **PASS** | ours 5.58 cm vs lit 3.66-11.93 (median 9.04), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.93] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 1.843 x lit spread | **PASS** | ours 39.44 cm vs model-based lit 20.72-40.49 (median 21.40, n=5); ALL comparators 20.72-105.01 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.584 x lit median | **PASS** | ours 8.57 cm vs lit 5.34-24.01 (median 14.67), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.485 x lit spread | **PASS** | ours 77.40 cm vs model-based lit 33.17-71.04 (median 52.10, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp126 | 2300 | median_vs_lit | 1.946 x lit median | **WARN** | ours 16.94 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 2.642 x lit spread | **WARN** | ours 183.86 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 0.773 x lit median | **PASS** | ours 8.11 cm vs lit 5.22-12.17 (median 10.49), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.22-12.17] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.486 x lit spread | **PASS** | ours 53.21 cm vs model-based lit 20.77-42.39 (median 35.81, n=5); ALL comparators 20.77-113.21 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.260 x lit median | **WARN** | ours 34.41 cm vs lit 27.21-27.41 (median 27.31), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.339 x lit spread | **PASS** | ours 114.39 cm vs model-based lit 80.10-90.72 (median 85.41, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp245 | 2300 | median_vs_lit | 1.709 x lit median | **WARN** | ours 142.66 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.155 x lit spread | **PASS** | ours 313.71 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 2.694 x lit median | **PASS** | ours 35.55 cm vs lit 4.30-39.10 (median 13.20), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 4.30-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.265 x lit spread | **PASS** | ours 65.02 cm vs model-based lit 20.71-79.00 (median 51.40, n=5); ALL comparators 20.71-126.10; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 0.950 x lit median | **PASS** | ours 89.26 cm vs lit 34.31-153.62 (median 93.97), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.528 x lit spread | **PASS** | ours 106.03 cm vs model-based lit 125.28-276.23 (median 200.75, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.012 x lit median | **PASS** | ours 276.27 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.313 x lit spread | **WARN** | ours 295.68 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.638 x lit spread | **PASS** | ours 4.93 cm vs model-based lit 7.12-10.06 (median 7.74, n=3) |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.568 x lit spread | **PASS** | ours 6.81 cm vs model-based lit 8.52-15.46 (median 11.99, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.685 x lit median | **WARN** | ours 12.54 cm vs lit 13.80-22.85 (median 18.33), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.595 x lit spread | **PASS** | ours 9.68 cm vs model-based lit 11.23-21.30 (median 16.26, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.667 x lit spread | **PASS** | ours 5.58 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.594 x lit spread | **PASS** | ours 8.60 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.682 x lit median | **WARN** | ours 18.09 cm vs lit 21.47-31.57 (median 26.52), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 0.946 x lit spread | **PASS** | ours 11.96 cm vs model-based lit 10.95-14.32 (median 12.63, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.790 x lit spread | **PASS** | ours 7.18 cm vs model-based lit 8.51-14.02 (median 9.10, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.832 x lit median | **WARN** | ours 20.07 cm vs lit 22.03-26.22 (median 24.13), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.778 x lit spread | **PASS** | ours 10.57 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.862 x lit median | **WARN** | ours 26.14 cm vs lit 29.10-31.57 (median 30.34), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 2.313 x lit spread | **WARN** | ours 11.52 cm vs model-based lit 0.13-9.83 (median 4.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2100 | median_vs_lit | 0.980 x lit median | **WARN** | ours 6.27 cm vs lit 6.36-8.31 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 6.36-13.80] |
...
| Greenland | ssp126 | 2150 | median_vs_lit | 0.898 x lit median | **WARN** | ours 8.36 cm vs lit 9.31-9.31 (median 9.31), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.389 x lit spread | **WARN** | ours 6.10 cm vs model-based lit 15.69-15.69 (median 15.69, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.790 x lit median | **WARN** | ours 11.83 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.397 x lit spread | **WARN** | ours 11.68 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp245 | 2100 | median_vs_lit | 0.792 x lit median | **WARN** | ours 7.36 cm vs lit 8.12-9.59 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 8.12-14.49] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.567 x lit spread | **PASS** | ours 4.73 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.682 x lit median | **WARN** | ours 11.28 cm vs lit 16.53-16.53 (median 16.53), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.674 x lit spread | **PASS** | ours 10.03 cm vs model-based lit 14.88-14.88 (median 14.88, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.510 x lit median | **WARN** | ours 18.24 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.755 x lit spread | **PASS** | ours 30.88 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.806 x lit median | **WARN** | ours 9.85 cm vs lit 11.67-13.49 (median 12.23), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 11.67-17.18] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.669 x lit spread | **PASS** | ours 8.14 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.666 x lit median | **WARN** | ours 21.58 cm vs lit 32.40-32.40 (median 32.40), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.303 x lit spread | **WARN** | ours 27.53 cm vs model-based lit 90.97-90.97 (median 90.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.708 x lit median | **WARN** | ours 79.98 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.156 x lit spread | **WARN** | ours 105.81 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.131 x lit median | **PASS** | ours 15.77 cm vs lit 11.09-16.79 (median 13.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.899 x lit spread | **PASS** | ours 11.75 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.165 x lit median | **PASS** | ours 19.60 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.958 x lit spread | **PASS** | ours 17.20 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.160 x lit median | **PASS** | ours 25.26 cm vs lit 16.74-26.81 (median 21.77), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.040 x lit spread | **PASS** | ours 29.64 cm vs model-based lit 25.47-31.53 (median 28.50, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.055 x lit median | **PASS** | ours 19.94 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.869 x lit spread | **PASS** | ours 13.81 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.081 x lit median | **PASS** | ours 29.21 cm vs lit 23.23-30.82 (median 27.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.853 x lit spread | **PASS** | ours 23.14 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.083 x lit median | **PASS** | ours 45.21 cm vs lit 36.30-47.22 (median 41.76), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.883 x lit spread | **PASS** | ours 47.50 cm vs model-based lit 53.37-54.25 (median 53.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.975 x lit median | **WARN** | ours 27.88 cm vs lit 27.88-29.29 (median 28.59), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.807 x lit spread | **PASS** | ours 18.37 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.988 x lit median | **PASS** | ours 51.39 cm vs lit 49.94-54.12 (median 52.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.810 x lit spread | **PASS** | ours 38.27 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.969 x lit median | **WARN** | ours 103.19 cm vs lit 103.49-109.39 (median 106.44), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.811 x lit spread | **PASS** | ours 97.37 cm vs model-based lit 118.64-121.40 (median 120.02, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.850 x lit median | **PASS** | ours 38.82 cm vs lit 35.59-50.06 (median 45.68), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-55.88] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.180 x lit spread | **PASS** | ours 54.67 cm vs model-based lit 32.73-55.62 (median 46.34, n=7); ALL comparators 32.73-125.52 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 1.119 x lit median | **WARN** | ours 51.38 cm vs lit 45.94-45.94 (median 45.94), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.655 x lit spread | **PASS** | ours 97.60 cm vs model-based lit 58.97-58.97 (median 58.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.149 x lit median | **WARN** | ours 76.37 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 1.876 x lit spread | **PASS** | ours 218.79 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.919 x lit median | **PASS** | ours 50.77 cm vs lit 49.78-58.27 (median 55.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 49.78-67.77] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.257 x lit spread | **PASS** | ours 67.09 cm vs model-based lit 35.22-64.58 (median 53.36, n=7); ALL comparators 35.22-151.34 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.058 x lit median | **WARN** | ours 93.21 cm vs lit 88.11-88.11 (median 88.11), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.280 x lit spread | **PASS** | ours 138.65 cm vs model-based lit 108.33-108.33 (median 108.33, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.265 x lit median | **WARN** | ours 236.25 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.061 x lit spread | **PASS** | ours 360.43 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.187 x lit median | **PASS** | ours 89.40 cm vs lit 62.39-97.85 (median 75.33), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 62.39-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.169 x lit spread | **PASS** | ours 80.49 cm vs model-based lit 40.46-106.79 (median 68.88, n=7); ALL comparators 40.46-181.04 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.721 x lit median | **WARN** | ours 189.46 cm vs lit 262.93-262.93 (median 262.93), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.366 x lit spread | **WARN** | ours 147.46 cm vs model-based lit 403.38-403.38 (median 403.38, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.488 x lit median | **WARN** | ours 495.99 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.302 x lit spread | **WARN** | ours 415.92 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 5.58 | 4.92 | 4.32 |
| AIS | ssp126 | 2150 | 8.57 | 7.68 | 6.52 |
| AIS | ssp126 | 2300 | 16.94 | 15.23 | 13.01 |
| AIS | ssp245 | 2100 | 8.11 | 10.55 | 27.41 |
| AIS | ssp245 | 2150 | 34.41 | 46.18 | 72.60 |
| AIS | ssp245 | 2300 | 142.66 | 156.34 | 205.94 |
| AIS | ssp585 | 2100 | 35.55 | 36.66 | 44.14 |
| AIS | ssp585 | 2150 | 89.26 | 92.56 | 97.88 |
| AIS | ssp585 | 2300 | 276.27 | 277.71 | 276.83 |
| glaciers | ssp126 | 2100 | 8.13 | 8.11 | 12.09 |
| glaciers | ssp126 | 2150 | 9.98 | 9.93 | 17.44 |
| glaciers | ssp126 | 2300 | 12.54 | 12.48 | 27.72 |
| glaciers | ssp245 | 2100 | 9.72 | 9.72 | 13.34 |
| glaciers | ssp245 | 2150 | 13.39 | 13.41 | 20.69 |
| glaciers | ssp245 | 2300 | 18.09 | 18.06 | 32.50 |
| glaciers | ssp585 | 2100 | 12.88 | 12.91 | 15.61 |
| glaciers | ssp585 | 2150 | 20.07 | 20.17 | 26.25 |
| glaciers | ssp585 | 2300 | 26.14 | 26.14 | 35.36 |
| Greenland | ssp126 | 2100 | 6.27 | 6.23 | 6.62 |
| Greenland | ssp126 | 2150 | 8.36 | 8.30 | 10.01 |
| Greenland | ssp126 | 2300 | 11.83 | 11.72 | 19.04 |
| Greenland | ssp245 | 2100 | 7.36 | 7.31 | 7.03 |
| Greenland | ssp245 | 2150 | 11.28 | 11.18 | 11.35 |
| Greenland | ssp245 | 2300 | 18.24 | 17.89 | 23.71 |
| Greenland | ssp585 | 2100 | 9.85 | 9.84 | 7.88 |
| Greenland | ssp585 | 2150 | 21.58 | 21.49 | 14.77 |
| Greenland | ssp585 | 2300 | 79.98 | 79.49 | 38.60 |
| thermal exp. | ssp126 | 2100 | 15.77 | 15.73 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.60 | 19.40 | 19.18 |
| thermal exp. | ssp126 | 2300 | 25.26 | 25.07 | 25.08 |
| thermal exp. | ssp245 | 2100 | 19.94 | 19.88 | 19.37 |
| thermal exp. | ssp245 | 2150 | 29.21 | 28.99 | 28.53 |
| thermal exp. | ssp245 | 2300 | 45.21 | 44.66 | 44.66 |
| thermal exp. | ssp585 | 2100 | 27.88 | 27.81 | 27.07 |
| thermal exp. | ssp585 | 2150 | 51.39 | 51.39 | 50.34 |
| thermal exp. | ssp585 | 2300 | 103.19 | 102.60 | 101.88 |
...
| TOTAL | ssp126 | 2100 | 38.82 | 38.00 | 41.16 |
| TOTAL | ssp126 | 2150 | 51.38 | 50.28 | 57.89 |
| TOTAL | ssp126 | 2300 | 76.37 | 74.81 | 94.76 |
| TOTAL | ssp245 | 2100 | 50.77 | 52.65 | 70.19 |
| TOTAL | ssp245 | 2150 | 93.21 | 104.85 | 137.98 |
| TOTAL | ssp245 | 2300 | 236.25 | 247.73 | 317.82 |
| TOTAL | ssp585 | 2100 | 89.40 | 90.67 | 98.00 |
| TOTAL | ssp585 | 2150 | 189.46 | 191.21 | 195.15 |
| TOTAL | ssp585 | 2300 | 495.99 | 497.87 | 467.87 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 6.37x | **PASS** | FACTS 0.73-2.10 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 10.41x | **PASS** | FACTS 1.43-1.43 (n=1); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 16.30x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.58x | **PASS** | FACTS 1.43-1.65 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.01x | **CHECK(wide)** | FACTS 1.93-1.93 (n=1); MAGICC-SLR 1.79-1.79 (n=1); 0.08 outside the bracket = 62% of its own range |
...
| Greenland | 2300 | 6.76x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| thermal exp. | 2300 | 4.08x | **PASS** | FACTS 4.08-4.08 (n=1); MAGICC-SLR 6.18-6.18 (n=1) |
...
| TOTAL | 2100 | 2.30x | **PASS** | FACTS 1.44-1.82 (n=7); MAGICC-SLR 2.75-2.75 (n=1) |
| TOTAL | 2150 | 3.69x | **WARN** | MAGICC-SLR 5.72-5.72 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| TOTAL | 2300 | 6.49x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L29.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L29`.*
