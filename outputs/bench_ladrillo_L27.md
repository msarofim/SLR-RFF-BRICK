...
*benchmark v1.0, 2026-09-20, repo `5a27c0b`. Champion arm: **L26**.*
...
| **thermal exp.** | WARN | FAIL | WARN | PASS | WORSE |
...
| glaciers | ssp126 | 2150 | median_vs_lit | 0.768 x lit median | **WARN** | ours 9.93 cm vs lit 12.28-13.60 (median 12.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.561 x lit spread | **PASS** | ours 6.73 cm vs model-based lit 8.52-15.46 (median 11.99, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.681 x lit median | **WARN** | ours 12.48 cm vs lit 13.80-22.85 (median 18.33), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.587 x lit spread | **PASS** | ours 9.55 cm vs model-based lit 11.23-21.30 (median 16.26, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2100 | median_vs_lit | 0.776 x lit median | **WARN** | ours 9.72 cm vs lit 11.22-12.90 (median 12.54), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.669 x lit spread | **PASS** | ours 5.60 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.586 x lit spread | **PASS** | ours 8.49 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.681 x lit median | **WARN** | ours 18.06 cm vs lit 21.47-31.57 (median 26.52), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 0.909 x lit spread | **PASS** | ours 11.48 cm vs model-based lit 10.95-14.32 (median 12.63, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2150 | median_vs_lit | 0.836 x lit median | **WARN** | ours 20.17 cm vs lit 22.03-26.22 (median 24.13), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.741 x lit spread | **PASS** | ours 10.05 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 2.202 x lit spread | **WARN** | ours 10.97 cm vs model-based lit 0.13-9.83 (median 4.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | median_vs_lit | 0.891 x lit median | **WARN** | ours 8.30 cm vs lit 9.31-9.31 (median 9.31), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.383 x lit spread | **WARN** | ours 6.01 cm vs model-based lit 15.69-15.69 (median 15.69, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.783 x lit median | **WARN** | ours 11.72 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.391 x lit spread | **WARN** | ours 11.49 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp245 | 2100 | median_vs_lit | 0.787 x lit median | **WARN** | ours 7.31 cm vs lit 8.12-9.59 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 8.12-14.49] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.563 x lit spread | **PASS** | ours 4.70 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.676 x lit median | **WARN** | ours 11.18 cm vs lit 16.53-16.53 (median 16.53), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.649 x lit spread | **PASS** | ours 9.66 cm vs model-based lit 14.88-14.88 (median 14.88, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.500 x lit median | **WARN** | ours 17.89 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.721 x lit spread | **PASS** | ours 29.50 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.804 x lit median | **WARN** | ours 9.84 cm vs lit 11.67-13.49 (median 12.23), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 11.67-17.18] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.644 x lit spread | **PASS** | ours 7.82 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.290 x lit spread | **WARN** | ours 26.42 cm vs model-based lit 90.97-90.97 (median 90.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.703 x lit median | **WARN** | ours 79.49 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.157 x lit spread | **WARN** | ours 106.99 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.128 x lit median | **PASS** | ours 15.73 cm vs lit 11.09-16.79 (median 13.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.902 x lit spread | **PASS** | ours 11.78 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.153 x lit median | **PASS** | ours 19.40 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.946 x lit spread | **PASS** | ours 16.98 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.151 x lit median | **PASS** | ours 25.07 cm vs lit 16.74-26.81 (median 21.77), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.019 x lit spread | **PASS** | ours 29.05 cm vs model-based lit 25.47-31.53 (median 28.50, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.051 x lit median | **PASS** | ours 19.88 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.855 x lit spread | **PASS** | ours 13.58 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.073 x lit median | **PASS** | ours 28.99 cm vs lit 23.23-30.82 (median 27.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.854 x lit spread | **PASS** | ours 23.18 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.875 x lit spread | **PASS** | ours 47.11 cm vs model-based lit 53.37-54.25 (median 53.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.973 x lit median | **WARN** | ours 27.81 cm vs lit 27.88-29.29 (median 28.59), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.789 x lit spread | **PASS** | ours 17.96 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.796 x lit spread | **PASS** | ours 37.62 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 4.92 | 4.96 | 4.32 |
| AIS | ssp126 | 2150 | 7.68 | 7.71 | 6.52 |
| AIS | ssp126 | 2300 | 15.23 | 15.37 | 13.01 |
| AIS | ssp245 | 2100 | 10.55 | 11.45 | 27.41 |
| AIS | ssp245 | 2150 | 46.18 | 48.37 | 72.60 |
| AIS | ssp245 | 2300 | 156.34 | 164.20 | 205.94 |
| AIS | ssp585 | 2100 | 36.66 | 38.94 | 44.14 |
| AIS | ssp585 | 2150 | 92.56 | 96.91 | 97.88 |
| AIS | ssp585 | 2300 | 277.71 | 292.94 | 276.83 |
| glaciers | ssp126 | 2100 | 8.11 | 8.09 | 12.09 |
| glaciers | ssp126 | 2150 | 9.93 | 9.96 | 17.44 |
| glaciers | ssp126 | 2300 | 12.48 | 12.51 | 27.72 |
| glaciers | ssp245 | 2100 | 9.72 | 9.69 | 13.34 |
| glaciers | ssp245 | 2150 | 13.41 | 13.33 | 20.69 |
| glaciers | ssp245 | 2300 | 18.06 | 17.96 | 32.50 |
| glaciers | ssp585 | 2100 | 12.91 | 12.83 | 15.61 |
| glaciers | ssp585 | 2150 | 20.17 | 20.04 | 26.25 |
| glaciers | ssp585 | 2300 | 26.14 | 26.16 | 35.36 |
| Greenland | ssp126 | 2100 | 6.23 | 6.35 | 6.62 |
| Greenland | ssp126 | 2150 | 8.30 | 8.53 | 10.01 |
| Greenland | ssp126 | 2300 | 11.72 | 12.18 | 19.04 |
| Greenland | ssp245 | 2100 | 7.31 | 7.42 | 7.03 |
| Greenland | ssp245 | 2150 | 11.18 | 11.40 | 11.35 |
| Greenland | ssp245 | 2300 | 17.89 | 18.84 | 23.71 |
| Greenland | ssp585 | 2100 | 9.84 | 9.90 | 7.88 |
| Greenland | ssp585 | 2150 | 21.49 | 21.73 | 14.77 |
| Greenland | ssp585 | 2300 | 79.49 | 81.46 | 38.60 |
| thermal exp. | ssp126 | 2100 | 15.73 | 15.64 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.40 | 19.47 | 19.18 |
| thermal exp. | ssp126 | 2300 | 25.07 | 25.14 | 25.08 |
| thermal exp. | ssp245 | 2100 | 19.88 | 19.77 | 19.37 |
| thermal exp. | ssp245 | 2150 | 28.99 | 28.96 | 28.53 |
| thermal exp. | ssp245 | 2300 | 44.66 | 44.66 | 44.66 |
| thermal exp. | ssp585 | 2100 | 27.81 | 27.65 | 27.07 |
| thermal exp. | ssp585 | 2150 | 51.39 | 51.05 | 50.34 |
| thermal exp. | ssp585 | 2300 | 102.60 | 102.78 | 101.88 |
| land water | ssp126 | 2100 | 2.46 | 2.46 | 2.34 |
| land water | ssp126 | 2150 | 3.96 | 3.96 | 4.04 |
| land water | ssp126 | 2300 | 8.46 | 8.46 | 8.90 |
| land water | ssp245 | 2100 | 2.46 | 2.46 | 2.34 |
| land water | ssp245 | 2150 | 3.96 | 3.96 | 4.04 |
| land water | ssp245 | 2300 | 8.46 | 8.46 | 8.90 |
| land water | ssp585 | 2100 | 2.46 | 2.46 | 2.34 |
| land water | ssp585 | 2150 | 3.96 | 3.96 | 4.04 |
| land water | ssp585 | 2300 | 8.46 | 8.46 | 8.90 |
| TOTAL | ssp126 | 2100 | 38.00 | 38.19 | 41.16 |
| TOTAL | ssp126 | 2150 | 50.28 | 50.74 | 57.89 |
| TOTAL | ssp126 | 2300 | 74.81 | 75.75 | 94.76 |
| TOTAL | ssp245 | 2100 | 52.65 | 53.21 | 70.19 |
| TOTAL | ssp245 | 2150 | 104.85 | 107.64 | 137.98 |
| TOTAL | ssp245 | 2300 | 247.73 | 262.58 | 317.82 |
| TOTAL | ssp585 | 2100 | 90.67 | 92.85 | 98.00 |
| TOTAL | ssp585 | 2150 | 191.21 | 195.72 | 195.15 |
| TOTAL | ssp585 | 2300 | 497.87 | 511.65 | 467.87 |
...
| Greenland | 2100 | 1.58x | **PASS** | FACTS 1.24-1.84 (n=3); MAGICC-SLR 2.11-2.11 (n=1) |
| Greenland | 2150 | 2.59x | **WARN** | MAGICC-SLR 3.48-3.48 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| Greenland | 2300 | 6.78x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| thermal exp. | 2100 | 1.77x | **PASS** | FACTS 1.74-1.74 (n=1); MAGICC-SLR 2.51-2.51 (n=1) |
| thermal exp. | 2150 | 2.65x | **PASS** | FACTS 2.58-2.58 (n=1); MAGICC-SLR 3.94-3.94 (n=1) |
...
*Machine-readable: `outputs/bench_ladrillo_L27.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L27`.*
