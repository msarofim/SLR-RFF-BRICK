...
| **glaciers** | PASS | UNRESOLVED | WARN | PASS | WORSE |
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L28 | 0.2557 | 1.53 | bias -0.1875 cm = -1.12 sd; cov90 44%; n=126 |
...
| AIS | 0.1674 | 1920-1949 | L28 | 0.3165 | 1.89 | bias -0.3114 cm = -1.86 sd; cov90 0%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L28 | 0.1046 | 0.62 | bias -0.0644 cm = -0.38 sd; cov90 91%; n=43 |
...
| Greenland | 0.1832 | 1920-1949 | L28 | 0.2057 | 1.12 | bias -0.1612 cm = -0.88 sd; cov90 57%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L28 | 0.2723 | 1.49 | bias -0.2538 cm = -1.39 sd; cov90 0%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L28 | 0.1245 | 0.68 | bias -0.0848 cm = -0.46 sd; cov90 18%; n=33 |
...
| thermal exp. | 0.3091 | full | L28 | 0.4682 | 1.51 | bias +0.2669 cm = +0.86 sd; cov90 40%; n=126 |
...
| thermal exp. | 0.3091 | 1920-1949 | L28 | 0.6213 | 2.01 | bias +0.5005 cm = +1.62 sd; cov90 33%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L28 | 0.1947 | 0.63 | bias -0.0515 cm = -0.17 sd; cov90 72%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L28 | 0.3734 | 1.21 | bias +0.2432 cm = +0.79 sd; cov90 18%; n=33 |
...
| TOTAL | 1.5380 | full | L28 | 0.3101 | 0.20 | bias -0.0044 cm = -0.00 sd; cov90 80%; n=125 |
...
| TOTAL | 1.5380 | 1920-1949 | L28 | 0.3589 | 0.23 | bias -0.1218 cm = -0.08 sd; cov90 97%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L28 | 0.2771 | 0.18 | bias -0.1060 cm = -0.07 sd; cov90 88%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L28 | 0.3274 | 0.21 | bias +0.1497 cm = +0.10 sd; cov90 41%; n=32 |
...
| AIS | rate | L28 | 0.03593 | cm/yr | -1.03 | 0.86x obs; z=-1.03 vs the obs error bar |
...
| glaciers | rate | L28 | 0.066645 | cm/yr | -0.15 | 0.98x obs; z=-0.15 vs the obs error bar |
...
| Greenland | rate | L28 | 0.058716 | cm/yr | -0.69 | 0.89x obs; z=-0.69 vs the obs error bar |
...
| TOTAL | rate | L28 | 0.34408 | cm/yr | +0.66 | 1.06x obs; z=+0.66 vs the obs error bar |
...
| AIS | accel | L28 | 0.00019363 | cm/yr2 | -0.46 | ratio NOT INTERPRETABLE (obs is 1.21 se from zero); z=-0.46 vs the obs error bar |
...
| glaciers | accel | L28 | -0.00017109 | cm/yr2 | +0.84 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.84 vs the obs error bar |
...
| Greenland | accel | L28 | -0.00012886 | cm/yr2 | +0.29 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.29 vs the obs error bar |
...
| thermal exp. | accel | L28 | 0.001237 | cm/yr2 | +1.62 | 1.47x obs; z=+1.62 vs the obs error bar |
...
| TOTAL | accel | L28 | 0.0013053 | cm/yr2 | +0.36 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.36 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.569 x lit median | **PASS** | ours 5.14 cm vs lit 3.66-11.93 (median 9.04), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.93] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 1.959 x lit spread | **PASS** | ours 41.91 cm vs model-based lit 20.72-40.49 (median 21.40, n=5); ALL comparators 20.72-105.01 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.539 x lit median | **PASS** | ours 7.91 cm vs lit 5.34-24.01 (median 14.67), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.505 x lit spread | **PASS** | ours 78.41 cm vs model-based lit 33.17-71.04 (median 52.10, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 2.838 x lit spread | **WARN** | ours 197.49 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 0.740 x lit median | **PASS** | ours 7.77 cm vs lit 5.22-12.17 (median 10.49), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.22-12.17] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.501 x lit spread | **PASS** | ours 53.75 cm vs model-based lit 20.77-42.39 (median 35.81, n=5); ALL comparators 20.77-113.21 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.299 x lit median | **WARN** | ours 35.47 cm vs lit 27.21-27.41 (median 27.31), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.339 x lit spread | **PASS** | ours 114.37 cm vs model-based lit 80.10-90.72 (median 85.41, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp245 | 2300 | median_vs_lit | 1.702 x lit median | **WARN** | ours 142.06 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.143 x lit spread | **PASS** | ours 310.48 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 2.606 x lit median | **PASS** | ours 34.38 cm vs lit 4.30-39.10 (median 13.20), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 4.30-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.246 x lit spread | **PASS** | ours 64.05 cm vs model-based lit 20.71-79.00 (median 51.40, n=5); ALL comparators 20.71-126.10; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 0.946 x lit median | **PASS** | ours 88.87 cm vs lit 34.31-153.62 (median 93.97), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.532 x lit spread | **PASS** | ours 106.79 cm vs model-based lit 125.28-276.23 (median 200.75, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 0.984 x lit median | **PASS** | ours 268.55 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.327 x lit spread | **WARN** | ours 309.33 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.629 x lit spread | **PASS** | ours 4.87 cm vs model-based lit 7.12-10.06 (median 7.74, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.769 x lit median | **WARN** | ours 9.95 cm vs lit 12.28-13.60 (median 12.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | median_vs_lit | 0.680 x lit median | **WARN** | ours 12.47 cm vs lit 13.80-22.85 (median 18.33), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.593 x lit spread | **PASS** | ours 9.64 cm vs model-based lit 11.23-21.30 (median 16.26, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2100 | median_vs_lit | 0.774 x lit median | **WARN** | ours 9.70 cm vs lit 11.22-12.90 (median 12.54), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.679 x lit spread | **PASS** | ours 5.69 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.774 x lit median | **WARN** | ours 13.36 cm vs lit 16.71-17.82 (median 17.27), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.603 x lit spread | **PASS** | ours 8.73 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.685 x lit median | **WARN** | ours 18.15 cm vs lit 21.47-31.57 (median 26.52), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 0.940 x lit spread | **PASS** | ours 11.88 cm vs model-based lit 10.95-14.32 (median 12.63, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2100 | median_vs_lit | 0.841 x lit median | **WARN** | ours 12.87 cm vs lit 13.93-17.13 (median 15.30), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.776 x lit spread | **PASS** | ours 7.06 cm vs model-based lit 8.51-14.02 (median 9.10, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.839 x lit median | **WARN** | ours 20.25 cm vs lit 22.03-26.22 (median 24.13), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.757 x lit spread | **PASS** | ours 10.28 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 2.267 x lit spread | **WARN** | ours 11.29 cm vs model-based lit 0.13-9.83 (median 4.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2100 | median_vs_lit | 0.973 x lit median | **WARN** | ours 6.23 cm vs lit 6.36-8.31 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 6.36-13.80] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.386 x lit spread | **FAIL** | ours 3.69 cm vs model-based lit 8.22-17.86 (median 9.57, n=3); ALL comparators 8.22-68.88 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.890 x lit median | **WARN** | ours 8.29 cm vs lit 9.31-9.31 (median 9.31), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | median_vs_lit | 0.777 x lit median | **WARN** | ours 11.64 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2100 | median_vs_lit | 0.786 x lit median | **WARN** | ours 7.30 cm vs lit 8.12-9.59 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 8.12-14.49] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.562 x lit spread | **PASS** | ours 4.70 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.675 x lit median | **WARN** | ours 11.16 cm vs lit 16.53-16.53 (median 16.53), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.666 x lit spread | **PASS** | ours 9.92 cm vs model-based lit 14.88-14.88 (median 14.88, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.502 x lit median | **WARN** | ours 17.96 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.780 x lit spread | **PASS** | ours 31.92 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.797 x lit median | **WARN** | ours 9.75 cm vs lit 11.67-13.49 (median 12.23), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 11.67-17.18] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.635 x lit spread | **PASS** | ours 7.72 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.656 x lit median | **WARN** | ours 21.26 cm vs lit 32.40-32.40 (median 32.40), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.295 x lit spread | **WARN** | ours 26.81 cm vs model-based lit 90.97-90.97 (median 90.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.701 x lit median | **WARN** | ours 79.18 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.156 x lit spread | **WARN** | ours 106.28 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.123 x lit median | **PASS** | ours 15.66 cm vs lit 11.09-16.79 (median 13.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.904 x lit spread | **PASS** | ours 11.81 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.158 x lit median | **PASS** | ours 19.48 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.947 x lit spread | **PASS** | ours 17.00 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.146 x lit median | **PASS** | ours 24.94 cm vs lit 16.74-26.81 (median 21.77), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.048 x lit median | **PASS** | ours 19.81 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.873 x lit spread | **PASS** | ours 13.87 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.073 x lit median | **PASS** | ours 29.01 cm vs lit 23.23-30.82 (median 27.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.859 x lit spread | **PASS** | ours 23.31 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.067 x lit median | **PASS** | ours 44.57 cm vs lit 36.30-47.22 (median 41.76), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.890 x lit spread | **PASS** | ours 47.87 cm vs model-based lit 53.37-54.25 (median 53.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.809 x lit spread | **PASS** | ours 18.41 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.984 x lit median | **PASS** | ours 51.19 cm vs lit 49.94-54.12 (median 52.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.814 x lit spread | **PASS** | ours 38.50 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.957 x lit median | **WARN** | ours 101.83 cm vs lit 103.49-109.39 (median 106.44), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.814 x lit spread | **PASS** | ours 97.72 cm vs model-based lit 118.64-121.40 (median 120.02, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.841 x lit median | **PASS** | ours 38.41 cm vs lit 35.59-50.06 (median 45.68), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-55.88] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.190 x lit spread | **PASS** | ours 55.12 cm vs model-based lit 32.73-55.62 (median 46.34, n=7); ALL comparators 32.73-125.52 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 1.100 x lit median | **WARN** | ours 50.52 cm vs lit 45.94-45.94 (median 45.94), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.687 x lit spread | **PASS** | ours 99.46 cm vs model-based lit 58.97-58.97 (median 58.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.129 x lit median | **WARN** | ours 75.09 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 1.924 x lit spread | **PASS** | ours 224.37 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.910 x lit median | **PASS** | ours 50.30 cm vs lit 49.78-58.27 (median 55.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 49.78-67.77] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.261 x lit spread | **PASS** | ours 67.30 cm vs model-based lit 35.22-64.58 (median 53.36, n=7); ALL comparators 35.22-151.34 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.063 x lit median | **WARN** | ours 93.63 cm vs lit 88.11-88.11 (median 88.11), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.270 x lit spread | **PASS** | ours 137.58 cm vs model-based lit 108.33-108.33 (median 108.33, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.268 x lit median | **WARN** | ours 236.75 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.060 x lit spread | **PASS** | ours 360.04 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.172 x lit median | **PASS** | ours 88.31 cm vs lit 62.39-97.85 (median 75.33), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 62.39-97.85] |
...
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.712 x lit median | **WARN** | ours 187.25 cm vs lit 262.93-262.93 (median 262.93), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.367 x lit spread | **WARN** | ours 147.86 cm vs model-based lit 403.38-403.38 (median 403.38, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.481 x lit median | **WARN** | ours 488.93 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.305 x lit spread | **WARN** | ours 419.98 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 5.14 | 4.92 | 4.32 |
| AIS | ssp126 | 2150 | 7.91 | 7.68 | 6.52 |
| AIS | ssp126 | 2300 | 15.49 | 15.23 | 13.01 |
| AIS | ssp245 | 2100 | 7.77 | 10.55 | 27.41 |
| AIS | ssp245 | 2150 | 35.47 | 46.18 | 72.60 |
| AIS | ssp245 | 2300 | 142.06 | 156.34 | 205.94 |
| AIS | ssp585 | 2100 | 34.38 | 36.66 | 44.14 |
| AIS | ssp585 | 2150 | 88.87 | 92.56 | 97.88 |
| AIS | ssp585 | 2300 | 268.55 | 277.71 | 276.83 |
| glaciers | ssp126 | 2100 | 8.10 | 8.11 | 12.09 |
| glaciers | ssp126 | 2150 | 9.95 | 9.93 | 17.44 |
| glaciers | ssp126 | 2300 | 12.47 | 12.48 | 27.72 |
| glaciers | ssp245 | 2100 | 9.70 | 9.72 | 13.34 |
| glaciers | ssp245 | 2150 | 13.36 | 13.41 | 20.69 |
| glaciers | ssp245 | 2300 | 18.15 | 18.06 | 32.50 |
| glaciers | ssp585 | 2100 | 12.87 | 12.91 | 15.61 |
| glaciers | ssp585 | 2150 | 20.25 | 20.17 | 26.25 |
| glaciers | ssp585 | 2300 | 26.30 | 26.14 | 35.36 |
| Greenland | ssp126 | 2100 | 6.23 | 6.23 | 6.62 |
| Greenland | ssp126 | 2150 | 8.29 | 8.30 | 10.01 |
| Greenland | ssp126 | 2300 | 11.64 | 11.72 | 19.04 |
| Greenland | ssp245 | 2100 | 7.30 | 7.31 | 7.03 |
| Greenland | ssp245 | 2150 | 11.16 | 11.18 | 11.35 |
| Greenland | ssp245 | 2300 | 17.96 | 17.89 | 23.71 |
| Greenland | ssp585 | 2100 | 9.75 | 9.84 | 7.88 |
| Greenland | ssp585 | 2150 | 21.26 | 21.49 | 14.77 |
| Greenland | ssp585 | 2300 | 79.18 | 79.49 | 38.60 |
| thermal exp. | ssp126 | 2100 | 15.66 | 15.73 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.48 | 19.40 | 19.18 |
| thermal exp. | ssp126 | 2300 | 24.94 | 25.07 | 25.08 |
| thermal exp. | ssp245 | 2100 | 19.81 | 19.88 | 19.37 |
| thermal exp. | ssp245 | 2150 | 29.01 | 28.99 | 28.53 |
| thermal exp. | ssp245 | 2300 | 44.57 | 44.66 | 44.66 |
| thermal exp. | ssp585 | 2100 | 27.65 | 27.81 | 27.07 |
| thermal exp. | ssp585 | 2150 | 51.19 | 51.39 | 50.34 |
| thermal exp. | ssp585 | 2300 | 101.83 | 102.60 | 101.88 |
...
| TOTAL | ssp126 | 2100 | 38.41 | 38.00 | 41.16 |
| TOTAL | ssp126 | 2150 | 50.52 | 50.28 | 57.89 |
| TOTAL | ssp126 | 2300 | 75.09 | 74.81 | 94.76 |
| TOTAL | ssp245 | 2100 | 50.30 | 52.65 | 70.19 |
| TOTAL | ssp245 | 2150 | 93.63 | 104.85 | 137.98 |
| TOTAL | ssp245 | 2300 | 236.75 | 247.73 | 317.82 |
| TOTAL | ssp585 | 2100 | 88.31 | 90.67 | 98.00 |
| TOTAL | ssp585 | 2150 | 187.25 | 191.21 | 195.15 |
| TOTAL | ssp585 | 2300 | 488.93 | 497.87 | 467.87 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 6.68x | **PASS** | FACTS 0.73-2.10 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 11.24x | **PASS** | FACTS 1.43-1.43 (n=1); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 17.34x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.59x | **PASS** | FACTS 1.43-1.65 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.04x | **CHECK(wide)** | FACTS 1.93-1.93 (n=1); MAGICC-SLR 1.79-1.79 (n=1); 0.11 outside the bracket = 81% of its own range |
| glaciers | 2300 | 2.11x | **PASS(edge)** | FACTS 1.38-1.38 (n=1); MAGICC-SLR 2.11-2.11 (n=1); 0.00 outside the bracket = 0% of its own range |
| Greenland | 2100 | 1.56x | **PASS** | FACTS 1.24-1.84 (n=3); MAGICC-SLR 2.11-2.11 (n=1) |
| Greenland | 2150 | 2.56x | **WARN** | MAGICC-SLR 3.48-3.48 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| Greenland | 2300 | 6.80x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2150 | 3.71x | **WARN** | MAGICC-SLR 5.72-5.72 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| TOTAL | 2300 | 6.51x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L28.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L28`.*
