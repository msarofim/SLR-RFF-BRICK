# Ladrillo benchmark — `L20`

*benchmark v1.0, 2026-08-27, repo `2da36d6`. Champion arm: **L14**.*
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L20 | 0.0314 | 0.19 | bias -0.0030 cm = -0.02 sd; cov90 82%; n=106 |
...
| AIS | 0.1674 | 1920-1949 | L20 | 0.0073 | 0.04 | bias -0.0071 cm = -0.04 sd; cov90 100%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L20 | 0.0073 | 0.04 | bias +0.0025 cm = +0.01 sd; cov90 98%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L20 | 0.0552 | 0.33 | bias -0.0063 cm = -0.04 sd; cov90 45%; n=33 |
...
| glaciers | 0.4593 | full | L20 | 0.3287 | 0.72 | bias +0.1658 cm = +0.36 sd; cov90 52%; n=104 |
...
| glaciers | 0.4593 | 1920-1949 | L20 | 0.5830 | 1.27 | bias +0.5207 cm = +1.13 sd; cov90 20%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L20 | 0.1355 | 0.30 | bias +0.0763 cm = +0.17 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L20 | 0.0892 | 0.19 | bias -0.0535 cm = -0.12 sd; cov90 77%; n=31 |
...
| Greenland | 0.1832 | full | L20 | 0.0589 | 0.32 | bias +0.0017 cm = +0.01 sd; cov90 53%; n=106 |
...
| Greenland | 0.1832 | 1920-1949 | L20 | 0.0803 | 0.44 | bias +0.0253 cm = +0.14 sd; cov90 53%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L20 | 0.0495 | 0.27 | bias -0.0146 cm = -0.08 sd; cov90 58%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L20 | 0.0456 | 0.25 | bias +0.0016 cm = +0.01 sd; cov90 45%; n=33 |
...
| thermal exp. | 0.3091 | full | L20 | 0.3198 | 1.03 | bias +0.1800 cm = +0.58 sd; cov90 28%; n=106 |
...
| thermal exp. | 0.3091 | 1920-1949 | L20 | 0.4457 | 1.44 | bias +0.3555 cm = +1.15 sd; cov90 30%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L20 | 0.1844 | 0.60 | bias +0.0321 cm = +0.10 sd; cov90 37%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L20 | 0.3219 | 1.04 | bias +0.2132 cm = +0.69 sd; cov90 15%; n=33 |
...
| TOTAL | 1.5380 | full | L20 | 0.6906 | 0.45 | bias +0.5595 cm = +0.36 sd; cov90 26%; n=105 |
...
| TOTAL | 1.5380 | 1920-1949 | L20 | 0.9746 | 0.63 | bias +0.9312 cm = +0.61 sd; cov90 40%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L20 | 0.6613 | 0.43 | bias +0.6186 cm = +0.40 sd; cov90 5%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L20 | 0.2948 | 0.19 | bias +0.1315 cm = +0.09 sd; cov90 41%; n=32 |
...
| AIS | rate | L20 | 0.031693 | cm/yr | -0.27 | 0.97x obs; z=-0.27 vs the obs error bar |
...
| glaciers | rate | L20 | 0.06264 | cm/yr | -0.58 | 0.92x obs; z=-0.58 vs the obs error bar |
...
| Greenland | rate | L20 | 0.065752 | cm/yr | -0.02 | 1.00x obs; z=-0.02 vs the obs error bar |
...
| thermal exp. | rate | L20 | 0.14718 | cm/yr | +4.21 | 1.19x obs; z=+4.21 vs the obs error bar |
...
| TOTAL | rate | L20 | 0.33761 | cm/yr | +0.44 | 1.04x obs; z=+0.44 vs the obs error bar |
...
| AIS | accel | L20 | 0.00020682 | cm/yr2 | +0.01 | ratio NOT INTERPRETABLE (obs is 1.53 se from zero); z=+0.01 vs the obs error bar |
...
| glaciers | accel | L20 | -0.00011231 | cm/yr2 | +0.98 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.98 vs the obs error bar |
...
| Greenland | accel | L20 | -0.00025064 | cm/yr2 | +0.05 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.05 vs the obs error bar |
...
| thermal exp. | accel | L20 | 0.0010005 | cm/yr2 | +0.65 | 1.19x obs; z=+0.65 vs the obs error bar |
...
| TOTAL | accel | L20 | 0.0010232 | cm/yr2 | +0.11 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.11 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.522 x lit median | **PASS** | ours 4.67 cm vs lit 3.66-11.90 (median 8.94), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.90] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 2.135 x lit spread | **FAIL** | ours 45.07 cm vs model-based lit 9.86-39.27 (median 21.11, n=5); ALL comparators 9.86-91.07 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.398 x lit median | **PASS** | ours 7.13 cm vs lit 5.34-26.34 (median 17.92), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 5.34-26.34] |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.863 x lit spread | **PASS** | ours 85.98 cm vs model-based lit 33.17-72.55 (median 46.14, n=4); ALL comparators 33.17-156.27 |
| AIS | ssp126 | 2300 | median_vs_lit | 1.604 x lit median | **WARN** | ours 13.97 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 3.070 x lit spread | **WARN** | ours 213.64 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 1.094 x lit median | **PASS** | ours 11.36 cm vs lit 5.54-12.73 (median 10.38), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.54-13.71] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.665 x lit spread | **PASS** | ours 59.63 cm vs model-based lit 20.88-44.94 (median 35.81, n=5); ALL comparators 20.88-109.87 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.856 x lit median | **WARN** | ours 50.96 cm vs lit 10.91-30.28 (median 27.45), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 10.91-30.28] |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.487 x lit spread | **WARN** | ours 125.09 cm vs model-based lit 44.92-369.45 (median 84.10, n=4); ALL comparators 44.92-369.45; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| AIS | ssp245 | 2300 | median_vs_lit | 2.055 x lit median | **WARN** | ours 171.54 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.226 x lit spread | **PASS** | ours 332.89 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 3.091 x lit median | **FAIL** | ours 44.58 cm vs lit 3.98-39.10 (median 14.43), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.98-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.133 x lit spread | **PASS** | ours 64.01 cm vs model-based lit 20.51-79.00 (median 56.48, n=5); ALL comparators 20.51-151.54; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 1.102 x lit median | **PASS** | ours 105.27 cm vs lit 6.26-198.76 (median 95.53), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 6.26-198.76] |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.558 x lit spread | **WARN** | ours 114.55 cm vs model-based lit 48.68-408.37 (median 205.25, n=4); ALL comparators 48.68-570.98; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.127 x lit median | **PASS** | ours 307.74 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.358 x lit spread | **WARN** | ours 338.70 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.826 x lit median | **WARN** | ours 7.64 cm vs lit 8.95-10.45 (median 9.25), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.824 x lit spread | **PASS** | ours 6.07 cm vs model-based lit 7.12-7.85 (median 7.36, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.770 x lit median | **WARN** | ours 9.35 cm vs lit 12.00-12.28 (median 12.14), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.785 x lit spread | **PASS** | ours 8.01 cm vs model-based lit 8.52-11.89 (median 10.21, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.852 x lit median | **WARN** | ours 11.76 cm vs lit 13.80-13.80 (median 13.80), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.987 x lit spread | **PASS** | ours 11.08 cm vs model-based lit 11.23-11.23 (median 11.23, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2100 | median_vs_lit | 0.794 x lit median | **WARN** | ours 9.69 cm vs lit 11.38-12.54 (median 12.21), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.891 x lit spread | **PASS** | ours 6.84 cm vs model-based lit 7.42-9.60 (median 7.68, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.786 x lit median | **WARN** | ours 13.45 cm vs lit 16.71-17.53 (median 17.12), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.761 x lit spread | **PASS** | ours 9.82 cm vs model-based lit 9.16-16.65 (median 12.91, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.850 x lit median | **WARN** | ours 18.24 cm vs lit 21.47-21.47 (median 21.47), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 1.199 x lit spread | **PASS** | ours 13.13 cm vs model-based lit 10.95-10.95 (median 10.95, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2100 | median_vs_lit | 0.897 x lit median | **WARN** | ours 13.87 cm vs lit 15.30-17.73 (median 15.46), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.957 x lit spread | **PASS** | ours 9.00 cm vs model-based lit 8.51-13.85 (median 9.41, n=3) |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.922 x lit spread | **PASS** | ours 11.81 cm vs model-based lit 10.09-15.53 (median 12.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.925 x lit median | **WARN** | ours 26.93 cm vs lit 29.10-29.10 (median 29.10), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 1.255 x lit spread | **PASS** | ours 12.34 cm vs model-based lit 9.83-9.83 (median 9.83, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.476 x lit spread | **FAIL** | ours 4.55 cm vs model-based lit 7.06-17.14 (median 9.57, n=3); ALL comparators 7.06-55.71 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.673 x lit median | **WARN** | ours 7.57 cm vs lit 9.31-13.18 (median 11.25), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 9.31-22.20] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.506 x lit spread | **PASS** | ours 6.79 cm vs model-based lit 11.12-15.69 (median 13.40, n=2); ALL comparators 11.12-86.94; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.621 x lit median | **WARN** | ours 9.30 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.388 x lit spread | **WARN** | ours 11.41 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp245 | 2100 | median_vs_lit | 0.888 x lit median | **PASS** | ours 8.25 cm vs lit 7.97-10.21 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 7.97-14.39] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.703 x lit spread | **PASS** | ours 5.87 cm vs model-based lit 7.85-16.85 (median 8.35, n=3); ALL comparators 7.85-72.68 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.688 x lit median | **WARN** | ours 11.94 cm vs lit 16.53-18.19 (median 17.36), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 16.53-25.62] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.731 x lit spread | **PASS** | ours 10.90 cm vs model-based lit 14.88-14.93 (median 14.91, n=2); ALL comparators 14.88-88.90; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.471 x lit median | **WARN** | ours 16.86 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.508 x lit spread | **PASS** | ours 20.77 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.991 x lit median | **PASS** | ours 13.37 cm vs lit 12.72-14.02 (median 13.49), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 12.72-20.28] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.938 x lit spread | **PASS** | ours 11.40 cm vs model-based lit 11.46-17.10 (median 12.15, n=3); ALL comparators 11.46-93.18 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.905 x lit median | **WARN** | ours 27.03 cm vs lit 27.33-32.40 (median 29.87), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 27.33-38.13] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.477 x lit spread | **WARN** | ours 27.62 cm vs model-based lit 24.97-90.97 (median 57.97, n=2); ALL comparators 24.97-121.86; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.415 x lit median | **WARN** | ours 46.93 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.088 x lit spread | **WARN** | ours 59.64 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.077 x lit median | **PASS** | ours 13.54 cm vs lit 11.09-14.05 (median 12.57), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.875 x lit spread | **PASS** | ours 10.16 cm vs model-based lit 11.26-11.97 (median 11.61, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.109 x lit median | **PASS** | ours 16.93 cm vs lit 12.68-17.85 (median 15.26), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.909 x lit spread | **PASS** | ours 15.01 cm vs model-based lit 16.06-16.96 (median 16.51, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.326 x lit median | **WARN** | ours 22.19 cm vs lit 16.74-16.74 (median 16.74), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.050 x lit spread | **PASS** | ours 26.74 cm vs model-based lit 25.47-25.47 (median 25.47, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.003 x lit median | **PASS** | ours 17.79 cm vs lit 16.62-18.84 (median 17.73), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.811 x lit spread | **PASS** | ours 11.76 cm vs model-based lit 13.73-15.26 (median 14.49, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.014 x lit median | **PASS** | ours 26.31 cm vs lit 23.23-28.64 (median 25.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.807 x lit spread | **PASS** | ours 20.09 cm vs model-based lit 23.92-25.87 (median 24.90, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.127 x lit median | **WARN** | ours 40.90 cm vs lit 36.30-36.30 (median 36.30), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.792 x lit spread | **PASS** | ours 42.95 cm vs model-based lit 54.25-54.25 (median 54.25, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.937 x lit median | **WARN** | ours 26.55 cm vs lit 27.88-28.82 (median 28.35), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.780 x lit spread | **PASS** | ours 17.17 cm vs model-based lit 21.13-22.88 (median 22.00, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.951 x lit median | **WARN** | ours 49.10 cm vs lit 49.94-53.35 (median 51.64), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.813 x lit spread | **PASS** | ours 36.55 cm vs model-based lit 41.87-48.08 (median 44.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.958 x lit median | **WARN** | ours 99.19 cm vs lit 103.49-103.49 (median 103.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.797 x lit spread | **PASS** | ours 96.76 cm vs model-based lit 121.40-121.40 (median 121.40, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.840 x lit median | **WARN** | ours 34.66 cm vs lit 35.59-46.11 (median 41.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-53.47] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.820 x lit spread | **PASS** | ours 61.07 cm vs model-based lit 25.25-49.52 (median 33.55, n=7); ALL comparators 25.25-107.65 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 0.681 x lit median | **WARN** | ours 45.05 cm vs lit 45.94-74.90 (median 66.11), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 45.94-83.12] |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.859 x lit spread | **PASS** | ours 108.35 cm vs model-based lit 53.31-79.31 (median 58.29, n=4); ALL comparators 53.31-200.59 |
| TOTAL | ssp126 | 2300 | median_vs_lit | 0.983 x lit median | **WARN** | ours 65.33 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.145 x lit spread | **WARN** | ours 250.11 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.964 x lit median | **PASS** | ours 51.58 cm vs lit 48.68-57.10 (median 53.51), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 48.68-67.90] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.411 x lit spread | **PASS** | ours 74.27 cm vs model-based lit 32.00-60.35 (median 52.65, n=7); ALL comparators 32.00-146.33 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.164 x lit median | **WARN** | ours 108.37 cm vs lit 80.04-105.22 (median 93.13), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 80.04-111.19] |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.432 x lit spread | **WARN** | ours 149.88 cm vs model-based lit 59.41-382.80 (median 104.68, n=4); ALL comparators 59.41-382.80; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.401 x lit median | **WARN** | ours 261.58 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.112 x lit spread | **PASS** | ours 377.86 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.287 x lit median | **WARN** | ours 102.21 cm vs lit 64.93-97.85 (median 79.41), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 64.93-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.198 x lit spread | **PASS** | ours 84.27 cm vs model-based lit 41.09-106.79 (median 70.33, n=7); ALL comparators 41.09-197.47 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 1.008 x lit median | **PASS** | ours 208.95 cm vs lit 117.08-310.66 (median 207.31), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 117.08-310.66] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.566 x lit spread | **WARN** | ours 156.70 cm vs model-based lit 77.93-414.71 (median 277.00, n=4); ALL comparators 77.93-631.59; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.483 x lit median | **WARN** | ours 490.51 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.317 x lit spread | **WARN** | ours 437.53 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 4.67 | 4.29 | 4.21 |
| AIS | ssp126 | 2150 | 7.13 | 6.53 | 6.37 |
| AIS | ssp126 | 2300 | 13.97 | 12.67 | 12.64 |
| AIS | ssp245 | 2100 | 11.36 | 5.51 | 29.21 |
| AIS | ssp245 | 2150 | 50.96 | 11.16 | 74.53 |
| AIS | ssp245 | 2300 | 171.54 | 79.23 | 207.88 |
| AIS | ssp585 | 2100 | 44.58 | 35.05 | 48.98 |
| AIS | ssp585 | 2150 | 105.27 | 92.13 | 104.07 |
| AIS | ssp585 | 2300 | 307.74 | 277.34 | 290.17 |
| glaciers | ssp126 | 2100 | 7.64 | 7.73 | 12.00 |
| glaciers | ssp126 | 2150 | 9.35 | 9.42 | 17.18 |
| glaciers | ssp126 | 2300 | 11.76 | 11.80 | 27.26 |
| glaciers | ssp245 | 2100 | 9.69 | 9.77 | 13.48 |
| glaciers | ssp245 | 2150 | 13.45 | 13.49 | 20.82 |
| glaciers | ssp245 | 2300 | 18.24 | 18.19 | 32.41 |
| glaciers | ssp585 | 2100 | 13.87 | 14.00 | 16.47 |
| glaciers | ssp585 | 2150 | 21.24 | 21.45 | 27.14 |
| glaciers | ssp585 | 2300 | 26.93 | 27.01 | 35.20 |
| Greenland | ssp126 | 2100 | 6.25 | 6.25 | 6.60 |
| Greenland | ssp126 | 2150 | 7.57 | 7.58 | 9.92 |
| Greenland | ssp126 | 2300 | 9.30 | 9.47 | 18.79 |
| Greenland | ssp245 | 2100 | 8.25 | 8.19 | 7.09 |
| Greenland | ssp245 | 2150 | 11.94 | 11.96 | 11.43 |
| Greenland | ssp245 | 2300 | 16.86 | 17.12 | 23.76 |
| Greenland | ssp585 | 2100 | 13.37 | 13.35 | 8.24 |
| Greenland | ssp585 | 2150 | 27.03 | 26.99 | 15.57 |
| Greenland | ssp585 | 2300 | 46.93 | 47.48 | 40.35 |
| thermal exp. | ssp126 | 2100 | 13.54 | 13.51 | 13.76 |
| thermal exp. | ssp126 | 2150 | 16.93 | 16.88 | 17.22 |
| thermal exp. | ssp126 | 2300 | 22.19 | 22.08 | 22.80 |
| thermal exp. | ssp245 | 2100 | 17.79 | 17.73 | 18.03 |
| thermal exp. | ssp245 | 2150 | 26.31 | 26.26 | 26.68 |
| thermal exp. | ssp245 | 2300 | 40.90 | 40.67 | 42.05 |
| thermal exp. | ssp585 | 2100 | 26.55 | 26.60 | 27.05 |
| thermal exp. | ssp585 | 2150 | 49.10 | 49.06 | 49.95 |
| thermal exp. | ssp585 | 2300 | 99.19 | 98.47 | 100.22 |
...
| TOTAL | ssp126 | 2100 | 34.66 | 34.33 | 39.24 |
| TOTAL | ssp126 | 2150 | 45.05 | 44.64 | 55.17 |
| TOTAL | ssp126 | 2300 | 65.33 | 64.44 | 91.18 |
| TOTAL | ssp245 | 2100 | 51.58 | 44.92 | 70.87 |
| TOTAL | ssp245 | 2150 | 108.37 | 71.57 | 137.98 |
| TOTAL | ssp245 | 2300 | 261.58 | 162.84 | 317.51 |
| TOTAL | ssp585 | 2100 | 102.21 | 92.45 | 104.68 |
| TOTAL | ssp585 | 2150 | 208.95 | 195.59 | 202.83 |
| TOTAL | ssp585 | 2300 | 490.51 | 461.72 | 482.40 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 9.54x | **PASS** | FACTS 0.63-3.20 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 14.76x | **PASS** | FACTS 0.48-7.55 (n=4); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 22.03x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.82x | **PASS** | FACTS 1.73-1.92 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.27x | **PASS** | FACTS 2.37-2.37 (n=1); MAGICC-SLR 1.79-1.79 (n=1) |
...
| Greenland | 2150 | 3.57x | **PASS(edge)** | FACTS 1.72-2.07 (n=2); MAGICC-SLR 3.48-3.48 (n=1); 0.09 outside the bracket = 5% of its own range |
| Greenland | 2300 | 5.05x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| thermal exp. | 2100 | 1.96x | **PASS(edge)** | FACTS 2.05-2.05 (n=1); MAGICC-SLR 2.51-2.51 (n=1); 0.09 outside the bracket = 19% of its own range |
| thermal exp. | 2150 | 2.90x | **PASS(edge)** | FACTS 2.99-2.99 (n=1); MAGICC-SLR 3.94-3.94 (n=1); 0.09 outside the bracket = 9% of its own range |
...
| TOTAL | 2100 | 2.95x | **PASS(edge)** | FACTS 1.63-2.23 (n=7); MAGICC-SLR 2.75-2.75 (n=1); 0.20 outside the bracket = 18% of its own range |
| TOTAL | 2150 | 4.64x | **PASS** | FACTS 1.94-4.15 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
| TOTAL | 2300 | 7.51x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L20.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L20`.*
