# Ladrillo benchmark — `L15`

*benchmark v1.0, 2026-08-25, repo `99af5c0`. Champion arm: **L14**.*
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L15 | 0.0631 | 0.38 | bias -0.0445 cm = -0.27 sd; cov90 40%; n=106 |
...
| AIS | 0.1674 | 1920-1949 | L15 | 0.0396 | 0.24 | bias -0.0309 cm = -0.18 sd; cov90 90%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L15 | 0.0611 | 0.37 | bias -0.0570 cm = -0.34 sd; cov90 7%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L15 | 0.0806 | 0.48 | bias -0.0405 cm = -0.24 sd; cov90 36%; n=33 |
...
| glaciers | 0.4593 | full | L15 | 0.3356 | 0.73 | bias +0.1724 cm = +0.38 sd; cov90 52%; n=104 |
...
| glaciers | 0.4593 | 1920-1949 | L15 | 0.5974 | 1.30 | bias +0.5346 cm = +1.16 sd; cov90 20%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L15 | 0.1351 | 0.29 | bias +0.0796 cm = +0.17 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L15 | 0.0842 | 0.18 | bias -0.0495 cm = -0.11 sd; cov90 77%; n=31 |
...
| Greenland | 0.1832 | full | L15 | 0.0585 | 0.32 | bias +0.0014 cm = +0.01 sd; cov90 53%; n=106 |
...
| Greenland | 0.1832 | 1920-1949 | L15 | 0.0797 | 0.43 | bias +0.0233 cm = +0.13 sd; cov90 53%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L15 | 0.0489 | 0.27 | bias -0.0143 cm = -0.08 sd; cov90 58%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L15 | 0.0457 | 0.25 | bias +0.0020 cm = +0.01 sd; cov90 45%; n=33 |
...
| thermal exp. | 0.3091 | full | L15 | 0.3194 | 1.03 | bias +0.1793 cm = +0.58 sd; cov90 28%; n=106 |
...
| thermal exp. | 0.3091 | 1920-1949 | L15 | 0.4440 | 1.44 | bias +0.3535 cm = +1.14 sd; cov90 30%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L15 | 0.1841 | 0.60 | bias +0.0310 cm = +0.10 sd; cov90 37%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L15 | 0.3230 | 1.05 | bias +0.2140 cm = +0.69 sd; cov90 15%; n=33 |
...
| TOTAL | 1.5380 | full | L15 | 0.6586 | 0.43 | bias +0.5205 cm = +0.34 sd; cov90 31%; n=105 |
...
| TOTAL | 1.5380 | 1920-1949 | L15 | 0.9564 | 0.62 | bias +0.9094 cm = +0.59 sd; cov90 43%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L15 | 0.6038 | 0.39 | bias +0.5591 cm = +0.36 sd; cov90 16%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L15 | 0.2751 | 0.18 | bias +0.1038 cm = +0.07 sd; cov90 41%; n=32 |
...
| AIS | rate | L15 | 0.028905 | cm/yr | -1.09 | 0.89x obs; z=-1.09 vs the obs error bar |
...
| glaciers | rate | L15 | 0.063192 | cm/yr | -0.52 | 0.93x obs; z=-0.52 vs the obs error bar |
...
| Greenland | rate | L15 | 0.0658 | cm/yr | -0.02 | 1.00x obs; z=-0.02 vs the obs error bar |
...
| thermal exp. | rate | L15 | 0.14727 | cm/yr | +4.22 | 1.19x obs; z=+4.22 vs the obs error bar |
...
| TOTAL | rate | L15 | 0.33552 | cm/yr | +0.37 | 1.03x obs; z=+0.37 vs the obs error bar |
...
| AIS | accel | L15 | 0.0002621 | cm/yr2 | +0.43 | ratio NOT INTERPRETABLE (obs is 1.53 se from zero); z=+0.43 vs the obs error bar |
...
| glaciers | accel | L15 | -0.00010584 | cm/yr2 | +0.99 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.99 vs the obs error bar |
...
| Greenland | accel | L15 | -0.00025285 | cm/yr2 | +0.05 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.05 vs the obs error bar |
...
| thermal exp. | accel | L15 | 0.0010011 | cm/yr2 | +0.65 | 1.19x obs; z=+0.65 vs the obs error bar |
...
| TOTAL | accel | L15 | 0.0010833 | cm/yr2 | +0.16 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.16 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.602 x lit median | **PASS** | ours 5.39 cm vs lit 3.66-11.90 (median 8.94), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.90] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 2.381 x lit spread | **FAIL** | ours 50.25 cm vs model-based lit 9.86-39.27 (median 21.11, n=5); ALL comparators 9.86-91.07 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.463 x lit median | **PASS** | ours 8.29 cm vs lit 5.34-26.34 (median 17.92), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 5.34-26.34] |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 2.005 x lit spread | **WARN** | ours 92.50 cm vs model-based lit 33.17-72.55 (median 46.14, n=4); ALL comparators 33.17-156.27; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 2xhigh/2xin and the median's 'high' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| AIS | ssp126 | 2300 | median_vs_lit | 1.844 x lit median | **WARN** | ours 16.06 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 3.363 x lit spread | **WARN** | ours 234.04 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 1.368 x lit median | **WARN** | ours 14.20 cm vs lit 5.54-12.73 (median 10.38), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.54-13.71] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.714 x lit spread | **PASS** | ours 61.40 cm vs model-based lit 20.88-44.94 (median 35.81, n=5); ALL comparators 20.88-109.87 |
| AIS | ssp245 | 2150 | median_vs_lit | 2.048 x lit median | **FAIL** | ours 56.22 cm vs lit 10.91-30.28 (median 27.45), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 10.91-30.28] |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.541 x lit spread | **WARN** | ours 129.61 cm vs model-based lit 44.92-369.45 (median 84.10, n=4); ALL comparators 44.92-369.45; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| AIS | ssp245 | 2300 | median_vs_lit | 2.239 x lit median | **WARN** | ours 186.83 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.247 x lit spread | **PASS** | ours 338.60 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 3.343 x lit median | **FAIL** | ours 48.23 cm vs lit 3.98-39.10 (median 14.43), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.98-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.157 x lit spread | **PASS** | ours 65.32 cm vs model-based lit 20.51-79.00 (median 56.48, n=5); ALL comparators 20.51-151.54; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 1.217 x lit median | **PASS** | ours 116.26 cm vs lit 6.26-198.76 (median 95.53), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 6.26-198.76] |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.611 x lit spread | **WARN** | ours 125.37 cm vs model-based lit 48.68-408.37 (median 205.25, n=4); ALL comparators 48.68-570.98; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.268 x lit median | **PASS** | ours 346.09 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.425 x lit spread | **WARN** | ours 401.28 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.832 x lit median | **WARN** | ours 7.69 cm vs lit 8.95-10.45 (median 9.25), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.822 x lit spread | **PASS** | ours 6.05 cm vs model-based lit 7.12-7.85 (median 7.36, n=3) |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.764 x lit spread | **PASS** | ours 7.80 cm vs model-based lit 8.52-11.89 (median 10.21, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.860 x lit median | **WARN** | ours 11.87 cm vs lit 13.80-13.80 (median 13.80), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.953 x lit spread | **PASS** | ours 10.70 cm vs model-based lit 11.23-11.23 (median 11.23, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.859 x lit spread | **PASS** | ours 6.60 cm vs model-based lit 7.42-9.60 (median 7.68, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.791 x lit median | **WARN** | ours 13.54 cm vs lit 16.71-17.53 (median 17.12), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.737 x lit spread | **PASS** | ours 9.51 cm vs model-based lit 9.16-16.65 (median 12.91, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.855 x lit median | **WARN** | ours 18.36 cm vs lit 21.47-21.47 (median 21.47), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 1.169 x lit spread | **PASS** | ours 12.81 cm vs model-based lit 10.95-10.95 (median 10.95, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2100 | median_vs_lit | 0.904 x lit median | **WARN** | ours 13.97 cm vs lit 15.30-17.73 (median 15.46), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.925 x lit spread | **PASS** | ours 8.70 cm vs model-based lit 8.51-13.85 (median 9.41, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.850 x lit median | **WARN** | ours 21.43 cm vs lit 22.03-28.40 (median 25.22), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.903 x lit spread | **PASS** | ours 11.57 cm vs model-based lit 10.09-15.53 (median 12.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 1.240 x lit spread | **PASS** | ours 12.20 cm vs model-based lit 9.83-9.83 (median 9.83, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp126 | 2150 | median_vs_lit | 0.669 x lit median | **WARN** | ours 7.53 cm vs lit 9.31-13.18 (median 11.25), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 9.31-22.20] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.517 x lit spread | **PASS** | ours 6.93 cm vs model-based lit 11.12-15.69 (median 13.40, n=2); ALL comparators 11.12-86.94; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.624 x lit median | **WARN** | ours 9.34 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2100 | median_vs_lit | 0.885 x lit median | **PASS** | ours 8.21 cm vs lit 7.97-10.21 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 7.97-14.39] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.702 x lit spread | **PASS** | ours 5.86 cm vs model-based lit 7.85-16.85 (median 8.35, n=3); ALL comparators 7.85-72.68 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.685 x lit median | **WARN** | ours 11.89 cm vs lit 16.53-18.19 (median 17.36), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 16.53-25.62] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | median_vs_lit | 0.476 x lit median | **WARN** | ours 17.03 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.521 x lit spread | **PASS** | ours 21.30 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.919 x lit spread | **PASS** | ours 11.17 cm vs model-based lit 11.46-17.10 (median 12.15, n=3); ALL comparators 11.46-93.18 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.906 x lit median | **WARN** | ours 27.04 cm vs lit 27.33-32.40 (median 29.87), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 27.33-38.13] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.471 x lit spread | **WARN** | ours 27.28 cm vs model-based lit 24.97-90.97 (median 57.97, n=2); ALL comparators 24.97-121.86; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.418 x lit median | **WARN** | ours 47.26 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.110 x lit median | **PASS** | ours 16.94 cm vs lit 12.68-17.85 (median 15.26), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.902 x lit spread | **PASS** | ours 14.89 cm vs model-based lit 16.06-16.96 (median 16.51, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.323 x lit median | **WARN** | ours 22.14 cm vs lit 16.74-16.74 (median 16.74), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.053 x lit spread | **PASS** | ours 26.83 cm vs model-based lit 25.47-25.47 (median 25.47, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.001 x lit median | **PASS** | ours 17.74 cm vs lit 16.62-18.84 (median 17.73), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.804 x lit spread | **PASS** | ours 11.66 cm vs model-based lit 13.73-15.26 (median 14.49, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.013 x lit median | **PASS** | ours 26.28 cm vs lit 23.23-28.64 (median 25.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.812 x lit spread | **PASS** | ours 20.22 cm vs model-based lit 23.92-25.87 (median 24.90, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.128 x lit median | **WARN** | ours 40.96 cm vs lit 36.30-36.30 (median 36.30), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.790 x lit spread | **PASS** | ours 42.84 cm vs model-based lit 54.25-54.25 (median 54.25, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.936 x lit median | **WARN** | ours 26.54 cm vs lit 27.88-28.82 (median 28.35), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.771 x lit spread | **PASS** | ours 16.96 cm vs model-based lit 21.13-22.88 (median 22.00, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.950 x lit median | **WARN** | ours 49.04 cm vs lit 49.94-53.35 (median 51.64), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.803 x lit spread | **PASS** | ours 36.12 cm vs model-based lit 41.87-48.08 (median 44.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.955 x lit median | **WARN** | ours 98.85 cm vs lit 103.49-103.49 (median 103.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.793 x lit spread | **PASS** | ours 96.25 cm vs model-based lit 121.40-121.40 (median 121.40, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.862 x lit median | **WARN** | ours 35.56 cm vs lit 35.59-46.11 (median 41.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-53.47] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.908 x lit spread | **PASS** | ours 64.01 cm vs model-based lit 25.25-49.52 (median 33.55, n=7); ALL comparators 25.25-107.65 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 0.703 x lit median | **PASS** | ours 46.51 cm vs lit 45.94-74.90 (median 66.11), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 45.94-83.12] |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.946 x lit spread | **PASS** | ours 113.44 cm vs model-based lit 53.31-79.31 (median 58.29, n=4); ALL comparators 53.31-200.59 |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.025 x lit median | **WARN** | ours 68.14 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.311 x lit spread | **WARN** | ours 269.42 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2100 | median_vs_lit | 1.008 x lit median | **PASS** | ours 53.95 cm vs lit 48.68-57.10 (median 53.51), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 48.68-67.90] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.458 x lit spread | **PASS** | ours 76.75 cm vs model-based lit 32.00-60.35 (median 52.65, n=7); ALL comparators 32.00-146.33 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.221 x lit median | **WARN** | ours 113.71 cm vs lit 80.04-105.22 (median 93.13), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 80.04-111.19] |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.463 x lit spread | **WARN** | ours 153.19 cm vs model-based lit 59.41-382.80 (median 104.68, n=4); ALL comparators 59.41-382.80; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.482 x lit median | **WARN** | ours 276.80 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.121 x lit spread | **PASS** | ours 380.90 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.333 x lit median | **WARN** | ours 105.88 cm vs lit 64.93-97.85 (median 79.41), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 64.93-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.210 x lit spread | **PASS** | ours 85.11 cm vs model-based lit 41.09-106.79 (median 70.33, n=7); ALL comparators 41.09-197.47 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 1.059 x lit median | **PASS** | ours 219.48 cm vs lit 117.08-310.66 (median 207.31), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 117.08-310.66] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.583 x lit spread | **WARN** | ours 161.39 cm vs model-based lit 77.93-414.71 (median 277.00, n=4); ALL comparators 77.93-631.59; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.519 x lit median | **WARN** | ours 527.65 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.360 x lit spread | **WARN** | ours 496.07 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 5.39 | 4.29 | 4.21 |
| AIS | ssp126 | 2150 | 8.29 | 6.53 | 6.37 |
| AIS | ssp126 | 2300 | 16.06 | 12.67 | 12.64 |
| AIS | ssp245 | 2100 | 14.20 | 5.51 | 29.21 |
| AIS | ssp245 | 2150 | 56.22 | 11.16 | 74.53 |
| AIS | ssp245 | 2300 | 186.83 | 79.23 | 207.88 |
| AIS | ssp585 | 2100 | 48.23 | 35.05 | 48.98 |
| AIS | ssp585 | 2150 | 116.26 | 92.13 | 104.07 |
| AIS | ssp585 | 2300 | 346.09 | 277.34 | 290.17 |
| glaciers | ssp126 | 2100 | 7.69 | 7.73 | 12.00 |
| glaciers | ssp126 | 2150 | 9.43 | 9.42 | 17.18 |
| glaciers | ssp126 | 2300 | 11.87 | 11.80 | 27.26 |
| glaciers | ssp245 | 2100 | 9.77 | 9.77 | 13.48 |
| glaciers | ssp245 | 2150 | 13.54 | 13.49 | 20.82 |
| glaciers | ssp245 | 2300 | 18.36 | 18.19 | 32.41 |
| glaciers | ssp585 | 2100 | 13.97 | 14.00 | 16.47 |
| glaciers | ssp585 | 2150 | 21.43 | 21.45 | 27.14 |
| glaciers | ssp585 | 2300 | 27.01 | 27.01 | 35.20 |
| Greenland | ssp126 | 2100 | 6.25 | 6.25 | 6.60 |
| Greenland | ssp126 | 2150 | 7.53 | 7.58 | 9.92 |
| Greenland | ssp126 | 2300 | 9.34 | 9.47 | 18.79 |
| Greenland | ssp245 | 2100 | 8.21 | 8.19 | 7.09 |
| Greenland | ssp245 | 2150 | 11.89 | 11.96 | 11.43 |
| Greenland | ssp245 | 2300 | 17.03 | 17.12 | 23.76 |
| Greenland | ssp585 | 2100 | 13.43 | 13.35 | 8.24 |
| Greenland | ssp585 | 2150 | 27.04 | 26.99 | 15.57 |
| Greenland | ssp585 | 2300 | 47.26 | 47.48 | 40.35 |
| thermal exp. | ssp126 | 2100 | 13.51 | 13.51 | 13.76 |
| thermal exp. | ssp126 | 2150 | 16.94 | 16.88 | 17.22 |
| thermal exp. | ssp126 | 2300 | 22.14 | 22.08 | 22.80 |
| thermal exp. | ssp245 | 2100 | 17.74 | 17.73 | 18.03 |
| thermal exp. | ssp245 | 2150 | 26.28 | 26.26 | 26.68 |
| thermal exp. | ssp245 | 2300 | 40.96 | 40.67 | 42.05 |
| thermal exp. | ssp585 | 2100 | 26.54 | 26.60 | 27.05 |
| thermal exp. | ssp585 | 2150 | 49.04 | 49.06 | 49.95 |
| thermal exp. | ssp585 | 2300 | 98.85 | 98.47 | 100.22 |
...
| TOTAL | ssp126 | 2100 | 35.56 | 34.33 | 39.24 |
| TOTAL | ssp126 | 2150 | 46.51 | 44.64 | 55.17 |
| TOTAL | ssp126 | 2300 | 68.14 | 64.44 | 91.18 |
| TOTAL | ssp245 | 2100 | 53.95 | 44.92 | 70.87 |
| TOTAL | ssp245 | 2150 | 113.71 | 71.57 | 137.98 |
| TOTAL | ssp245 | 2300 | 276.80 | 162.84 | 317.51 |
| TOTAL | ssp585 | 2100 | 105.88 | 92.45 | 104.68 |
| TOTAL | ssp585 | 2150 | 219.48 | 195.59 | 202.83 |
| TOTAL | ssp585 | 2300 | 527.65 | 461.72 | 482.40 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 8.95x | **PASS** | FACTS 0.63-3.20 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 14.02x | **PASS** | FACTS 0.48-7.55 (n=4); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 21.56x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| Greenland | 2150 | 3.59x | **PASS(edge)** | FACTS 1.72-2.07 (n=2); MAGICC-SLR 3.48-3.48 (n=1); 0.11 outside the bracket = 6% of its own range |
| Greenland | 2300 | 5.06x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| thermal exp. | 2150 | 2.90x | **PASS(edge)** | FACTS 2.99-2.99 (n=1); MAGICC-SLR 3.94-3.94 (n=1); 0.09 outside the bracket = 10% of its own range |
...
| TOTAL | 2100 | 2.98x | **PASS(edge)** | FACTS 1.63-2.23 (n=7); MAGICC-SLR 2.75-2.75 (n=1); 0.23 outside the bracket = 20% of its own range |
| TOTAL | 2150 | 4.72x | **PASS** | FACTS 1.94-4.15 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
| TOTAL | 2300 | 7.74x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L15.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L15`.*
