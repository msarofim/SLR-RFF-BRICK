# Ladrillo benchmark — `L32`

*benchmark v1.0, 2026-09-23, repo `85e806f`. Champion arm: **L27**.*
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L32 | 0.1475 | 0.88 | bias -0.1149 cm = -0.69 sd; cov90 79%; n=126 |
...
| AIS | 0.1674 | 1920-1949 | L32 | 0.1792 | 1.07 | bias -0.1787 cm = -1.07 sd; cov90 100%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L32 | 0.0785 | 0.47 | bias -0.0466 cm = -0.28 sd; cov90 93%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L32 | 0.1692 | 1.01 | bias -0.1136 cm = -0.68 sd; cov90 27%; n=33 |
...
| glaciers | 0.4593 | full | L32 | 0.3183 | 0.69 | bias +0.0609 cm = +0.13 sd; cov90 69%; n=124 |
...
| glaciers | 0.4593 | 1920-1949 | L32 | 0.1832 | 0.40 | bias -0.0006 cm = -0.00 sd; cov90 100%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L32 | 0.2304 | 0.50 | bias -0.1162 cm = -0.25 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L32 | 0.0453 | 0.10 | bias -0.0199 cm = -0.04 sd; cov90 39%; n=31 |
...
| Greenland | 0.1832 | full | L32 | 0.1952 | 1.07 | bias -0.1408 cm = -0.77 sd; cov90 35%; n=126 |
...
| Greenland | 0.1832 | 1920-1949 | L32 | 0.1987 | 1.08 | bias -0.1504 cm = -0.82 sd; cov90 60%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L32 | 0.2662 | 1.45 | bias -0.2480 cm = -1.35 sd; cov90 0%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L32 | 0.1232 | 0.67 | bias -0.0836 cm = -0.46 sd; cov90 18%; n=33 |
...
| thermal exp. | 0.3091 | full | L32 | 0.4660 | 1.51 | bias +0.2639 cm = +0.85 sd; cov90 40%; n=126 |
...
| thermal exp. | 0.3091 | 1920-1949 | L32 | 0.6162 | 1.99 | bias +0.4945 cm = +1.60 sd; cov90 37%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L32 | 0.1956 | 0.63 | bias -0.0550 cm = -0.18 sd; cov90 70%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L32 | 0.3770 | 1.22 | bias +0.2458 cm = +0.80 sd; cov90 18%; n=33 |
...
| TOTAL | 1.5380 | full | L32 | 0.3437 | 0.22 | bias +0.0757 cm = +0.05 sd; cov90 81%; n=125 |
...
| TOTAL | 1.5380 | 1920-1949 | L32 | 0.3649 | 0.24 | bias +0.0212 cm = +0.01 sd; cov90 100%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L32 | 0.2535 | 0.16 | bias -0.0853 cm = -0.06 sd; cov90 88%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L32 | 0.2917 | 0.19 | bias +0.1065 cm = +0.07 sd; cov90 41%; n=32 |
...
| AIS | rate | L32 | 0.03152 | cm/yr | -1.79 | 0.75x obs; z=-1.79 vs the obs error bar |
...
| glaciers | rate | L32 | 0.066811 | cm/yr | -0.13 | 0.98x obs; z=-0.13 vs the obs error bar |
...
| Greenland | rate | L32 | 0.058793 | cm/yr | -0.69 | 0.89x obs; z=-0.69 vs the obs error bar |
...
| TOTAL | rate | L32 | 0.33995 | cm/yr | +0.52 | 1.05x obs; z=+0.52 vs the obs error bar |
...
| AIS | accel | L32 | 0.00024632 | cm/yr2 | -0.26 | ratio NOT INTERPRETABLE (obs is 1.21 se from zero); z=-0.26 vs the obs error bar |
...
| glaciers | accel | L32 | -0.00016491 | cm/yr2 | +0.86 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.86 vs the obs error bar |
...
| Greenland | accel | L32 | -0.00012716 | cm/yr2 | +0.29 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.29 vs the obs error bar |
...
| thermal exp. | accel | L32 | 0.0012394 | cm/yr2 | +1.63 | 1.47x obs; z=+1.63 vs the obs error bar |
...
| TOTAL | accel | L32 | 0.0013617 | cm/yr2 | +0.40 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.40 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.630 x lit median | **PASS** | ours 5.69 cm vs lit 3.66-11.93 (median 9.04), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.93] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 2.227 x lit spread | **FAIL** | ours 47.65 cm vs model-based lit 20.72-40.49 (median 21.40, n=5); ALL comparators 20.72-105.01 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.603 x lit median | **PASS** | ours 8.85 cm vs lit 5.34-24.01 (median 14.67), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.694 x lit spread | **PASS** | ours 88.27 cm vs model-based lit 33.17-71.04 (median 52.10, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp126 | 2300 | median_vs_lit | 2.023 x lit median | **WARN** | ours 17.62 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 3.062 x lit spread | **WARN** | ours 213.12 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 1.080 x lit median | **PASS** | ours 11.33 cm vs lit 5.22-12.17 (median 10.49), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.22-12.17] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.564 x lit spread | **PASS** | ours 56.03 cm vs model-based lit 20.77-42.39 (median 35.81, n=5); ALL comparators 20.77-113.21 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.750 x lit median | **WARN** | ours 47.78 cm vs lit 27.21-27.41 (median 27.31), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.394 x lit spread | **PASS** | ours 119.03 cm vs model-based lit 80.10-90.72 (median 85.41, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp245 | 2300 | median_vs_lit | 1.901 x lit median | **WARN** | ours 158.65 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.176 x lit spread | **PASS** | ours 319.41 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 2.862 x lit median | **PASS** | ours 37.77 cm vs lit 4.30-39.10 (median 13.20), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 4.30-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.278 x lit spread | **PASS** | ours 65.69 cm vs model-based lit 20.71-79.00 (median 51.40, n=5); ALL comparators 20.71-126.10; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 0.998 x lit median | **PASS** | ours 93.74 cm vs lit 34.31-153.62 (median 93.97), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.563 x lit spread | **PASS** | ours 113.07 cm vs model-based lit 125.28-276.23 (median 200.75, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.035 x lit median | **PASS** | ours 282.44 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.334 x lit spread | **WARN** | ours 315.69 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.782 x lit median | **WARN** | ours 8.10 cm vs lit 9.72-10.45 (median 10.36), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.649 x lit spread | **PASS** | ours 5.02 cm vs model-based lit 7.12-10.06 (median 7.74, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.772 x lit median | **WARN** | ours 9.99 cm vs lit 12.28-13.60 (median 12.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.580 x lit spread | **PASS** | ours 6.96 cm vs model-based lit 8.52-15.46 (median 11.99, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.687 x lit median | **WARN** | ours 12.59 cm vs lit 13.80-22.85 (median 18.33), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.590 x lit spread | **PASS** | ours 9.59 cm vs model-based lit 11.23-21.30 (median 16.26, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.683 x lit spread | **PASS** | ours 5.72 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.777 x lit median | **WARN** | ours 13.41 cm vs lit 16.71-17.82 (median 17.27), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.619 x lit spread | **PASS** | ours 8.96 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.683 x lit median | **WARN** | ours 18.11 cm vs lit 21.47-31.57 (median 26.52), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2100 | median_vs_lit | 0.844 x lit median | **WARN** | ours 12.91 cm vs lit 13.93-17.13 (median 15.30), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.809 x lit spread | **PASS** | ours 7.36 cm vs model-based lit 8.51-14.02 (median 9.10, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.837 x lit median | **WARN** | ours 20.19 cm vs lit 22.03-26.22 (median 24.13), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.786 x lit spread | **PASS** | ours 10.67 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.867 x lit median | **WARN** | ours 26.30 cm vs lit 29.10-31.57 (median 30.34), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 2.275 x lit spread | **WARN** | ours 11.33 cm vs model-based lit 0.13-9.83 (median 4.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2100 | median_vs_lit | 0.974 x lit median | **WARN** | ours 6.24 cm vs lit 6.36-8.31 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 6.36-13.80] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.404 x lit spread | **FAIL** | ours 3.87 cm vs model-based lit 8.22-17.86 (median 9.57, n=3); ALL comparators 8.22-68.88 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.889 x lit median | **WARN** | ours 8.28 cm vs lit 9.31-9.31 (median 9.31), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.412 x lit spread | **WARN** | ours 6.46 cm vs model-based lit 15.69-15.69 (median 15.69, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.778 x lit median | **WARN** | ours 11.66 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.428 x lit spread | **WARN** | ours 12.60 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp245 | 2100 | median_vs_lit | 0.785 x lit median | **WARN** | ours 7.29 cm vs lit 8.12-9.59 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 8.12-14.49] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.576 x lit spread | **PASS** | ours 4.81 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.672 x lit median | **WARN** | ours 11.11 cm vs lit 16.53-16.53 (median 16.53), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.699 x lit spread | **PASS** | ours 10.41 cm vs model-based lit 14.88-14.88 (median 14.88, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.500 x lit median | **WARN** | ours 17.90 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.766 x lit spread | **PASS** | ours 31.33 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.796 x lit median | **WARN** | ours 9.74 cm vs lit 11.67-13.49 (median 12.23), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 11.67-17.18] |
...
| Greenland | ssp585 | 2150 | median_vs_lit | 0.663 x lit median | **WARN** | ours 21.47 cm vs lit 32.40-32.40 (median 32.40), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.316 x lit spread | **WARN** | ours 28.72 cm vs model-based lit 90.97-90.97 (median 90.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.706 x lit median | **WARN** | ours 79.80 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.164 x lit spread | **WARN** | ours 111.46 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.125 x lit median | **PASS** | ours 15.69 cm vs lit 11.09-16.79 (median 13.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.907 x lit spread | **PASS** | ours 11.85 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.169 x lit median | **PASS** | ours 19.67 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.933 x lit spread | **PASS** | ours 16.74 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.153 x lit median | **PASS** | ours 25.09 cm vs lit 16.74-26.81 (median 21.77), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.029 x lit spread | **PASS** | ours 29.33 cm vs model-based lit 25.47-31.53 (median 28.50, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.048 x lit median | **PASS** | ours 19.82 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.868 x lit spread | **PASS** | ours 13.79 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.078 x lit median | **PASS** | ours 29.12 cm vs lit 23.23-30.82 (median 27.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.852 x lit spread | **PASS** | ours 23.11 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.074 x lit median | **PASS** | ours 44.84 cm vs lit 36.30-47.22 (median 41.76), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.882 x lit spread | **PASS** | ours 47.46 cm vs model-based lit 53.37-54.25 (median 53.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.970 x lit median | **WARN** | ours 27.72 cm vs lit 27.88-29.29 (median 28.59), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.799 x lit spread | **PASS** | ours 18.19 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.989 x lit median | **PASS** | ours 51.43 cm vs lit 49.94-54.12 (median 52.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.797 x lit spread | **PASS** | ours 37.67 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.961 x lit median | **WARN** | ours 102.29 cm vs lit 103.49-109.39 (median 106.44), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.803 x lit spread | **PASS** | ours 96.35 cm vs model-based lit 118.64-121.40 (median 120.02, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.855 x lit median | **PASS** | ours 39.08 cm vs lit 35.59-50.06 (median 45.68), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-55.88] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.289 x lit spread | **PASS** | ours 59.72 cm vs model-based lit 32.73-55.62 (median 46.34, n=7); ALL comparators 32.73-125.52 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 1.131 x lit median | **WARN** | ours 51.93 cm vs lit 45.94-45.94 (median 45.94), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.854 x lit spread | **PASS** | ours 109.33 cm vs model-based lit 58.97-58.97 (median 58.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.161 x lit median | **WARN** | ours 77.17 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.118 x lit spread | **WARN** | ours 246.91 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.969 x lit median | **PASS** | ours 53.52 cm vs lit 49.78-58.27 (median 55.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 49.78-67.77] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.325 x lit spread | **PASS** | ours 70.68 cm vs model-based lit 35.22-64.58 (median 53.36, n=7); ALL comparators 35.22-151.34 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.205 x lit median | **WARN** | ours 106.19 cm vs lit 88.11-88.11 (median 88.11), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.322 x lit spread | **PASS** | ours 143.21 cm vs model-based lit 108.33-108.33 (median 108.33, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.344 x lit median | **WARN** | ours 251.05 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.090 x lit spread | **PASS** | ours 370.34 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.215 x lit median | **PASS** | ours 91.50 cm vs lit 62.39-97.85 (median 75.33), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 62.39-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.194 x lit spread | **PASS** | ours 82.25 cm vs model-based lit 40.46-106.79 (median 68.88, n=7); ALL comparators 40.46-181.04 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.737 x lit median | **WARN** | ours 193.76 cm vs lit 262.93-262.93 (median 262.93), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.376 x lit spread | **WARN** | ours 151.75 cm vs model-based lit 403.38-403.38 (median 403.38, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.496 x lit median | **WARN** | ours 503.85 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.310 x lit spread | **WARN** | ours 428.02 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 5.69 | 4.92 | 4.32 |
| AIS | ssp126 | 2150 | 8.85 | 7.68 | 6.52 |
| AIS | ssp126 | 2300 | 17.62 | 15.23 | 13.01 |
| AIS | ssp245 | 2100 | 11.33 | 10.55 | 27.41 |
| AIS | ssp245 | 2150 | 47.78 | 46.18 | 72.60 |
| AIS | ssp245 | 2300 | 158.65 | 156.34 | 205.94 |
| AIS | ssp585 | 2100 | 37.77 | 36.66 | 44.14 |
| AIS | ssp585 | 2150 | 93.74 | 92.56 | 97.88 |
| AIS | ssp585 | 2300 | 282.44 | 277.71 | 276.83 |
| glaciers | ssp126 | 2100 | 8.10 | 8.11 | 12.09 |
| glaciers | ssp126 | 2150 | 9.99 | 9.93 | 17.44 |
| glaciers | ssp126 | 2300 | 12.59 | 12.48 | 27.72 |
| glaciers | ssp245 | 2100 | 9.73 | 9.72 | 13.34 |
| glaciers | ssp245 | 2150 | 13.41 | 13.41 | 20.69 |
| glaciers | ssp245 | 2300 | 18.11 | 18.06 | 32.50 |
| glaciers | ssp585 | 2100 | 12.91 | 12.91 | 15.61 |
| glaciers | ssp585 | 2150 | 20.19 | 20.17 | 26.25 |
| glaciers | ssp585 | 2300 | 26.30 | 26.14 | 35.36 |
| Greenland | ssp126 | 2100 | 6.24 | 6.23 | 6.62 |
| Greenland | ssp126 | 2150 | 8.28 | 8.30 | 10.01 |
| Greenland | ssp126 | 2300 | 11.66 | 11.72 | 19.04 |
| Greenland | ssp245 | 2100 | 7.29 | 7.31 | 7.03 |
| Greenland | ssp245 | 2150 | 11.11 | 11.18 | 11.35 |
| Greenland | ssp245 | 2300 | 17.90 | 17.89 | 23.71 |
| Greenland | ssp585 | 2100 | 9.74 | 9.84 | 7.88 |
| Greenland | ssp585 | 2150 | 21.47 | 21.49 | 14.77 |
| Greenland | ssp585 | 2300 | 79.80 | 79.49 | 38.60 |
| thermal exp. | ssp126 | 2100 | 15.69 | 15.73 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.67 | 19.40 | 19.18 |
| thermal exp. | ssp126 | 2300 | 25.09 | 25.07 | 25.08 |
| thermal exp. | ssp245 | 2100 | 19.82 | 19.88 | 19.37 |
| thermal exp. | ssp245 | 2150 | 29.12 | 28.99 | 28.53 |
| thermal exp. | ssp245 | 2300 | 44.84 | 44.66 | 44.66 |
| thermal exp. | ssp585 | 2100 | 27.72 | 27.81 | 27.07 |
| thermal exp. | ssp585 | 2150 | 51.43 | 51.39 | 50.34 |
| thermal exp. | ssp585 | 2300 | 102.29 | 102.60 | 101.88 |
...
| TOTAL | ssp126 | 2100 | 39.08 | 38.00 | 41.16 |
| TOTAL | ssp126 | 2150 | 51.93 | 50.28 | 57.89 |
| TOTAL | ssp126 | 2300 | 77.17 | 74.81 | 94.76 |
| TOTAL | ssp245 | 2100 | 53.52 | 52.65 | 70.19 |
| TOTAL | ssp245 | 2150 | 106.19 | 104.85 | 137.98 |
| TOTAL | ssp245 | 2300 | 251.05 | 247.73 | 317.82 |
| TOTAL | ssp585 | 2100 | 91.50 | 90.67 | 98.00 |
| TOTAL | ssp585 | 2150 | 193.76 | 191.21 | 195.15 |
| TOTAL | ssp585 | 2300 | 503.85 | 497.87 | 467.87 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 6.64x | **PASS** | FACTS 0.73-2.10 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 10.60x | **PASS** | FACTS 1.43-1.43 (n=1); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 16.03x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.59x | **PASS** | FACTS 1.43-1.65 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.02x | **CHECK(wide)** | FACTS 1.93-1.93 (n=1); MAGICC-SLR 1.79-1.79 (n=1); 0.09 outside the bracket = 70% of its own range |
...
| Greenland | 2150 | 2.59x | **WARN** | MAGICC-SLR 3.48-3.48 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| Greenland | 2300 | 6.85x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| thermal exp. | 2100 | 1.77x | **PASS** | FACTS 1.74-1.74 (n=1); MAGICC-SLR 2.51-2.51 (n=1) |
| thermal exp. | 2150 | 2.61x | **PASS** | FACTS 2.58-2.58 (n=1); MAGICC-SLR 3.94-3.94 (n=1) |
| thermal exp. | 2300 | 4.08x | **PASS(edge)** | FACTS 4.08-4.08 (n=1); MAGICC-SLR 6.18-6.18 (n=1); 0.00 outside the bracket = 0% of its own range |
...
| TOTAL | 2100 | 2.34x | **PASS** | FACTS 1.44-1.82 (n=7); MAGICC-SLR 2.75-2.75 (n=1) |
| TOTAL | 2150 | 3.73x | **WARN** | MAGICC-SLR 5.72-5.72 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| TOTAL | 2300 | 6.53x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L32.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L32`.*
