# Ladrillo benchmark — `L30`

*benchmark v1.0, 2026-09-22, repo `d9b24a4`. Champion arm: **L27**.*
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L30 | 0.2568 | 1.53 | bias -0.1919 cm = -1.15 sd; cov90 40%; n=126 |
...
| AIS | 0.1674 | 1920-1949 | L30 | 0.3226 | 1.93 | bias -0.3176 cm = -1.90 sd; cov90 0%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L30 | 0.1075 | 0.64 | bias -0.0703 cm = -0.42 sd; cov90 79%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L30 | 0.1216 | 0.73 | bias -0.0751 cm = -0.45 sd; cov90 52%; n=33 |
...
| glaciers | 0.4593 | full | L30 | 0.3212 | 0.70 | bias +0.0650 cm = +0.14 sd; cov90 69%; n=124 |
...
| glaciers | 0.4593 | 1920-1949 | L30 | 0.1831 | 0.40 | bias +0.0067 cm = +0.01 sd; cov90 100%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L30 | 0.2271 | 0.49 | bias -0.1139 cm = -0.25 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L30 | 0.0459 | 0.10 | bias -0.0207 cm = -0.05 sd; cov90 39%; n=31 |
...
| Greenland | 0.1832 | full | L30 | 0.1956 | 1.07 | bias -0.1425 cm = -0.78 sd; cov90 34%; n=126 |
...
| Greenland | 0.1832 | 1920-1949 | L30 | 0.2003 | 1.09 | bias -0.1529 cm = -0.83 sd; cov90 57%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L30 | 0.2658 | 1.45 | bias -0.2476 cm = -1.35 sd; cov90 0%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L30 | 0.1248 | 0.68 | bias -0.0850 cm = -0.46 sd; cov90 18%; n=33 |
...
| thermal exp. | 0.3091 | full | L30 | 0.4642 | 1.50 | bias +0.2613 cm = +0.85 sd; cov90 40%; n=126 |
...
| thermal exp. | 0.3091 | 1920-1949 | L30 | 0.6119 | 1.98 | bias +0.4894 cm = +1.58 sd; cov90 37%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L30 | 0.1964 | 0.64 | bias -0.0580 cm = -0.19 sd; cov90 70%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L30 | 0.3801 | 1.23 | bias +0.2480 cm = +0.80 sd; cov90 18%; n=33 |
...
| TOTAL | 1.5380 | full | L30 | 0.3143 | 0.20 | bias -0.0111 cm = -0.01 sd; cov90 80%; n=125 |
...
| TOTAL | 1.5380 | 1920-1949 | L30 | 0.3629 | 0.24 | bias -0.1329 cm = -0.09 sd; cov90 97%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L30 | 0.2865 | 0.19 | bias -0.1204 cm = -0.08 sd; cov90 88%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L30 | 0.3250 | 0.21 | bias +0.1467 cm = +0.10 sd; cov90 41%; n=32 |
...
| AIS | rate | L30 | 0.035316 | cm/yr | -1.13 | 0.84x obs; z=-1.13 vs the obs error bar |
...
| glaciers | rate | L30 | 0.066727 | cm/yr | -0.14 | 0.98x obs; z=-0.14 vs the obs error bar |
...
| Greenland | rate | L30 | 0.058679 | cm/yr | -0.70 | 0.89x obs; z=-0.70 vs the obs error bar |
...
| TOTAL | rate | L30 | 0.34413 | cm/yr | +0.66 | 1.06x obs; z=+0.66 vs the obs error bar |
...
| AIS | accel | L30 | 0.00019671 | cm/yr2 | -0.45 | ratio NOT INTERPRETABLE (obs is 1.21 se from zero); z=-0.45 vs the obs error bar |
...
| glaciers | accel | L30 | -0.00016428 | cm/yr2 | +0.86 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.86 vs the obs error bar |
...
| Greenland | accel | L30 | -0.00012995 | cm/yr2 | +0.28 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.28 vs the obs error bar |
...
| thermal exp. | accel | L30 | 0.0012414 | cm/yr2 | +1.64 | 1.47x obs; z=+1.64 vs the obs error bar |
...
| TOTAL | accel | L30 | 0.0013196 | cm/yr2 | +0.37 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.37 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.617 x lit median | **PASS** | ours 5.58 cm vs lit 3.66-11.93 (median 9.04), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.93] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 1.958 x lit spread | **PASS** | ours 41.89 cm vs model-based lit 20.72-40.49 (median 21.40, n=5); ALL comparators 20.72-105.01 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.586 x lit median | **PASS** | ours 8.60 cm vs lit 5.34-24.01 (median 14.67), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.559 x lit spread | **PASS** | ours 81.22 cm vs model-based lit 33.17-71.04 (median 52.10, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp126 | 2300 | median_vs_lit | 1.961 x lit median | **WARN** | ours 17.08 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 2.965 x lit spread | **WARN** | ours 206.37 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 0.803 x lit median | **PASS** | ours 8.42 cm vs lit 5.22-12.17 (median 10.49), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.22-12.17] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.491 x lit spread | **PASS** | ours 53.39 cm vs model-based lit 20.77-42.39 (median 35.81, n=5); ALL comparators 20.77-113.21 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.302 x lit median | **WARN** | ours 35.57 cm vs lit 27.21-27.41 (median 27.31), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.341 x lit spread | **PASS** | ours 114.52 cm vs model-based lit 80.10-90.72 (median 85.41, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp245 | 2300 | median_vs_lit | 1.702 x lit median | **WARN** | ours 142.01 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.162 x lit spread | **PASS** | ours 315.44 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 2.687 x lit median | **PASS** | ours 35.46 cm vs lit 4.30-39.10 (median 13.20), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 4.30-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.243 x lit spread | **PASS** | ours 63.89 cm vs model-based lit 20.71-79.00 (median 51.40, n=5); ALL comparators 20.71-126.10; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 0.953 x lit median | **PASS** | ours 89.53 cm vs lit 34.31-153.62 (median 93.97), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.540 x lit spread | **PASS** | ours 108.49 cm vs model-based lit 125.28-276.23 (median 200.75, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 0.999 x lit median | **PASS** | ours 272.85 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.313 x lit spread | **WARN** | ours 296.10 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.788 x lit median | **WARN** | ours 8.17 cm vs lit 9.72-10.45 (median 10.36), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.638 x lit spread | **PASS** | ours 4.94 cm vs model-based lit 7.12-10.06 (median 7.74, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.776 x lit median | **WARN** | ours 10.04 cm vs lit 12.28-13.60 (median 12.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.560 x lit spread | **PASS** | ours 6.71 cm vs model-based lit 8.52-15.46 (median 11.99, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.688 x lit median | **WARN** | ours 12.62 cm vs lit 13.80-22.85 (median 18.33), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.586 x lit spread | **PASS** | ours 9.54 cm vs model-based lit 11.23-21.30 (median 16.26, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2100 | median_vs_lit | 0.778 x lit median | **WARN** | ours 9.76 cm vs lit 11.22-12.90 (median 12.54), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.676 x lit spread | **PASS** | ours 5.66 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.777 x lit median | **WARN** | ours 13.43 cm vs lit 16.71-17.82 (median 17.27), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.586 x lit spread | **PASS** | ours 8.48 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.682 x lit median | **WARN** | ours 18.08 cm vs lit 21.47-31.57 (median 26.52), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 0.947 x lit spread | **PASS** | ours 11.96 cm vs model-based lit 10.95-14.32 (median 12.63, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.786 x lit spread | **PASS** | ours 7.15 cm vs model-based lit 8.51-14.02 (median 9.10, n=3) |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.749 x lit spread | **PASS** | ours 10.17 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.865 x lit median | **WARN** | ours 26.24 cm vs lit 29.10-31.57 (median 30.34), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2100 | median_vs_lit | 0.975 x lit median | **WARN** | ours 6.24 cm vs lit 6.36-8.31 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 6.36-13.80] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.412 x lit spread | **FAIL** | ours 3.94 cm vs model-based lit 8.22-17.86 (median 9.57, n=3); ALL comparators 8.22-68.88 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.893 x lit median | **WARN** | ours 8.32 cm vs lit 9.31-9.31 (median 9.31), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.414 x lit spread | **WARN** | ours 6.50 cm vs model-based lit 15.69-15.69 (median 15.69, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.421 x lit spread | **WARN** | ours 12.37 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.592 x lit spread | **PASS** | ours 4.94 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.709 x lit spread | **PASS** | ours 10.55 cm vs model-based lit 14.88-14.88 (median 14.88, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.505 x lit median | **WARN** | ours 18.07 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.793 x lit spread | **PASS** | ours 32.44 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.673 x lit spread | **PASS** | ours 8.18 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.663 x lit median | **WARN** | ours 21.49 cm vs lit 32.40-32.40 (median 32.40), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.313 x lit spread | **WARN** | ours 28.50 cm vs model-based lit 90.97-90.97 (median 90.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.712 x lit median | **WARN** | ours 80.50 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.165 x lit spread | **WARN** | ours 112.42 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.929 x lit spread | **PASS** | ours 12.13 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.160 x lit median | **PASS** | ours 19.52 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.954 x lit spread | **PASS** | ours 17.13 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.157 x lit median | **PASS** | ours 25.20 cm vs lit 16.74-26.81 (median 21.77), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.024 x lit spread | **PASS** | ours 29.18 cm vs model-based lit 25.47-31.53 (median 28.50, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.053 x lit median | **PASS** | ours 19.90 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.884 x lit spread | **PASS** | ours 14.05 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.880 x lit spread | **PASS** | ours 23.87 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.901 x lit spread | **PASS** | ours 48.47 cm vs model-based lit 53.37-54.25 (median 53.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.977 x lit median | **PASS** | ours 27.93 cm vs lit 27.88-29.29 (median 28.59), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.814 x lit spread | **PASS** | ours 18.53 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.989 x lit median | **PASS** | ours 51.47 cm vs lit 49.94-54.12 (median 52.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.824 x lit spread | **PASS** | ours 38.95 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.970 x lit median | **WARN** | ours 103.29 cm vs lit 103.49-109.39 (median 106.44), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.818 x lit spread | **PASS** | ours 98.22 cm vs model-based lit 118.64-121.40 (median 120.02, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.853 x lit median | **PASS** | ours 38.95 cm vs lit 35.59-50.06 (median 45.68), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-55.88] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.191 x lit spread | **PASS** | ours 55.20 cm vs model-based lit 32.73-55.62 (median 46.34, n=7); ALL comparators 32.73-125.52 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 1.124 x lit median | **WARN** | ours 51.63 cm vs lit 45.94-45.94 (median 45.94), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.735 x lit spread | **PASS** | ours 102.29 cm vs model-based lit 58.97-58.97 (median 58.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.156 x lit median | **WARN** | ours 76.85 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.067 x lit spread | **WARN** | ours 240.97 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.920 x lit median | **PASS** | ours 50.81 cm vs lit 49.78-58.27 (median 55.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 49.78-67.77] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.270 x lit spread | **PASS** | ours 67.74 cm vs model-based lit 35.22-64.58 (median 53.36, n=7); ALL comparators 35.22-151.34 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.062 x lit median | **WARN** | ours 93.60 cm vs lit 88.11-88.11 (median 88.11), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.286 x lit spread | **PASS** | ours 139.33 cm vs model-based lit 108.33-108.33 (median 108.33, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.257 x lit median | **WARN** | ours 234.73 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.061 x lit spread | **PASS** | ours 360.45 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.190 x lit median | **PASS** | ours 89.66 cm vs lit 62.39-97.85 (median 75.33), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 62.39-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.161 x lit spread | **PASS** | ours 79.98 cm vs model-based lit 40.46-106.79 (median 68.88, n=7); ALL comparators 40.46-181.04 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.723 x lit median | **WARN** | ours 190.12 cm vs lit 262.93-262.93 (median 262.93), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.366 x lit spread | **WARN** | ours 147.45 cm vs model-based lit 403.38-403.38 (median 403.38, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.490 x lit median | **WARN** | ours 498.05 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.298 x lit spread | **WARN** | ours 411.54 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2150 | 8.60 | 7.68 | 6.52 |
| AIS | ssp126 | 2300 | 17.08 | 15.23 | 13.01 |
| AIS | ssp245 | 2100 | 8.42 | 10.55 | 27.41 |
| AIS | ssp245 | 2150 | 35.57 | 46.18 | 72.60 |
| AIS | ssp245 | 2300 | 142.01 | 156.34 | 205.94 |
| AIS | ssp585 | 2100 | 35.46 | 36.66 | 44.14 |
| AIS | ssp585 | 2150 | 89.53 | 92.56 | 97.88 |
| AIS | ssp585 | 2300 | 272.85 | 277.71 | 276.83 |
| glaciers | ssp126 | 2100 | 8.17 | 8.11 | 12.09 |
| glaciers | ssp126 | 2150 | 10.04 | 9.93 | 17.44 |
| glaciers | ssp126 | 2300 | 12.62 | 12.48 | 27.72 |
| glaciers | ssp245 | 2100 | 9.76 | 9.72 | 13.34 |
| glaciers | ssp245 | 2150 | 13.43 | 13.41 | 20.69 |
| glaciers | ssp245 | 2300 | 18.08 | 18.06 | 32.50 |
| glaciers | ssp585 | 2100 | 12.88 | 12.91 | 15.61 |
| glaciers | ssp585 | 2150 | 20.13 | 20.17 | 26.25 |
| glaciers | ssp585 | 2300 | 26.24 | 26.14 | 35.36 |
...
| Greenland | ssp245 | 2300 | 18.07 | 17.89 | 23.71 |
| Greenland | ssp585 | 2100 | 9.81 | 9.84 | 7.88 |
| Greenland | ssp585 | 2150 | 21.49 | 21.49 | 14.77 |
| Greenland | ssp585 | 2300 | 80.50 | 79.49 | 38.60 |
| thermal exp. | ssp126 | 2100 | 15.77 | 15.73 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.52 | 19.40 | 19.18 |
| thermal exp. | ssp126 | 2300 | 25.20 | 25.07 | 25.08 |
| thermal exp. | ssp245 | 2100 | 19.90 | 19.88 | 19.37 |
| thermal exp. | ssp245 | 2150 | 29.12 | 28.99 | 28.53 |
| thermal exp. | ssp245 | 2300 | 44.84 | 44.66 | 44.66 |
| thermal exp. | ssp585 | 2100 | 27.93 | 27.81 | 27.07 |
| thermal exp. | ssp585 | 2150 | 51.47 | 51.39 | 50.34 |
| thermal exp. | ssp585 | 2300 | 103.29 | 102.60 | 101.88 |
...
| TOTAL | ssp126 | 2100 | 38.95 | 38.00 | 41.16 |
| TOTAL | ssp126 | 2150 | 51.63 | 50.28 | 57.89 |
| TOTAL | ssp126 | 2300 | 76.85 | 74.81 | 94.76 |
| TOTAL | ssp245 | 2100 | 50.81 | 52.65 | 70.19 |
| TOTAL | ssp245 | 2150 | 93.60 | 104.85 | 137.98 |
| TOTAL | ssp245 | 2300 | 234.73 | 247.73 | 317.82 |
| TOTAL | ssp585 | 2100 | 89.66 | 90.67 | 98.00 |
| TOTAL | ssp585 | 2150 | 190.12 | 191.21 | 195.15 |
| TOTAL | ssp585 | 2300 | 498.05 | 497.87 | 467.87 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 6.36x | **PASS** | FACTS 0.73-2.10 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 10.41x | **PASS** | FACTS 1.43-1.43 (n=1); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 15.98x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.58x | **PASS** | FACTS 1.43-1.65 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.01x | **CHECK(wide)** | FACTS 1.93-1.93 (n=1); MAGICC-SLR 1.79-1.79 (n=1); 0.08 outside the bracket = 59% of its own range |
...
| thermal exp. | 2150 | 2.64x | **PASS** | FACTS 2.58-2.58 (n=1); MAGICC-SLR 3.94-3.94 (n=1) |
| thermal exp. | 2300 | 4.10x | **PASS** | FACTS 4.08-4.08 (n=1); MAGICC-SLR 6.18-6.18 (n=1) |
...
| TOTAL | 2150 | 3.68x | **WARN** | MAGICC-SLR 5.72-5.72 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| TOTAL | 2300 | 6.48x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L30.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L30`.*
