...
| ar1_prof | Ladrillo L32 | 50 | 231.5 | 212.0 | -363.0 | -351.7 | -152.1 |
...
- **ar1_prof**: Δln L (Ladrillo − BRICK 2.0) = **116.2** for Δk = 15. ΔAIC (BRICK − Ladrillo) = **202.4**, ΔBIC = **139.1**. The likelihood gain is worth 116 parameters under AIC and 37 under BIC (ln N = 6.22); Ladrillo has 15 more.
...
|---|---|---|---|---|---|---|---|
| ais | 129.9 | 0.012 | 0.896 | 121.8 | 0.014 | 0.900 | 8.1 |
| gsic | 4.0 | 0.000 | 0.241 | -65.7 | 0.246 | 0.900 | 69.7 |
| gis | 96.4 | 0.037 | 0.900 | 57.6 | 0.093 | 0.900 | 38.8 |
| steric | 1.1 | 0.113 | 0.900 | 1.5 | 0.111 | 0.900 | -0.4 |
...
| ar1_prof | -162.4 | -167.1 | -165.3 | -186.8 |
