...
*benchmark v1.0, 2026-08-28, repo `aa64e52`. Champion arm: **L21** (the candidate IS the champion — no delta column).*
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.074 x lit spread | **PASS** | ours 291.71 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| AIS | ssp585 | 2300 | median_vs_lit | 0.979 x lit median | **PASS** | ours 267.28 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.297 x lit spread | **WARN** | ours 280.76 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.755 x lit spread | **PASS** | ours 11.25 cm vs model-based lit 14.88-14.93 (median 14.91, n=2); ALL comparators 14.88-88.90; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.536 x lit spread | **PASS** | ours 21.91 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.808 x lit spread | **PASS** | ours 9.82 cm vs model-based lit 11.46-17.10 (median 12.15, n=3); ALL comparators 11.46-93.18 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.822 x lit median | **WARN** | ours 24.54 cm vs lit 27.33-32.40 (median 29.87), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 27.33-38.13] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.432 x lit spread | **WARN** | ours 25.04 cm vs model-based lit 24.97-90.97 (median 57.97, n=2); ALL comparators 24.97-121.86; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.392 x lit median | **WARN** | ours 44.34 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.084 x lit spread | **WARN** | ours 57.18 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.004 x lit spread | **PASS** | ours 341.04 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.087 x lit median | **PASS** | ours 86.29 cm vs lit 64.93-97.85 (median 79.41), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 64.93-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.107 x lit spread | **PASS** | ours 77.83 cm vs model-based lit 41.09-106.79 (median 70.33, n=7); ALL comparators 41.09-197.47 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.912 x lit median | **PASS** | ours 189.01 cm vs lit 117.08-310.66 (median 207.31), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 117.08-310.66] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.509 x lit spread | **WARN** | ours 140.96 cm vs model-based lit 77.93-414.71 (median 277.00, n=4); ALL comparators 77.93-631.59; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 2xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.450 x lit median | **WARN** | ours 457.20 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.260 x lit spread | **WARN** | ours 358.71 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 4.46 | (is champion) | 4.21 |
| AIS | ssp126 | 2150 | 6.83 | (is champion) | 6.37 |
| AIS | ssp126 | 2300 | 13.48 | (is champion) | 12.64 |
| AIS | ssp245 | 2100 | 5.45 | (is champion) | 29.21 |
| AIS | ssp245 | 2150 | 10.89 | (is champion) | 74.53 |
| AIS | ssp245 | 2300 | 65.92 | (is champion) | 207.88 |
| AIS | ssp585 | 2100 | 29.49 | (is champion) | 48.98 |
| AIS | ssp585 | 2150 | 84.25 | (is champion) | 104.07 |
| AIS | ssp585 | 2300 | 267.28 | (is champion) | 290.17 |
| glaciers | ssp126 | 2100 | 7.99 | (is champion) | 12.00 |
| glaciers | ssp126 | 2150 | 9.86 | (is champion) | 17.18 |
| glaciers | ssp126 | 2300 | 12.40 | (is champion) | 27.26 |
| glaciers | ssp245 | 2100 | 9.64 | (is champion) | 13.48 |
| glaciers | ssp245 | 2150 | 13.35 | (is champion) | 20.82 |
| glaciers | ssp245 | 2300 | 18.33 | (is champion) | 32.41 |
| glaciers | ssp585 | 2100 | 12.88 | (is champion) | 16.47 |
| glaciers | ssp585 | 2150 | 20.40 | (is champion) | 27.14 |
| glaciers | ssp585 | 2300 | 26.65 | (is champion) | 35.20 |
| Greenland | ssp126 | 2100 | 6.52 | (is champion) | 6.60 |
| Greenland | ssp126 | 2150 | 7.97 | (is champion) | 9.92 |
| Greenland | ssp126 | 2300 | 10.04 | (is champion) | 18.79 |
| Greenland | ssp245 | 2100 | 8.16 | (is champion) | 7.09 |
| Greenland | ssp245 | 2150 | 11.87 | (is champion) | 11.43 |
| Greenland | ssp245 | 2300 | 17.16 | (is champion) | 23.76 |
| Greenland | ssp585 | 2100 | 12.04 | (is champion) | 8.24 |
| Greenland | ssp585 | 2150 | 24.54 | (is champion) | 15.57 |
| Greenland | ssp585 | 2300 | 44.34 | (is champion) | 40.35 |
| thermal exp. | ssp126 | 2100 | 16.05 | (is champion) | 13.76 |
| thermal exp. | ssp126 | 2150 | 20.05 | (is champion) | 17.22 |
| thermal exp. | ssp126 | 2300 | 25.72 | (is champion) | 22.80 |
| thermal exp. | ssp245 | 2100 | 20.31 | (is champion) | 18.03 |
| thermal exp. | ssp245 | 2150 | 29.74 | (is champion) | 26.68 |
| thermal exp. | ssp245 | 2300 | 45.98 | (is champion) | 42.05 |
| thermal exp. | ssp585 | 2100 | 28.30 | (is champion) | 27.05 |
| thermal exp. | ssp585 | 2150 | 52.62 | (is champion) | 49.95 |
| thermal exp. | ssp585 | 2300 | 105.22 | (is champion) | 100.22 |
...
| TOTAL | ssp126 | 2100 | 37.80 | (is champion) | 39.24 |
| TOTAL | ssp126 | 2150 | 49.25 | (is champion) | 55.17 |
| TOTAL | ssp126 | 2300 | 70.85 | (is champion) | 91.18 |
| TOTAL | ssp245 | 2100 | 47.34 | (is champion) | 70.87 |
| TOTAL | ssp245 | 2150 | 74.79 | (is champion) | 137.98 |
| TOTAL | ssp245 | 2300 | 158.93 | (is champion) | 317.51 |
| TOTAL | ssp585 | 2100 | 86.29 | (is champion) | 104.68 |
| TOTAL | ssp585 | 2150 | 189.01 | (is champion) | 202.83 |
| TOTAL | ssp585 | 2300 | 457.20 | (is champion) | 482.40 |
...
| AIS | 2300 | 19.83x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| Greenland | 2300 | 4.41x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2150 | 3.84x | **PASS** | FACTS 1.94-4.15 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
