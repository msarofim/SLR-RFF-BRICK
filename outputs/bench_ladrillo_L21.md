...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.493 x lit median | **PASS** | ours 4.46 cm vs lit 3.66-11.93 (median 9.04), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.93]; ⚠ BIMODAL cell -- our MEAN is 6.64 cm = 0.73x the literature median, and the median sits entirely inside the near mode |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 0.750 x lit spread | **N/A(bimodal)** | ours 16.05 cm vs model-based lit 20.72-40.49 (median 21.40, n=5); ALL comparators 20.72-105.01; ⚠ p05-p99/p05-p95 = 3.21 vs Gaussian 1.207 => BIMODAL, and p95 is blind to the far mode (p05-p99 = 51.46 cm). The p5-p95 ratio is a property of the QUANTILE here, not of the model |
| AIS | ssp126 | 2150 | median_vs_lit | 0.374 x lit median | **PASS** | ours 6.83 cm vs lit 5.34-27.64 (median 18.27), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 5.34-27.64]; ⚠ BIMODAL cell -- our MEAN is 11.59 cm = 0.63x the literature median, and the median sits entirely inside the near mode |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 0.696 x lit spread | **N/A(bimodal)** | ours 40.03 cm vs model-based lit 33.17-242.51 (median 57.53, n=4); ALL comparators 33.17-242.51; ⚠ p05-p99/p05-p95 = 2.59 vs Gaussian 1.207 => BIMODAL, and p95 is blind to the far mode (p05-p99 = 103.51 cm). The p5-p95 ratio is a property of the QUANTILE here, not of the model |
...
| AIS | ssp245 | 2100 | median_vs_lit | 0.519 x lit median | **PASS** | ours 5.45 cm vs lit 5.22-12.17 (median 10.49), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.22-12.17] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.212 x lit spread | **PASS** | ours 43.42 cm vs model-based lit 20.77-42.39 (median 35.81, n=5); ALL comparators 20.77-113.21 |
| AIS | ssp245 | 2150 | median_vs_lit | 0.399 x lit median | **PASS** | ours 10.89 cm vs lit 10.52-30.38 (median 27.31), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 10.52-30.38] |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.197 x lit spread | **WARN** | ours 102.22 cm vs model-based lit 45.12-305.79 (median 85.41, n=4); ALL comparators 45.12-305.79; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
...
| AIS | ssp585 | 2100 | median_vs_lit | 2.200 x lit median | **PASS** | ours 29.04 cm vs lit 4.30-39.10 (median 13.20), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 4.30-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.137 x lit spread | **PASS** | ours 58.46 cm vs model-based lit 20.71-79.00 (median 51.40, n=5); ALL comparators 20.71-126.10; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 1.039 x lit median | **PASS** | ours 84.35 cm vs lit 6.93-153.62 (median 81.21), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 6.93-153.62] |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.515 x lit spread | **WARN** | ours 103.40 cm vs model-based lit 48.47-385.93 (median 200.75, n=4); ALL comparators 48.47-505.64; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 0.976 x lit median | **WARN** | ours 266.35 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.298 x lit spread | **WARN** | ours 281.65 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.771 x lit median | **WARN** | ours 7.99 cm vs lit 9.72-10.45 (median 10.36), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.775 x lit spread | **PASS** | ours 6.00 cm vs model-based lit 7.12-10.06 (median 7.74, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.762 x lit median | **WARN** | ours 9.86 cm vs lit 12.28-13.60 (median 12.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.670 x lit spread | **PASS** | ours 8.04 cm vs model-based lit 8.52-15.46 (median 11.99, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp245 | 2100 | median_vs_lit | 0.769 x lit median | **WARN** | ours 9.64 cm vs lit 11.22-12.90 (median 12.54), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.832 x lit spread | **PASS** | ours 6.97 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.773 x lit median | **WARN** | ours 13.35 cm vs lit 16.71-17.82 (median 17.27), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.701 x lit spread | **PASS** | ours 10.14 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2100 | median_vs_lit | 0.847 x lit median | **WARN** | ours 12.95 cm vs lit 13.93-17.13 (median 15.30), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.937 x lit spread | **PASS** | ours 8.52 cm vs model-based lit 8.51-14.02 (median 9.10, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.845 x lit median | **WARN** | ours 20.38 cm vs lit 22.03-26.22 (median 24.13), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.844 x lit spread | **PASS** | ours 11.46 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.915 x lit median | **WARN** | ours 26.63 cm vs lit 29.10-29.10 (median 29.10), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 1.208 x lit spread | **PASS** | ours 11.88 cm vs model-based lit 9.83-9.83 (median 9.83, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp126 | 2100 | median_vs_lit | 1.019 x lit median | **PASS** | ours 6.52 cm vs lit 6.36-8.31 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 6.36-13.80] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.463 x lit spread | **FAIL** | ours 4.43 cm vs model-based lit 8.22-17.86 (median 9.57, n=3); ALL comparators 8.22-68.88 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.673 x lit median | **WARN** | ours 7.97 cm vs lit 9.31-14.39 (median 11.85), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 9.31-24.45] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.423 x lit spread | **WARN** | ours 6.55 cm vs model-based lit 15.32-15.69 (median 15.51, n=2); ALL comparators 15.32-93.49; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2100 | median_vs_lit | 0.879 x lit median | **PASS** | ours 8.16 cm vs lit 8.12-9.59 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 8.12-14.49] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.690 x lit spread | **PASS** | ours 5.76 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.688 x lit median | **WARN** | ours 11.87 cm vs lit 16.53-17.98 (median 17.26), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 16.53-25.78] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.746 x lit spread | **PASS** | ours 11.26 cm vs model-based lit 14.88-15.32 (median 15.10, n=2); ALL comparators 14.88-104.03; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp585 | 2100 | median_vs_lit | 0.985 x lit median | **PASS** | ours 12.05 cm vs lit 11.67-13.49 (median 12.23), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 11.67-17.18] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.849 x lit spread | **PASS** | ours 10.32 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.908 x lit median | **PASS** | ours 25.65 cm vs lit 24.11-32.40 (median 28.26), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 24.11-32.51] ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.571 x lit spread | **PASS** | ours 31.25 cm vs model-based lit 18.48-90.97 (median 54.73, n=2); ALL comparators 18.48-113.11; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.741 x lit median | **WARN** | ours 83.69 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.163 x lit spread | **WARN** | ours 110.70 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.152 x lit median | **PASS** | ours 16.05 cm vs lit 11.09-16.79 (median 13.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.917 x lit spread | **PASS** | ours 11.98 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.191 x lit median | **PASS** | ours 20.05 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.970 x lit spread | **PASS** | ours 17.41 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.074 x lit median | **PASS** | ours 20.31 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.887 x lit spread | **PASS** | ours 14.09 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.100 x lit median | **PASS** | ours 29.74 cm vs lit 23.23-30.82 (median 27.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.877 x lit spread | **PASS** | ours 23.79 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.993 x lit median | **PASS** | ours 28.40 cm vs lit 27.88-29.29 (median 28.59), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.817 x lit spread | **PASS** | ours 18.59 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 1.011 x lit median | **PASS** | ours 52.62 cm vs lit 49.94-54.12 (median 52.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.825 x lit spread | **PASS** | ours 38.99 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 1.021 x lit median | **WARN** | ours 105.64 cm vs lit 103.49-103.49 (median 103.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.818 x lit spread | **PASS** | ours 99.26 cm vs model-based lit 121.40-121.40 (median 121.40, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.827 x lit median | **PASS** | ours 37.80 cm vs lit 35.59-50.06 (median 45.68), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-55.88] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 0.694 x lit spread | **PASS** | ours 32.14 cm vs model-based lit 32.73-55.62 (median 46.34, n=7); ALL comparators 32.73-125.52 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 0.689 x lit median | **PASS** | ours 49.25 cm vs lit 45.94-83.52 (median 71.52), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 45.94-92.42] |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 0.834 x lit spread | **PASS** | ours 62.48 cm vs model-based lit 58.97-253.21 (median 74.95, n=4); ALL comparators 58.97-253.21 |
...
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.857 x lit median | **WARN** | ours 47.34 cm vs lit 49.78-58.27 (median 55.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 49.78-67.77] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.115 x lit spread | **PASS** | ours 59.48 cm vs model-based lit 35.22-64.58 (median 53.36, n=7); ALL comparators 35.22-151.34 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 0.794 x lit median | **WARN** | ours 74.79 cm vs lit 80.52-106.90 (median 94.25), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 80.52-111.40] |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.178 x lit spread | **PASS** | ours 129.09 cm vs model-based lit 66.28-338.40 (median 109.59, n=4); ALL comparators 66.28-338.40 |
...
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.140 x lit median | **PASS** | ours 85.91 cm vs lit 62.39-97.85 (median 75.33), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 62.39-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.133 x lit spread | **PASS** | ours 78.04 cm vs model-based lit 40.46-106.79 (median 68.88, n=7); ALL comparators 40.46-181.04 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.952 x lit median | **PASS** | ours 189.18 cm vs lit 114.05-262.93 (median 198.69), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 114.05-262.93] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.525 x lit spread | **WARN** | ours 147.65 cm vs model-based lit 79.09-424.71 (median 281.29, n=4); ALL comparators 79.09-558.81; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 2xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.484 x lit median | **WARN** | ours 491.55 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.290 x lit spread | **WARN** | ours 400.54 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp585 | 2100 | 29.04 | (is champion) | 44.14 |
| AIS | ssp585 | 2150 | 84.35 | (is champion) | 97.88 |
| AIS | ssp585 | 2300 | 266.35 | (is champion) | 276.83 |
...
| glaciers | ssp585 | 2100 | 12.95 | (is champion) | 15.61 |
| glaciers | ssp585 | 2150 | 20.38 | (is champion) | 26.25 |
| glaciers | ssp585 | 2300 | 26.63 | (is champion) | 35.36 |
...
| Greenland | ssp585 | 2100 | 12.05 | (is champion) | 7.88 |
| Greenland | ssp585 | 2150 | 25.65 | (is champion) | 14.77 |
| Greenland | ssp585 | 2300 | 83.69 | (is champion) | 38.60 |
...
| thermal exp. | ssp585 | 2100 | 28.40 | (is champion) | 27.07 |
| thermal exp. | ssp585 | 2150 | 52.62 | (is champion) | 50.34 |
| thermal exp. | ssp585 | 2300 | 105.64 | (is champion) | 101.88 |
...
| TOTAL | ssp585 | 2100 | 85.91 | (is champion) | 98.00 |
| TOTAL | ssp585 | 2150 | 189.18 | (is champion) | 195.15 |
| TOTAL | ssp585 | 2300 | 491.55 | (is champion) | 467.87 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 6.52x | **PASS** | FACTS 0.73-2.10 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
...
| Greenland | 2300 | 8.33x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| thermal exp. | 2300 | 4.11x | **WARN** | MAGICC-SLR 6.18-6.18 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2100 | 2.27x | **PASS** | FACTS 1.44-1.82 (n=7); MAGICC-SLR 2.75-2.75 (n=1) |
| TOTAL | 2150 | 3.84x | **PASS** | FACTS 1.65-3.00 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
| TOTAL | 2300 | 6.94x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
