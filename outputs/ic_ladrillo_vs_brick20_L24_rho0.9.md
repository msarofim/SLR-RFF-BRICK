...
| ar1_prof | Ladrillo L24 | 58 | 240.7 | 215.1 | -365.5 | -350.0 | -120.8 |
...
- **ar1_prof**: Δln L (Ladrillo − BRICK 2.0) = **133.8** for Δk = 23. ΔAIC (BRICK − Ladrillo) = **221.6**, ΔBIC = **124.6**. The likelihood gain is worth 134 parameters under AIC and 43 under BIC (ln N = 6.22); Ladrillo has 23 more.
...
|---|---|---|---|---|---|---|---|
| ais | 120.6 | 0.013 | 0.764 | 110.0 | 0.028 | 0.900 | 10.6 |
| gsic | 8.5 | 0.000 | 0.121 | -64.4 | 0.241 | 0.900 | 72.9 |
| gis | 110.1 | 0.016 | 0.900 | 60.6 | 0.088 | 0.900 | 49.5 |
| steric | 1.5 | 0.111 | 0.900 | 0.7 | 0.112 | 0.900 | 0.8 |
...
| ar1_prof | -163.5 | -167.0 | -165.3 | -189.5 |
