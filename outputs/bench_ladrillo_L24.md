...
*benchmark v1.0, 2026-09-02, repo `8d32b96`. Champion arm: **L23**.*
...
|---|---|---|---|---|---|
| **AIS** | PASS | UNRESOLVED | FAIL | WARN | SAME |
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L24 | 0.0316 | 0.19 | bias -0.0034 cm = -0.02 sd; cov90 82%; n=106 |
...
| glaciers | 0.4593 | full | L24 | 0.3324 | 0.72 | bias +0.1692 cm = +0.37 sd; cov90 53%; n=104 |
...
| Greenland | 0.1832 | full | L24 | 0.0591 | 0.32 | bias +0.0024 cm = +0.01 sd; cov90 53%; n=106 |
...
| thermal exp. | 0.3091 | full | L24 | 0.4006 | 1.30 | bias +0.1604 cm = +0.52 sd; cov90 36%; n=106 |
...
| TOTAL | 1.5380 | full | L24 | 0.6794 | 0.44 | bias +0.5397 cm = +0.35 sd; cov90 34%; n=105 |
...
| thermal exp. | rate | L23* | 0.15641 | cm/yr | +5.84 | 1.27x obs UNCORRECTED, 1.15x at the FULL depth-scope bound; z spans +3.61..+5.84. Model is FULL-DEPTH, target is 0-2000 m; factor <= 1.1022 from IGCC ocean_2000-6000m (PRESCRIBED 1.15 ZJ/yr, not data), and it OVERSTATES the correction because deep water expands less per joule. NOT applied to accel: a prescribed constant rate carries no curvature. |
| thermal exp. | rate | BRICK 2.0 | 0.14454 | cm/yr | +3.74 | 1.17x obs UNCORRECTED, 1.06x at the FULL depth-scope bound; z spans +1.51..+3.74. Model is FULL-DEPTH, target is 0-2000 m; factor <= 1.1022 from IGCC ocean_2000-6000m (PRESCRIBED 1.15 ZJ/yr, not data), and it OVERSTATES the correction because deep water expands less per joule. NOT applied to accel: a prescribed constant rate carries no curvature. |
...
| AIS | ssp126 | 2300 | median_vs_lit | 1.663 x lit median | **WARN** | ours 14.48 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 3.533 x lit spread | **WARN** | ours 245.86 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | median_vs_lit | 1.849 x lit median | **WARN** | ours 154.29 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.223 x lit spread | **PASS** | ours 332.11 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| AIS | ssp585 | 2150 | median_vs_lit | 1.178 x lit median | **PASS** | ours 95.69 cm vs lit 6.93-153.62 (median 81.21), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 6.93-153.62] |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.588 x lit spread | **WARN** | ours 118.09 cm vs model-based lit 48.47-385.93 (median 200.75, n=4); ALL comparators 48.47-505.64; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.070 x lit median | **PASS** | ours 292.09 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.348 x lit spread | **WARN** | ours 329.14 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
...
| glaciers | ssp126 | 2300 | median_vs_lit | 0.897 x lit median | **WARN** | ours 12.38 cm vs lit 13.80-13.80 (median 13.80), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.962 x lit spread | **PASS** | ours 10.80 cm vs model-based lit 11.23-11.23 (median 11.23, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp245 | 2300 | median_vs_lit | 0.848 x lit median | **WARN** | ours 18.21 cm vs lit 21.47-21.47 (median 21.47), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 1.209 x lit spread | **PASS** | ours 13.24 cm vs model-based lit 10.95-10.95 (median 10.95, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp585 | 2300 | median_vs_lit | 0.912 x lit median | **WARN** | ours 26.53 cm vs lit 29.10-29.10 (median 29.10), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 1.224 x lit spread | **PASS** | ours 12.04 cm vs model-based lit 9.83-9.83 (median 9.83, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp126 | 2300 | median_vs_lit | 0.680 x lit median | **WARN** | ours 10.19 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.401 x lit spread | **WARN** | ours 11.79 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.763 x lit spread | **PASS** | ours 11.52 cm vs model-based lit 14.88-15.32 (median 15.10, n=2); ALL comparators 14.88-104.03; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.489 x lit median | **WARN** | ours 17.52 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.545 x lit spread | **PASS** | ours 22.28 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.818 x lit spread | **PASS** | ours 9.94 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.872 x lit median | **PASS** | ours 24.64 cm vs lit 24.11-32.40 (median 28.26), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 24.11-32.51] ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.471 x lit spread | **WARN** | ours 25.79 cm vs model-based lit 18.48-90.97 (median 54.73, n=2); ALL comparators 18.48-113.11; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.404 x lit median | **WARN** | ours 45.61 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.085 x lit spread | **WARN** | ours 57.87 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.535 x lit median | **WARN** | ours 25.68 cm vs lit 16.74-16.74 (median 16.74), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.144 x lit spread | **PASS** | ours 29.15 cm vs model-based lit 25.47-25.47 (median 25.47, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.262 x lit median | **WARN** | ours 45.81 cm vs lit 36.30-36.30 (median 36.30), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.881 x lit spread | **PASS** | ours 47.78 cm vs model-based lit 54.25-54.25 (median 54.25, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| thermal exp. | ssp585 | 2300 | median_vs_lit | 1.014 x lit median | **WARN** | ours 104.98 cm vs lit 103.49-103.49 (median 103.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.813 x lit spread | **PASS** | ours 98.73 cm vs model-based lit 121.40-121.40 (median 121.40, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.092 x lit median | **WARN** | ours 72.58 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.420 x lit spread | **WARN** | ours 282.19 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.334 x lit median | **WARN** | ours 249.20 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.109 x lit spread | **PASS** | ours 376.65 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.270 x lit spread | **PASS** | ours 87.45 cm vs model-based lit 40.46-106.79 (median 68.88, n=7); ALL comparators 40.46-181.04 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 1.002 x lit median | **PASS** | ours 199.04 cm vs lit 114.05-262.93 (median 198.69), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 114.05-262.93] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.541 x lit spread | **WARN** | ours 152.21 cm vs model-based lit 79.09-424.71 (median 281.29, n=4); ALL comparators 79.09-558.81; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 2xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.474 x lit median | **WARN** | ours 481.57 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.296 x lit spread | **WARN** | ours 408.53 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 4.76 | 4.82 | 4.32 |
| AIS | ssp126 | 2150 | 7.33 | 7.46 | 6.52 |
| AIS | ssp126 | 2300 | 14.48 | 14.74 | 13.01 |
| AIS | ssp245 | 2100 | 7.72 | 9.76 | 27.41 |
| AIS | ssp245 | 2150 | 39.85 | 47.00 | 72.60 |
| AIS | ssp245 | 2300 | 154.29 | 166.14 | 205.94 |
| AIS | ssp585 | 2100 | 37.45 | 38.74 | 44.14 |
| AIS | ssp585 | 2150 | 95.69 | 97.58 | 97.88 |
| AIS | ssp585 | 2300 | 292.09 | 295.57 | 276.83 |
| glaciers | ssp126 | 2100 | 7.92 | 8.02 | 12.09 |
| glaciers | ssp126 | 2150 | 9.79 | 9.88 | 17.44 |
| glaciers | ssp126 | 2300 | 12.38 | 12.48 | 27.72 |
| glaciers | ssp245 | 2100 | 9.56 | 9.72 | 13.34 |
| glaciers | ssp245 | 2150 | 13.30 | 13.47 | 20.69 |
| glaciers | ssp245 | 2300 | 18.21 | 18.38 | 32.50 |
| glaciers | ssp585 | 2100 | 12.81 | 13.00 | 15.61 |
| glaciers | ssp585 | 2150 | 20.30 | 20.52 | 26.25 |
| glaciers | ssp585 | 2300 | 26.53 | 26.76 | 35.36 |
| Greenland | ssp126 | 2100 | 6.58 | 6.57 | 6.62 |
| Greenland | ssp126 | 2150 | 8.09 | 8.02 | 10.01 |
| Greenland | ssp126 | 2300 | 10.19 | 9.94 | 19.04 |
| Greenland | ssp245 | 2100 | 8.23 | 8.22 | 7.03 |
| Greenland | ssp245 | 2150 | 11.97 | 11.89 | 11.35 |
| Greenland | ssp245 | 2300 | 17.52 | 17.14 | 23.71 |
| Greenland | ssp585 | 2100 | 12.10 | 12.11 | 7.88 |
| Greenland | ssp585 | 2150 | 24.64 | 25.68 | 14.77 |
| Greenland | ssp585 | 2300 | 45.61 | 83.36 | 38.60 |
| thermal exp. | ssp126 | 2100 | 16.09 | 16.10 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.96 | 20.04 | 19.18 |
| thermal exp. | ssp126 | 2300 | 25.68 | 25.84 | 25.08 |
| thermal exp. | ssp245 | 2100 | 20.28 | 20.34 | 19.37 |
| thermal exp. | ssp245 | 2150 | 29.64 | 29.82 | 28.53 |
| thermal exp. | ssp245 | 2300 | 45.81 | 45.94 | 44.66 |
| thermal exp. | ssp585 | 2100 | 28.38 | 28.45 | 27.07 |
| thermal exp. | ssp585 | 2150 | 52.53 | 52.65 | 50.34 |
| thermal exp. | ssp585 | 2300 | 104.98 | 105.47 | 101.88 |
...
| TOTAL | ssp126 | 2100 | 38.40 | 38.36 | 41.16 |
| TOTAL | ssp126 | 2150 | 50.24 | 50.17 | 57.89 |
| TOTAL | ssp126 | 2300 | 72.58 | 72.85 | 94.76 |
| TOTAL | ssp245 | 2100 | 52.14 | 52.94 | 70.19 |
| TOTAL | ssp245 | 2150 | 100.53 | 108.19 | 137.98 |
| TOTAL | ssp245 | 2300 | 249.20 | 263.80 | 317.82 |
| TOTAL | ssp585 | 2100 | 94.21 | 96.24 | 98.00 |
| TOTAL | ssp585 | 2150 | 199.04 | 203.01 | 195.15 |
| TOTAL | ssp585 | 2300 | 481.57 | 519.20 | 467.87 |
...
| AIS | 2300 | 20.18x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| Greenland | 2150 | 3.05x | **PASS** | FACTS 1.33-1.68 (n=2); MAGICC-SLR 3.48-3.48 (n=1) |
| Greenland | 2300 | 4.48x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2150 | 3.96x | **PASS** | FACTS 1.65-3.00 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
