# Ladrillo benchmark — `L22`

*benchmark v1.0, 2026-08-29, repo `902b121`. Champion arm: **L21**.*
...
|---|---|---|---|---|---|
| **AIS** | PASS | UNRESOLVED | WARN | WARN | WORSE |
| **glaciers** | WARN | UNRESOLVED | WARN | WARN | SAME |
| **Greenland** | PASS | UNRESOLVED | FAIL | WARN | SAME |
| **thermal exp.** | WARN | FAIL | WARN | FAIL | WORSE |
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L22 | 0.0313 | 0.19 | bias -0.0028 cm = -0.02 sd; cov90 82%; n=106 |
...
| AIS | 0.1674 | 1920-1949 | L22 | 0.0089 | 0.05 | bias -0.0087 cm = -0.05 sd; cov90 100%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L22 | 0.0087 | 0.05 | bias +0.0027 cm = +0.02 sd; cov90 98%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L22 | 0.0545 | 0.33 | bias -0.0047 cm = -0.03 sd; cov90 45%; n=33 |
...
| glaciers | 0.4593 | full | L22 | 0.3388 | 0.74 | bias +0.1739 cm = +0.38 sd; cov90 53%; n=104 |
...
| glaciers | 0.4593 | 1920-1949 | L22 | 0.6030 | 1.31 | bias +0.5403 cm = +1.18 sd; cov90 20%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L22 | 0.1356 | 0.30 | bias +0.0817 cm = +0.18 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L22 | 0.0884 | 0.19 | bias -0.0529 cm = -0.12 sd; cov90 81%; n=31 |
...
| Greenland | 0.1832 | full | L22 | 0.0587 | 0.32 | bias +0.0012 cm = +0.01 sd; cov90 55%; n=106 |
...
| Greenland | 0.1832 | 1920-1949 | L22 | 0.0800 | 0.44 | bias +0.0232 cm = +0.13 sd; cov90 57%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L22 | 0.0493 | 0.27 | bias -0.0146 cm = -0.08 sd; cov90 60%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L22 | 0.0456 | 0.25 | bias +0.0018 cm = +0.01 sd; cov90 45%; n=33 |
...
| thermal exp. | 0.3091 | full | L22 | 0.4002 | 1.29 | bias +0.1474 cm = +0.48 sd; cov90 16%; n=106 |
...
| thermal exp. | 0.3091 | 1920-1949 | L22 | 0.5189 | 1.68 | bias +0.3742 cm = +1.21 sd; cov90 10%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L22 | 0.2264 | 0.73 | bias -0.1262 cm = -0.41 sd; cov90 26%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L22 | 0.4505 | 1.46 | bias +0.2976 cm = +0.96 sd; cov90 9%; n=33 |
...
| TOTAL | 1.5380 | full | L22 | 0.6593 | 0.43 | bias +0.5251 cm = +0.34 sd; cov90 30%; n=105 |
...
| TOTAL | 1.5380 | 1920-1949 | L22 | 1.0080 | 0.66 | bias +0.9487 cm = +0.62 sd; cov90 27%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L22 | 0.4976 | 0.32 | bias +0.4609 cm = +0.30 sd; cov90 35%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L22 | 0.3755 | 0.24 | bias +0.2143 cm = +0.14 sd; cov90 28%; n=32 |
...
| AIS | rate | L22 | 0.031636 | cm/yr | -0.29 | 0.97x obs; z=-0.29 vs the obs error bar |
...
| glaciers | rate | L22 | 0.062723 | cm/yr | -0.57 | 0.92x obs; z=-0.57 vs the obs error bar |
...
| Greenland | rate | L22 | 0.065755 | cm/yr | -0.02 | 1.00x obs; z=-0.02 vs the obs error bar |
...
| thermal exp. | rate | L22 | 0.1582 | cm/yr | +6.16 | 1.28x obs; z=+6.16 vs the obs error bar |
...
| TOTAL | rate | L22 | 0.34894 | cm/yr | +0.82 | 1.07x obs; z=+0.82 vs the obs error bar |
...
| AIS | accel | L22 | 0.00020654 | cm/yr2 | +0.01 | ratio NOT INTERPRETABLE (obs is 1.53 se from zero); z=+0.01 vs the obs error bar |
...
| glaciers | accel | L22 | -0.00010696 | cm/yr2 | +0.99 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.99 vs the obs error bar |
...
| Greenland | accel | L22 | -0.00025192 | cm/yr2 | +0.05 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.05 vs the obs error bar |
...
| thermal exp. | accel | L22 | 0.0012874 | cm/yr2 | +1.83 | 1.53x obs; z=+1.83 vs the obs error bar |
...
| TOTAL | accel | L22 | 0.0013107 | cm/yr2 | +0.36 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.36 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.506 x lit median | **PASS** | ours 4.53 cm vs lit 3.66-11.90 (median 8.94), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.90]; ⚠ BIMODAL cell -- our MEAN is 6.99 cm = 0.78x the literature median, and the median sits entirely inside the near mode |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 0.939 x lit spread | **N/A(bimodal)** | ours 19.81 cm vs model-based lit 9.86-39.27 (median 21.11, n=5); ALL comparators 9.86-91.07; ⚠ p05-p99/p05-p95 = 2.77 vs Gaussian 1.207 => BIMODAL, and p95 is blind to the far mode (p05-p99 = 54.85 cm). The p5-p95 ratio is a property of the QUANTILE here, not of the model |
| AIS | ssp126 | 2150 | median_vs_lit | 0.390 x lit median | **PASS** | ours 6.99 cm vs lit 5.34-26.34 (median 17.92), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 5.34-26.34] |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.100 x lit spread | **PASS** | ours 50.77 cm vs model-based lit 33.17-72.55 (median 46.14, n=4); ALL comparators 33.17-156.27 |
| AIS | ssp126 | 2300 | median_vs_lit | 1.589 x lit median | **WARN** | ours 13.83 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 2.035 x lit spread | **WARN** | ours 141.66 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 0.529 x lit median | **WARN** | ours 5.49 cm vs lit 5.54-12.73 (median 10.38), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.54-13.71] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.183 x lit spread | **PASS** | ours 42.38 cm vs model-based lit 20.88-44.94 (median 35.81, n=5); ALL comparators 20.88-109.87 |
| AIS | ssp245 | 2150 | median_vs_lit | 0.420 x lit median | **PASS** | ours 11.54 cm vs lit 10.91-30.28 (median 27.45), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 10.91-30.28] |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.220 x lit spread | **WARN** | ours 102.58 cm vs model-based lit 44.92-369.45 (median 84.10, n=4); ALL comparators 44.92-369.45; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| AIS | ssp245 | 2300 | median_vs_lit | 0.887 x lit median | **WARN** | ours 74.01 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.077 x lit spread | **PASS** | ours 292.50 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.019 x lit spread | **PASS** | ours 57.57 cm vs model-based lit 20.51-79.00 (median 56.48, n=5); ALL comparators 20.51-151.54; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 0.888 x lit median | **PASS** | ours 84.78 cm vs lit 6.26-198.76 (median 95.53), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 6.26-198.76] |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.498 x lit spread | **WARN** | ours 102.25 cm vs model-based lit 48.68-408.37 (median 205.25, n=4); ALL comparators 48.68-570.98; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'low' is not a majority, so the median is not a summary here; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 0.991 x lit median | **PASS** | ours 270.45 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.294 x lit spread | **WARN** | ours 277.39 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.830 x lit spread | **PASS** | ours 6.11 cm vs model-based lit 7.12-7.85 (median 7.36, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.811 x lit median | **WARN** | ours 9.84 cm vs lit 12.00-12.28 (median 12.14), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.780 x lit spread | **PASS** | ours 7.96 cm vs model-based lit 8.52-11.89 (median 10.21, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.904 x lit median | **WARN** | ours 12.47 cm vs lit 13.80-13.80 (median 13.80), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.982 x lit spread | **PASS** | ours 11.02 cm vs model-based lit 11.23-11.23 (median 11.23, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2100 | median_vs_lit | 0.795 x lit median | **WARN** | ours 9.71 cm vs lit 11.38-12.54 (median 12.21), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.912 x lit spread | **PASS** | ours 7.01 cm vs model-based lit 7.42-9.60 (median 7.68, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.784 x lit median | **WARN** | ours 13.42 cm vs lit 16.71-17.53 (median 17.12), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.783 x lit spread | **PASS** | ours 10.10 cm vs model-based lit 9.16-16.65 (median 12.91, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.854 x lit median | **WARN** | ours 18.34 cm vs lit 21.47-21.47 (median 21.47), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 1.223 x lit spread | **PASS** | ours 13.40 cm vs model-based lit 10.95-10.95 (median 10.95, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2100 | median_vs_lit | 0.836 x lit median | **WARN** | ours 12.92 cm vs lit 15.30-17.73 (median 15.46), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.938 x lit spread | **PASS** | ours 8.82 cm vs model-based lit 8.51-13.85 (median 9.41, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.809 x lit median | **WARN** | ours 20.41 cm vs lit 22.03-28.40 (median 25.22), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.910 x lit spread | **PASS** | ours 11.66 cm vs model-based lit 10.09-15.53 (median 12.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.918 x lit median | **WARN** | ours 26.70 cm vs lit 29.10-29.10 (median 29.10), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 1.236 x lit spread | **PASS** | ours 12.16 cm vs model-based lit 9.83-9.83 (median 9.83, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp126 | 2100 | median_vs_lit | 1.020 x lit median | **PASS** | ours 6.53 cm vs lit 5.46-7.67 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 5.46-13.05] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.446 x lit spread | **FAIL** | ours 4.27 cm vs model-based lit 7.06-17.14 (median 9.57, n=3); ALL comparators 7.06-55.71 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.708 x lit median | **WARN** | ours 7.96 cm vs lit 9.31-13.18 (median 11.25), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 9.31-22.20] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.484 x lit spread | **WARN** | ours 6.49 cm vs model-based lit 11.12-15.69 (median 13.40, n=2); ALL comparators 11.12-86.94; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.663 x lit median | **WARN** | ours 9.93 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.386 x lit spread | **WARN** | ours 11.35 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.667 x lit spread | **PASS** | ours 5.57 cm vs model-based lit 7.85-16.85 (median 8.35, n=3); ALL comparators 7.85-72.68 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.684 x lit median | **WARN** | ours 11.88 cm vs lit 16.53-18.19 (median 17.36), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 16.53-25.62] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.736 x lit spread | **PASS** | ours 10.97 cm vs model-based lit 14.88-14.93 (median 14.91, n=2); ALL comparators 14.88-88.90; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.474 x lit median | **WARN** | ours 16.97 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.519 x lit spread | **PASS** | ours 21.22 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.892 x lit median | **WARN** | ours 12.03 cm vs lit 12.72-14.02 (median 13.49), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 12.72-20.28] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.811 x lit spread | **PASS** | ours 9.85 cm vs model-based lit 11.46-17.10 (median 12.15, n=3); ALL comparators 11.46-93.18 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.820 x lit median | **WARN** | ours 24.50 cm vs lit 27.33-32.40 (median 29.87), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 27.33-38.13] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.430 x lit spread | **WARN** | ours 24.94 cm vs model-based lit 24.97-90.97 (median 57.97, n=2); ALL comparators 24.97-121.86; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.388 x lit median | **WARN** | ours 43.86 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.080 x lit spread | **WARN** | ours 54.29 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.296 x lit median | **WARN** | ours 16.30 cm vs lit 11.09-14.05 (median 12.57), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 1.039 x lit spread | **PASS** | ours 12.07 cm vs model-based lit 11.26-11.97 (median 11.61, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.327 x lit median | **WARN** | ours 20.25 cm vs lit 12.68-17.85 (median 15.26), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 1.044 x lit spread | **PASS** | ours 17.24 cm vs model-based lit 16.06-16.96 (median 16.51, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.559 x lit median | **WARN** | ours 26.09 cm vs lit 16.74-16.74 (median 16.74), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.157 x lit spread | **PASS** | ours 29.47 cm vs model-based lit 25.47-25.47 (median 25.47, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.162 x lit median | **WARN** | ours 20.60 cm vs lit 16.62-18.84 (median 17.73), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.979 x lit spread | **PASS** | ours 14.19 cm vs model-based lit 13.73-15.26 (median 14.49, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.162 x lit median | **WARN** | ours 30.13 cm vs lit 23.23-28.64 (median 25.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.956 x lit spread | **PASS** | ours 23.80 cm vs model-based lit 23.92-25.87 (median 24.90, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.280 x lit median | **WARN** | ours 46.47 cm vs lit 36.30-36.30 (median 36.30), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.891 x lit spread | **PASS** | ours 48.32 cm vs model-based lit 54.25-54.25 (median 54.25, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 1.018 x lit median | **WARN** | ours 28.86 cm vs lit 27.88-28.82 (median 28.35), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.835 x lit spread | **PASS** | ours 18.37 cm vs model-based lit 21.13-22.88 (median 22.00, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 1.034 x lit median | **WARN** | ours 53.41 cm vs lit 49.94-53.35 (median 51.64), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.865 x lit spread | **PASS** | ours 38.89 cm vs model-based lit 41.87-48.08 (median 44.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 1.029 x lit median | **WARN** | ours 106.45 cm vs lit 103.49-103.49 (median 103.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.823 x lit spread | **PASS** | ours 99.94 cm vs model-based lit 121.40-121.40 (median 121.40, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.920 x lit median | **PASS** | ours 37.96 cm vs lit 35.59-46.11 (median 41.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-53.47] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.041 x lit spread | **PASS** | ours 34.93 cm vs model-based lit 25.25-49.52 (median 33.55, n=7); ALL comparators 25.25-107.65 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 0.749 x lit median | **PASS** | ours 49.52 cm vs lit 45.94-74.90 (median 66.11), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 45.94-83.12] |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.248 x lit spread | **PASS** | ours 72.75 cm vs model-based lit 53.31-79.31 (median 58.29, n=4); ALL comparators 53.31-200.59 |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.074 x lit median | **WARN** | ours 71.44 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 1.559 x lit spread | **PASS** | ours 181.72 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.894 x lit median | **WARN** | ours 47.83 cm vs lit 48.68-57.10 (median 53.51), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 48.68-67.90] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.169 x lit spread | **PASS** | ours 61.52 cm vs model-based lit 32.00-60.35 (median 52.65, n=7); ALL comparators 32.00-146.33 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 0.810 x lit median | **WARN** | ours 75.43 cm vs lit 80.04-105.22 (median 93.13), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 80.04-111.19] |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.264 x lit spread | **WARN** | ours 132.35 cm vs model-based lit 59.41-382.80 (median 104.68, n=4); ALL comparators 59.41-382.80; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2300 | median_vs_lit | 0.896 x lit median | **WARN** | ours 167.39 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 0.996 x lit spread | **PASS** | ours 338.37 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.097 x lit median | **PASS** | ours 87.08 cm vs lit 64.93-97.85 (median 79.41), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 64.93-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.116 x lit spread | **PASS** | ours 78.49 cm vs model-based lit 41.09-106.79 (median 70.33, n=7); ALL comparators 41.09-197.47 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.911 x lit median | **PASS** | ours 188.90 cm vs lit 117.08-310.66 (median 207.31), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 117.08-310.66] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.513 x lit spread | **WARN** | ours 142.21 cm vs model-based lit 77.93-414.71 (median 277.00, n=4); ALL comparators 77.93-631.59; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 2xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.453 x lit median | **WARN** | ours 460.62 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.261 x lit spread | **WARN** | ours 359.91 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 4.53 | 4.46 | 4.21 |
| AIS | ssp126 | 2150 | 6.99 | 6.83 | 6.37 |
| AIS | ssp126 | 2300 | 13.83 | 13.48 | 12.64 |
| AIS | ssp245 | 2100 | 5.49 | 5.45 | 29.21 |
| AIS | ssp245 | 2150 | 11.54 | 10.89 | 74.53 |
| AIS | ssp245 | 2300 | 74.01 | 65.92 | 207.88 |
| AIS | ssp585 | 2100 | 29.49 | 29.49 | 48.98 |
| AIS | ssp585 | 2150 | 84.78 | 84.25 | 104.07 |
| AIS | ssp585 | 2300 | 270.45 | 267.28 | 290.17 |
| glaciers | ssp126 | 2100 | 7.99 | 7.99 | 12.00 |
| glaciers | ssp126 | 2150 | 9.84 | 9.86 | 17.18 |
| glaciers | ssp126 | 2300 | 12.47 | 12.40 | 27.26 |
| glaciers | ssp245 | 2100 | 9.71 | 9.64 | 13.48 |
| glaciers | ssp245 | 2150 | 13.42 | 13.35 | 20.82 |
| glaciers | ssp245 | 2300 | 18.34 | 18.33 | 32.41 |
| glaciers | ssp585 | 2100 | 12.92 | 12.88 | 16.47 |
| glaciers | ssp585 | 2150 | 20.41 | 20.40 | 27.14 |
| glaciers | ssp585 | 2300 | 26.70 | 26.65 | 35.20 |
| Greenland | ssp126 | 2100 | 6.53 | 6.52 | 6.60 |
| Greenland | ssp126 | 2150 | 7.96 | 7.97 | 9.92 |
| Greenland | ssp126 | 2300 | 9.93 | 10.04 | 18.79 |
| Greenland | ssp245 | 2100 | 8.19 | 8.16 | 7.09 |
| Greenland | ssp245 | 2150 | 11.88 | 11.87 | 11.43 |
| Greenland | ssp245 | 2300 | 16.97 | 17.16 | 23.76 |
| Greenland | ssp585 | 2100 | 12.03 | 12.04 | 8.24 |
| Greenland | ssp585 | 2150 | 24.50 | 24.54 | 15.57 |
| Greenland | ssp585 | 2300 | 43.86 | 44.34 | 40.35 |
| thermal exp. | ssp126 | 2100 | 16.30 | 16.05 | 13.76 |
| thermal exp. | ssp126 | 2150 | 20.25 | 20.05 | 17.22 |
| thermal exp. | ssp126 | 2300 | 26.09 | 25.72 | 22.80 |
| thermal exp. | ssp245 | 2100 | 20.60 | 20.31 | 18.03 |
| thermal exp. | ssp245 | 2150 | 30.13 | 29.74 | 26.68 |
| thermal exp. | ssp245 | 2300 | 46.47 | 45.98 | 42.05 |
| thermal exp. | ssp585 | 2100 | 28.86 | 28.30 | 27.05 |
| thermal exp. | ssp585 | 2150 | 53.41 | 52.62 | 49.95 |
| thermal exp. | ssp585 | 2300 | 106.45 | 105.22 | 100.22 |
...
| TOTAL | ssp126 | 2100 | 37.96 | 37.80 | 39.24 |
| TOTAL | ssp126 | 2150 | 49.52 | 49.25 | 55.17 |
| TOTAL | ssp126 | 2300 | 71.44 | 70.85 | 91.18 |
| TOTAL | ssp245 | 2100 | 47.83 | 47.34 | 70.87 |
| TOTAL | ssp245 | 2150 | 75.43 | 74.79 | 137.98 |
| TOTAL | ssp245 | 2300 | 167.39 | 158.93 | 317.51 |
| TOTAL | ssp585 | 2100 | 87.08 | 86.29 | 104.68 |
| TOTAL | ssp585 | 2150 | 188.90 | 189.01 | 202.83 |
| TOTAL | ssp585 | 2300 | 460.62 | 457.20 | 482.40 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 6.51x | **PASS** | FACTS 0.63-3.20 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 12.14x | **PASS** | FACTS 0.48-7.55 (n=4); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 19.55x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.62x | **PASS** | FACTS 1.73-1.92 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.07x | **PASS** | FACTS 2.37-2.37 (n=1); MAGICC-SLR 1.79-1.79 (n=1) |
| glaciers | 2300 | 2.14x | **WARN** | MAGICC-SLR 2.11-2.11 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| Greenland | 2100 | 1.84x | **PASS** | FACTS 1.55-2.33 (n=3); MAGICC-SLR 2.11-2.11 (n=1) |
| Greenland | 2150 | 3.08x | **PASS** | FACTS 1.72-2.07 (n=2); MAGICC-SLR 3.48-3.48 (n=1) |
| Greenland | 2300 | 4.42x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| thermal exp. | 2100 | 1.77x | **FAIL** | FACTS 2.05-2.05 (n=1); MAGICC-SLR 2.51-2.51 (n=1); 0.28 outside the bracket = 60% of its own range |
| thermal exp. | 2150 | 2.64x | **FAIL** | FACTS 2.99-2.99 (n=1); MAGICC-SLR 3.94-3.94 (n=1); 0.35 outside the bracket = 37% of its own range |
| thermal exp. | 2300 | 4.08x | **WARN** | MAGICC-SLR 6.18-6.18 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2100 | 2.29x | **PASS** | FACTS 1.63-2.23 (n=7); MAGICC-SLR 2.75-2.75 (n=1) |
| TOTAL | 2150 | 3.81x | **PASS** | FACTS 1.94-4.15 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
| TOTAL | 2300 | 6.45x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L22.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L22`.*
