...
| ar1_prof | Ladrillo L32 | 50 | 241.4 | 228.9 | -382.9 | -371.6 | -172.0 |
...
- **ar1_prof**: Δln L (Ladrillo − BRICK 2.0) = **81.5** for Δk = 15. ΔAIC (BRICK − Ladrillo) = **133.0**, ΔBIC = **69.8**. The likelihood gain is worth 82 parameters under AIC and 26 under BIC (ln N = 6.22); Ladrillo has 15 more.
...
|---|---|---|---|---|---|---|---|
| ais | 129.9 | 0.012 | 0.896 | 122.2 | 0.024 | 0.950 | 7.7 |
| gsic | 4.0 | 0.000 | 0.241 | -44.4 | 0.169 | 0.950 | 48.4 |
| gis | 101.3 | 0.029 | 0.950 | 75.1 | 0.065 | 0.950 | 26.3 |
| steric | 6.1 | 0.093 | 0.950 | 7.0 | 0.090 | 0.950 | -0.9 |
...
| ar1_prof | -162.4 | -166.5 | -165.3 | -183.1 |
