# Ladrillo benchmark — `L34`

*benchmark v1.0, 2026-09-24, repo `29bcf43`. Champion arm: **L27**.*
...
|---|---|---|---|---|---|
| **AIS** | PASS | WARN | FAIL | WARN | SAME |
| **glaciers** | PASS | UNRESOLVED | WARN | PASS | SAME |
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L34 | 0.1225 | 0.73 | bias -0.0093 cm = -0.06 sd; cov90 65%; n=126 |
...
| AIS | 0.1674 | 1920-1949 | L34 | 0.0125 | 0.07 | bias +0.0091 cm = +0.05 sd; cov90 100%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L34 | 0.0567 | 0.34 | bias +0.0484 cm = +0.29 sd; cov90 74%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L34 | 0.2216 | 1.32 | bias -0.1527 cm = -0.91 sd; cov90 0%; n=33 |
...
| glaciers | 0.4593 | full | L34 | 0.3145 | 0.68 | bias +0.0574 cm = +0.12 sd; cov90 70%; n=124 |
...
| glaciers | 0.4593 | 1920-1949 | L34 | 0.1798 | 0.39 | bias -0.0059 cm = -0.01 sd; cov90 100%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L34 | 0.2302 | 0.50 | bias -0.1157 cm = -0.25 sd; cov90 58%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L34 | 0.0485 | 0.11 | bias -0.0231 cm = -0.05 sd; cov90 39%; n=31 |
...
| Greenland | 0.1832 | full | L34 | 0.1983 | 1.08 | bias -0.1434 cm = -0.78 sd; cov90 35%; n=126 |
...
| Greenland | 0.1832 | 1920-1949 | L34 | 0.2035 | 1.11 | bias -0.1556 cm = -0.85 sd; cov90 60%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L34 | 0.2699 | 1.47 | bias -0.2516 cm = -1.37 sd; cov90 0%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L34 | 0.1239 | 0.68 | bias -0.0843 cm = -0.46 sd; cov90 18%; n=33 |
...
| thermal exp. | 0.3091 | full | L34 | 0.4642 | 1.50 | bias +0.2613 cm = +0.85 sd; cov90 40%; n=126 |
...
| thermal exp. | 0.3091 | 1920-1949 | L34 | 0.6120 | 1.98 | bias +0.4894 cm = +1.58 sd; cov90 37%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L34 | 0.1964 | 0.64 | bias -0.0580 cm = -0.19 sd; cov90 70%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L34 | 0.3801 | 1.23 | bias +0.2479 cm = +0.80 sd; cov90 18%; n=33 |
...
| TOTAL | 1.5380 | full | L34 | 0.4073 | 0.26 | bias +0.1781 cm = +0.12 sd; cov90 83%; n=125 |
...
| TOTAL | 1.5380 | 1920-1949 | L34 | 0.4319 | 0.28 | bias +0.2001 cm = +0.13 sd; cov90 100%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L34 | 0.2165 | 0.14 | bias +0.0023 cm = +0.00 sd; cov90 91%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L34 | 0.2701 | 0.18 | bias +0.0723 cm = +0.05 sd; cov90 47%; n=32 |
...
| AIS | rate | L34 | 0.027179 | cm/yr | -1.59 | 0.83x obs; z=-1.59 vs the obs error bar |
| AIS | rate | L27* | 0.027801 | cm/yr | -1.41 | 0.85x obs; z=-1.41 vs the obs error bar |
...
| glaciers | rate | L34 | 0.06674 | cm/yr | -0.14 | 0.98x obs; z=-0.14 vs the obs error bar |
...
| Greenland | rate | L34 | 0.058762 | cm/yr | -0.69 | 0.89x obs; z=-0.69 vs the obs error bar |
...
| TOTAL | rate | L34 | 0.3359 | cm/yr | +0.38 | 1.03x obs; z=+0.38 vs the obs error bar |
...
| AIS | accel | L34 | 0.00022344 | cm/yr2 | +0.14 | ratio NOT INTERPRETABLE (obs is 1.53 se from zero); z=+0.14 vs the obs error bar |
| AIS | accel | L27* | 0.00021744 | cm/yr2 | +0.09 | ratio NOT INTERPRETABLE (obs is 1.53 se from zero); z=+0.09 vs the obs error bar |
...
| glaciers | accel | L34 | -0.000169 | cm/yr2 | +0.85 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.85 vs the obs error bar |
...
| Greenland | accel | L34 | -0.0001242 | cm/yr2 | +0.29 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.29 vs the obs error bar |
...
| thermal exp. | accel | L34 | 0.0012414 | cm/yr2 | +1.64 | 1.47x obs; z=+1.64 vs the obs error bar |
...
| TOTAL | accel | L34 | 0.0013446 | cm/yr2 | +0.39 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.39 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.557 x lit median | **PASS** | ours 5.04 cm vs lit 3.66-11.93 (median 9.04), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.93] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 2.203 x lit spread | **FAIL** | ours 47.14 cm vs model-based lit 20.72-40.49 (median 21.40, n=5); ALL comparators 20.72-105.01 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.533 x lit median | **PASS** | ours 7.82 cm vs lit 5.34-24.01 (median 14.67), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.671 x lit spread | **PASS** | ours 87.05 cm vs model-based lit 33.17-71.04 (median 52.10, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp126 | 2300 | median_vs_lit | 1.779 x lit median | **WARN** | ours 15.49 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 3.000 x lit spread | **WARN** | ours 208.78 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 0.953 x lit median | **PASS** | ours 10.00 cm vs lit 5.22-12.17 (median 10.49), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.22-12.17] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.599 x lit spread | **PASS** | ours 57.25 cm vs model-based lit 20.77-42.39 (median 35.81, n=5); ALL comparators 20.77-113.21 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.678 x lit median | **WARN** | ours 45.84 cm vs lit 27.21-27.41 (median 27.31), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.379 x lit spread | **PASS** | ours 117.75 cm vs model-based lit 80.10-90.72 (median 85.41, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp245 | 2300 | median_vs_lit | 1.888 x lit median | **WARN** | ours 157.53 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.163 x lit spread | **PASS** | ours 315.87 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 2.766 x lit median | **PASS** | ours 36.50 cm vs lit 4.30-39.10 (median 13.20), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 4.30-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.272 x lit spread | **PASS** | ours 65.39 cm vs model-based lit 20.71-79.00 (median 51.40, n=5); ALL comparators 20.71-126.10; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 0.984 x lit median | **PASS** | ours 92.43 cm vs lit 34.31-153.62 (median 93.97), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.543 x lit spread | **PASS** | ours 108.96 cm vs model-based lit 125.28-276.23 (median 200.75, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.036 x lit median | **PASS** | ours 282.94 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.333 x lit spread | **WARN** | ours 314.95 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.784 x lit median | **WARN** | ours 8.13 cm vs lit 9.72-10.45 (median 10.36), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.640 x lit spread | **PASS** | ours 4.95 cm vs model-based lit 7.12-10.06 (median 7.74, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.772 x lit median | **WARN** | ours 9.98 cm vs lit 12.28-13.60 (median 12.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.565 x lit spread | **PASS** | ours 6.78 cm vs model-based lit 8.52-15.46 (median 11.99, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.684 x lit median | **WARN** | ours 12.54 cm vs lit 13.80-22.85 (median 18.33), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.591 x lit spread | **PASS** | ours 9.62 cm vs model-based lit 11.23-21.30 (median 16.26, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.674 x lit spread | **PASS** | ours 5.65 cm vs model-based lit 7.42-11.15 (median 8.38, n=3) |
| glaciers | ssp245 | 2150 | median_vs_lit | 0.775 x lit median | **WARN** | ours 13.39 cm vs lit 16.71-17.82 (median 17.27), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.598 x lit spread | **PASS** | ours 8.65 cm vs model-based lit 9.16-19.79 (median 14.47, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.684 x lit median | **WARN** | ours 18.13 cm vs lit 21.47-31.57 (median 26.52), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 0.942 x lit spread | **PASS** | ours 11.90 cm vs model-based lit 10.95-14.32 (median 12.63, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2100 | median_vs_lit | 0.842 x lit median | **WARN** | ours 12.88 cm vs lit 13.93-17.13 (median 15.30), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.780 x lit spread | **PASS** | ours 7.10 cm vs model-based lit 8.51-14.02 (median 9.10, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.834 x lit median | **WARN** | ours 20.12 cm vs lit 22.03-26.22 (median 24.13), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.764 x lit spread | **PASS** | ours 10.37 cm vs model-based lit 10.09-17.06 (median 13.58, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.861 x lit median | **WARN** | ours 26.13 cm vs lit 29.10-31.57 (median 30.34), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 2.285 x lit spread | **WARN** | ours 11.38 cm vs model-based lit 0.13-9.83 (median 4.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2100 | median_vs_lit | 0.977 x lit median | **WARN** | ours 6.25 cm vs lit 6.36-8.31 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 6.36-13.80] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.395 x lit spread | **FAIL** | ours 3.78 cm vs model-based lit 8.22-17.86 (median 9.57, n=3); ALL comparators 8.22-68.88 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.898 x lit median | **WARN** | ours 8.37 cm vs lit 9.31-9.31 (median 9.31), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.401 x lit spread | **WARN** | ours 6.30 cm vs model-based lit 15.69-15.69 (median 15.69, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.784 x lit median | **WARN** | ours 11.75 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.414 x lit spread | **WARN** | ours 12.18 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp245 | 2100 | median_vs_lit | 0.791 x lit median | **WARN** | ours 7.34 cm vs lit 8.12-9.59 (median 9.28), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 8.12-14.49] |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.569 x lit spread | **PASS** | ours 4.76 cm vs model-based lit 7.77-17.73 (median 8.35, n=3); ALL comparators 7.77-77.52 |
| Greenland | ssp245 | 2150 | median_vs_lit | 0.680 x lit median | **WARN** | ours 11.24 cm vs lit 16.53-16.53 (median 16.53), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.673 x lit spread | **PASS** | ours 10.02 cm vs model-based lit 14.88-14.88 (median 14.88, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.507 x lit median | **WARN** | ours 18.13 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.750 x lit spread | **PASS** | ours 30.69 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.802 x lit median | **WARN** | ours 9.81 cm vs lit 11.67-13.49 (median 12.23), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 11.67-17.18] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.660 x lit spread | **PASS** | ours 8.02 cm vs model-based lit 8.46-18.27 (median 12.15, n=3); ALL comparators 8.46-81.93 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.666 x lit median | **WARN** | ours 21.56 cm vs lit 32.40-32.40 (median 32.40), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.302 x lit spread | **WARN** | ours 27.44 cm vs model-based lit 90.97-90.97 (median 90.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.715 x lit median | **WARN** | ours 80.82 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.161 x lit spread | **WARN** | ours 109.39 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.125 x lit median | **PASS** | ours 15.68 cm vs lit 11.09-16.79 (median 13.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.899 x lit spread | **PASS** | ours 11.74 cm vs model-based lit 11.97-14.17 (median 13.07, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.164 x lit median | **PASS** | ours 19.58 cm vs lit 12.68-20.97 (median 16.83), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.953 x lit spread | **PASS** | ours 17.10 cm vs model-based lit 16.06-19.84 (median 17.95, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.150 x lit median | **PASS** | ours 25.03 cm vs lit 16.74-26.81 (median 21.77), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.029 x lit spread | **PASS** | ours 29.32 cm vs model-based lit 25.47-31.53 (median 28.50, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.047 x lit median | **PASS** | ours 19.79 cm vs lit 16.62-21.18 (median 18.90), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.871 x lit spread | **PASS** | ours 13.84 cm vs model-based lit 15.26-16.52 (median 15.89, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.078 x lit median | **PASS** | ours 29.13 cm vs lit 23.23-30.82 (median 27.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.865 x lit spread | **PASS** | ours 23.46 cm vs model-based lit 25.87-28.40 (median 27.13, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.073 x lit median | **PASS** | ours 44.80 cm vs lit 36.30-47.22 (median 41.76), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.888 x lit spread | **PASS** | ours 47.80 cm vs model-based lit 53.37-54.25 (median 53.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.971 x lit median | **WARN** | ours 27.77 cm vs lit 27.88-29.29 (median 28.59), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.795 x lit spread | **PASS** | ours 18.09 cm vs model-based lit 22.64-22.88 (median 22.76, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.987 x lit median | **PASS** | ours 51.34 cm vs lit 49.94-54.12 (median 52.03), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.811 x lit spread | **PASS** | ours 38.33 cm vs model-based lit 46.46-48.08 (median 47.27, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.967 x lit median | **WARN** | ours 102.92 cm vs lit 103.49-109.39 (median 106.44), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.834 x lit spread | **PASS** | ours 100.12 cm vs model-based lit 118.64-121.40 (median 120.02, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.840 x lit median | **PASS** | ours 38.35 cm vs lit 35.59-50.06 (median 45.68), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-55.88] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.284 x lit spread | **PASS** | ours 59.52 cm vs model-based lit 32.73-55.62 (median 46.34, n=7); ALL comparators 32.73-125.52 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 1.105 x lit median | **WARN** | ours 50.78 cm vs lit 45.94-45.94 (median 45.94), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.797 x lit spread | **PASS** | ours 105.96 cm vs model-based lit 58.97-58.97 (median 58.97, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp126 | 2300 | median_vs_lit | 1.133 x lit median | **WARN** | ours 75.37 cm vs lit 66.49-66.49 (median 66.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.082 x lit spread | **WARN** | ours 242.75 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.939 x lit median | **PASS** | ours 51.89 cm vs lit 49.78-58.27 (median 55.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 49.78-67.77] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.282 x lit spread | **PASS** | ours 68.42 cm vs model-based lit 35.22-64.58 (median 53.36, n=7); ALL comparators 35.22-151.34 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.181 x lit median | **WARN** | ours 104.08 cm vs lit 88.11-88.11 (median 88.11), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.291 x lit spread | **PASS** | ours 139.87 cm vs model-based lit 108.33-108.33 (median 108.33, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.343 x lit median | **WARN** | ours 250.75 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.069 x lit spread | **PASS** | ours 363.24 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.207 x lit median | **PASS** | ours 90.94 cm vs lit 62.39-97.85 (median 75.33), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 62.39-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.152 x lit spread | **PASS** | ours 79.35 cm vs model-based lit 40.46-106.79 (median 68.88, n=7); ALL comparators 40.46-181.04 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.731 x lit median | **WARN** | ours 192.28 cm vs lit 262.93-262.93 (median 262.93), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.359 x lit spread | **WARN** | ours 144.79 cm vs model-based lit 403.38-403.38 (median 403.38, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.494 x lit median | **WARN** | ours 501.82 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.307 x lit spread | **WARN** | ours 422.96 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 5.04 | 4.92 | 4.32 |
| AIS | ssp126 | 2150 | 7.82 | 7.68 | 6.52 |
| AIS | ssp126 | 2300 | 15.49 | 15.23 | 13.01 |
| AIS | ssp245 | 2100 | 10.00 | 10.55 | 27.41 |
| AIS | ssp245 | 2150 | 45.84 | 46.18 | 72.60 |
| AIS | ssp245 | 2300 | 157.53 | 156.34 | 205.94 |
| AIS | ssp585 | 2100 | 36.50 | 36.66 | 44.14 |
| AIS | ssp585 | 2150 | 92.43 | 92.56 | 97.88 |
| AIS | ssp585 | 2300 | 282.94 | 277.71 | 276.83 |
| glaciers | ssp126 | 2100 | 8.13 | 8.11 | 12.09 |
| glaciers | ssp126 | 2150 | 9.98 | 9.93 | 17.44 |
| glaciers | ssp126 | 2300 | 12.54 | 12.48 | 27.72 |
| glaciers | ssp245 | 2100 | 9.73 | 9.72 | 13.34 |
| glaciers | ssp245 | 2150 | 13.39 | 13.41 | 20.69 |
| glaciers | ssp245 | 2300 | 18.13 | 18.06 | 32.50 |
| glaciers | ssp585 | 2100 | 12.88 | 12.91 | 15.61 |
| glaciers | ssp585 | 2150 | 20.12 | 20.17 | 26.25 |
| glaciers | ssp585 | 2300 | 26.13 | 26.14 | 35.36 |
| Greenland | ssp126 | 2100 | 6.25 | 6.23 | 6.62 |
| Greenland | ssp126 | 2150 | 8.37 | 8.30 | 10.01 |
| Greenland | ssp126 | 2300 | 11.75 | 11.72 | 19.04 |
| Greenland | ssp245 | 2100 | 7.34 | 7.31 | 7.03 |
| Greenland | ssp245 | 2150 | 11.24 | 11.18 | 11.35 |
| Greenland | ssp245 | 2300 | 18.13 | 17.89 | 23.71 |
| Greenland | ssp585 | 2100 | 9.81 | 9.84 | 7.88 |
| Greenland | ssp585 | 2150 | 21.56 | 21.49 | 14.77 |
| Greenland | ssp585 | 2300 | 80.82 | 79.49 | 38.60 |
| thermal exp. | ssp126 | 2100 | 15.68 | 15.73 | 15.34 |
| thermal exp. | ssp126 | 2150 | 19.58 | 19.40 | 19.18 |
| thermal exp. | ssp126 | 2300 | 25.03 | 25.07 | 25.08 |
| thermal exp. | ssp245 | 2100 | 19.79 | 19.88 | 19.37 |
| thermal exp. | ssp245 | 2150 | 29.13 | 28.99 | 28.53 |
| thermal exp. | ssp245 | 2300 | 44.80 | 44.66 | 44.66 |
| thermal exp. | ssp585 | 2100 | 27.77 | 27.81 | 27.07 |
| thermal exp. | ssp585 | 2150 | 51.34 | 51.39 | 50.34 |
| thermal exp. | ssp585 | 2300 | 102.92 | 102.60 | 101.88 |
...
| TOTAL | ssp126 | 2100 | 38.35 | 38.00 | 41.16 |
| TOTAL | ssp126 | 2150 | 50.78 | 50.28 | 57.89 |
| TOTAL | ssp126 | 2300 | 75.37 | 74.81 | 94.76 |
| TOTAL | ssp245 | 2100 | 51.89 | 52.65 | 70.19 |
| TOTAL | ssp245 | 2150 | 104.08 | 104.85 | 137.98 |
| TOTAL | ssp245 | 2300 | 250.75 | 247.73 | 317.82 |
| TOTAL | ssp585 | 2100 | 90.94 | 90.67 | 98.00 |
| TOTAL | ssp585 | 2150 | 192.28 | 191.21 | 195.15 |
| TOTAL | ssp585 | 2300 | 501.82 | 497.87 | 467.87 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 7.25x | **PASS** | FACTS 0.73-2.10 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 11.82x | **PASS** | FACTS 1.43-1.43 (n=1); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 18.27x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| glaciers | 2100 | 1.58x | **PASS** | FACTS 1.43-1.65 (n=2); MAGICC-SLR 1.46-1.46 (n=1) |
| glaciers | 2150 | 2.02x | **CHECK(wide)** | FACTS 1.93-1.93 (n=1); MAGICC-SLR 1.79-1.79 (n=1); 0.09 outside the bracket = 66% of its own range |
| glaciers | 2300 | 2.08x | **PASS** | FACTS 1.38-1.38 (n=1); MAGICC-SLR 2.11-2.11 (n=1) |
| Greenland | 2100 | 1.57x | **PASS** | FACTS 1.24-1.84 (n=3); MAGICC-SLR 2.11-2.11 (n=1) |
| Greenland | 2150 | 2.58x | **WARN** | MAGICC-SLR 3.48-3.48 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| Greenland | 2300 | 6.88x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2150 | 3.79x | **WARN** | MAGICC-SLR 5.72-5.72 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| TOTAL | 2300 | 6.66x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L34.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L34`.*
