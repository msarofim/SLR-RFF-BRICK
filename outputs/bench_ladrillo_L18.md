# Ladrillo benchmark — `L18`

*benchmark v1.0, 2026-08-27, repo `1d0509c`. Champion arm: **L14**.*
...
|---|---|---|---|---|---|---|
| AIS | 0.1674 | full | L18 | 0.0313 | 0.19 | bias -0.0029 cm = -0.02 sd; cov90 82%; n=106 |
...
| AIS | 0.1674 | 1920-1949 | L18 | 0.0067 | 0.04 | bias -0.0065 cm = -0.04 sd; cov90 100%; n=30 |
...
| AIS | 0.1674 | 1950-1992 | L18 | 0.0073 | 0.04 | bias +0.0022 cm = +0.01 sd; cov90 98%; n=43 |
...
| AIS | 0.1674 | 1993-2026 | L18 | 0.0550 | 0.33 | bias -0.0064 cm = -0.04 sd; cov90 45%; n=33 |
...
| glaciers | 0.4593 | full | L18 | 0.3289 | 0.72 | bias +0.1662 cm = +0.36 sd; cov90 52%; n=104 |
...
| glaciers | 0.4593 | 1920-1949 | L18 | 0.5851 | 1.27 | bias +0.5221 cm = +1.14 sd; cov90 20%; n=30 |
...
| glaciers | 0.4593 | 1950-1992 | L18 | 0.1333 | 0.29 | bias +0.0736 cm = +0.16 sd; cov90 56%; n=43 |
...
| glaciers | 0.4593 | 1993-2026 | L18 | 0.0844 | 0.18 | bias -0.0498 cm = -0.11 sd; cov90 77%; n=31 |
...
| Greenland | 0.1832 | full | L18 | 0.0589 | 0.32 | bias +0.0017 cm = +0.01 sd; cov90 55%; n=106 |
...
| Greenland | 0.1832 | 1920-1949 | L18 | 0.0803 | 0.44 | bias +0.0254 cm = +0.14 sd; cov90 57%; n=30 |
...
| Greenland | 0.1832 | 1950-1992 | L18 | 0.0496 | 0.27 | bias -0.0146 cm = -0.08 sd; cov90 60%; n=43 |
...
| Greenland | 0.1832 | 1993-2026 | L18 | 0.0457 | 0.25 | bias +0.0012 cm = +0.01 sd; cov90 45%; n=33 |
...
| thermal exp. | 0.3091 | full | L18 | 0.3183 | 1.03 | bias +0.1771 cm = +0.57 sd; cov90 28%; n=106 |
...
| thermal exp. | 0.3091 | 1920-1949 | L18 | 0.4391 | 1.42 | bias +0.3477 cm = +1.12 sd; cov90 30%; n=30 |
...
| thermal exp. | 0.3091 | 1950-1992 | L18 | 0.1834 | 0.59 | bias +0.0279 cm = +0.09 sd; cov90 37%; n=43 |
...
| thermal exp. | 0.3091 | 1993-2026 | L18 | 0.3263 | 1.06 | bias +0.2164 cm = +0.70 sd; cov90 15%; n=33 |
...
| TOTAL | 1.5380 | full | L18 | 0.6890 | 0.45 | bias +0.5586 cm = +0.36 sd; cov90 25%; n=105 |
...
| TOTAL | 1.5380 | 1920-1949 | L18 | 0.9744 | 0.63 | bias +0.9309 cm = +0.61 sd; cov90 37%; n=30 |
...
| TOTAL | 1.5380 | 1950-1992 | L18 | 0.6554 | 0.43 | bias +0.6120 cm = +0.40 sd; cov90 5%; n=43 |
...
| TOTAL | 1.5380 | 1993-2026 | L18 | 0.3004 | 0.20 | bias +0.1378 cm = +0.09 sd; cov90 41%; n=32 |
...
| AIS | rate | L18 | 0.031671 | cm/yr | -0.28 | 0.97x obs; z=-0.28 vs the obs error bar |
...
| glaciers | rate | L18 | 0.063138 | cm/yr | -0.53 | 0.93x obs; z=-0.53 vs the obs error bar |
...
| Greenland | rate | L18 | 0.065713 | cm/yr | -0.02 | 1.00x obs; z=-0.02 vs the obs error bar |
...
| thermal exp. | rate | L18 | 0.14753 | cm/yr | +4.27 | 1.20x obs; z=+4.27 vs the obs error bar |
...
| TOTAL | rate | L18 | 0.33827 | cm/yr | +0.46 | 1.04x obs; z=+0.46 vs the obs error bar |
...
| AIS | accel | L18 | 0.00020681 | cm/yr2 | +0.01 | ratio NOT INTERPRETABLE (obs is 1.53 se from zero); z=+0.01 vs the obs error bar |
...
| glaciers | accel | L18 | -0.00010596 | cm/yr2 | +0.99 | ratio NOT INTERPRETABLE (obs is 1.23 se from zero); z=+0.99 vs the obs error bar |
...
| Greenland | accel | L18 | -0.00025286 | cm/yr2 | +0.05 | ratio NOT INTERPRETABLE (obs is 0.53 se from zero); z=+0.05 vs the obs error bar |
...
| thermal exp. | accel | L18 | 0.0010029 | cm/yr2 | +0.66 | 1.19x obs; z=+0.66 vs the obs error bar |
...
| TOTAL | accel | L18 | 0.0010297 | cm/yr2 | +0.12 | ratio NOT INTERPRETABLE (obs is 0.77 se from zero); z=+0.12 vs the obs error bar |
...
|---|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | median_vs_lit | 0.513 x lit median | **PASS** | ours 4.59 cm vs lit 3.66-11.90 (median 8.94), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.66-11.90] |
...
| AIS | ssp126 | 2100 | spread_vs_lit | 2.265 x lit spread | **FAIL** | ours 47.81 cm vs model-based lit 9.86-39.27 (median 21.11, n=5); ALL comparators 9.86-91.07 |
| AIS | ssp126 | 2150 | median_vs_lit | 0.391 x lit median | **PASS** | ours 7.00 cm vs lit 5.34-26.34 (median 17.92), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 5.34-26.34] |
...
| AIS | ssp126 | 2150 | spread_vs_lit | 1.832 x lit spread | **PASS** | ours 84.54 cm vs model-based lit 33.17-72.55 (median 46.14, n=4); ALL comparators 33.17-156.27 |
| AIS | ssp126 | 2300 | median_vs_lit | 1.570 x lit median | **WARN** | ours 13.67 cm vs lit 8.71-8.71 (median 8.71), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp126 | 2300 | spread_vs_lit | 2.898 x lit spread | **WARN** | ours 201.67 cm vs model-based lit 69.60-69.60 (median 69.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| AIS | ssp245 | 2100 | median_vs_lit | 0.846 x lit median | **PASS** | ours 8.78 cm vs lit 5.54-12.73 (median 10.38), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 5.54-13.71] |
...
| AIS | ssp245 | 2100 | spread_vs_lit | 1.673 x lit spread | **PASS** | ours 59.92 cm vs model-based lit 20.88-44.94 (median 35.81, n=5); ALL comparators 20.88-109.87 |
| AIS | ssp245 | 2150 | median_vs_lit | 1.681 x lit median | **WARN** | ours 46.14 cm vs lit 10.91-30.28 (median 27.45), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 10.91-30.28] |
...
| AIS | ssp245 | 2150 | spread_vs_lit | 1.488 x lit spread | **WARN** | ours 125.15 cm vs model-based lit 44.92-369.45 (median 84.10, n=4); ALL comparators 44.92-369.45; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| AIS | ssp245 | 2300 | median_vs_lit | 1.898 x lit median | **WARN** | ours 158.43 cm vs lit 83.46-83.46 (median 83.46), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| AIS | ssp245 | 2300 | spread_vs_lit | 1.201 x lit spread | **PASS** | ours 326.22 cm vs model-based lit 271.56-271.56 (median 271.56, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| AIS | ssp585 | 2100 | median_vs_lit | 2.974 x lit median | **FAIL** | ours 42.90 cm vs lit 3.98-39.10 (median 14.43), n_lit=5 [1 SEJ comparator(s) excluded from the score; full range 3.98-39.10] |
...
| AIS | ssp585 | 2100 | spread_vs_lit | 1.247 x lit spread | **PASS** | ours 70.44 cm vs model-based lit 20.51-79.00 (median 56.48, n=5); ALL comparators 20.51-151.54; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2150 | median_vs_lit | 1.070 x lit median | **PASS** | ours 102.18 cm vs lit 6.26-198.76 (median 95.53), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 6.26-198.76] |
...
| AIS | ssp585 | 2150 | spread_vs_lit | 0.564 x lit spread | **WARN** | ours 115.72 cm vs model-based lit 48.68-408.37 (median 205.25, n=4); ALL comparators 48.68-570.98; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/1xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| AIS | ssp585 | 2300 | median_vs_lit | 1.110 x lit median | **PASS** | ours 303.11 cm vs lit 267.00-712.02 (median 273.00), n_lit=3 |
...
| AIS | ssp585 | 2300 | spread_vs_lit | 0.357 x lit spread | **WARN** | ours 337.51 cm vs model-based lit 944.94-944.94 (median 944.94, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN; width here is the antarctic_lambda PRIOR -- do NOT narrow |
| glaciers | ssp126 | 2100 | median_vs_lit | 0.833 x lit median | **WARN** | ours 7.70 cm vs lit 8.95-10.45 (median 9.25), n_lit=3 |
...
| glaciers | ssp126 | 2100 | spread_vs_lit | 0.826 x lit spread | **PASS** | ours 6.08 cm vs model-based lit 7.12-7.85 (median 7.36, n=3) |
| glaciers | ssp126 | 2150 | median_vs_lit | 0.777 x lit median | **WARN** | ours 9.43 cm vs lit 12.00-12.28 (median 12.14), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2150 | spread_vs_lit | 0.781 x lit spread | **PASS** | ours 7.97 cm vs model-based lit 8.52-11.89 (median 10.21, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp126 | 2300 | median_vs_lit | 0.863 x lit median | **WARN** | ours 11.91 cm vs lit 13.80-13.80 (median 13.80), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp126 | 2300 | spread_vs_lit | 0.971 x lit spread | **PASS** | ours 10.91 cm vs model-based lit 11.23-11.23 (median 11.23, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2100 | median_vs_lit | 0.797 x lit median | **WARN** | ours 9.73 cm vs lit 11.38-12.54 (median 12.21), n_lit=3 |
...
| glaciers | ssp245 | 2100 | spread_vs_lit | 0.893 x lit spread | **PASS** | ours 6.86 cm vs model-based lit 7.42-9.60 (median 7.68, n=3) |
...
| glaciers | ssp245 | 2150 | spread_vs_lit | 0.759 x lit spread | **PASS** | ours 9.80 cm vs model-based lit 9.16-16.65 (median 12.91, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp245 | 2300 | median_vs_lit | 0.849 x lit median | **WARN** | ours 18.22 cm vs lit 21.47-21.47 (median 21.47), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp245 | 2300 | spread_vs_lit | 1.184 x lit spread | **PASS** | ours 12.96 cm vs model-based lit 10.95-10.95 (median 10.95, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2100 | median_vs_lit | 0.896 x lit median | **WARN** | ours 13.86 cm vs lit 15.30-17.73 (median 15.46), n_lit=3 |
...
| glaciers | ssp585 | 2100 | spread_vs_lit | 0.944 x lit spread | **PASS** | ours 8.88 cm vs model-based lit 8.51-13.85 (median 9.41, n=3) |
| glaciers | ssp585 | 2150 | median_vs_lit | 0.848 x lit median | **WARN** | ours 21.39 cm vs lit 22.03-28.40 (median 25.22), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2150 | spread_vs_lit | 0.899 x lit spread | **PASS** | ours 11.52 cm vs model-based lit 10.09-15.53 (median 12.81, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| glaciers | ssp585 | 2300 | median_vs_lit | 0.932 x lit median | **WARN** | ours 27.13 cm vs lit 29.10-29.10 (median 29.10), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| glaciers | ssp585 | 2300 | spread_vs_lit | 1.235 x lit spread | **PASS** | ours 12.15 cm vs model-based lit 9.83-9.83 (median 9.83, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp126 | 2100 | median_vs_lit | 0.979 x lit median | **PASS** | ours 6.26 cm vs lit 5.46-7.67 (median 6.40), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 5.46-13.05] |
...
| Greenland | ssp126 | 2100 | spread_vs_lit | 0.486 x lit spread | **FAIL** | ours 4.65 cm vs model-based lit 7.06-17.14 (median 9.57, n=3); ALL comparators 7.06-55.71 |
| Greenland | ssp126 | 2150 | median_vs_lit | 0.671 x lit median | **WARN** | ours 7.55 cm vs lit 9.31-13.18 (median 11.25), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 9.31-22.20] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2150 | spread_vs_lit | 0.522 x lit spread | **PASS** | ours 7.00 cm vs model-based lit 11.12-15.69 (median 13.40, n=2); ALL comparators 11.12-86.94; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp126 | 2300 | median_vs_lit | 0.630 x lit median | **WARN** | ours 9.43 cm vs lit 14.98-14.98 (median 14.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp126 | 2300 | spread_vs_lit | 0.396 x lit spread | **WARN** | ours 11.63 cm vs model-based lit 29.41-29.41 (median 29.41, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2100 | spread_vs_lit | 0.692 x lit spread | **PASS** | ours 5.78 cm vs model-based lit 7.85-16.85 (median 8.35, n=3); ALL comparators 7.85-72.68 |
...
| Greenland | ssp245 | 2150 | spread_vs_lit | 0.730 x lit spread | **PASS** | ours 10.89 cm vs model-based lit 14.88-14.93 (median 14.91, n=2); ALL comparators 14.88-88.90; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp245 | 2300 | median_vs_lit | 0.476 x lit median | **WARN** | ours 17.04 cm vs lit 35.79-35.79 (median 35.79), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp245 | 2300 | spread_vs_lit | 0.519 x lit spread | **PASS** | ours 21.24 cm vs model-based lit 40.91-40.91 (median 40.91, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| Greenland | ssp585 | 2100 | median_vs_lit | 0.995 x lit median | **PASS** | ours 13.43 cm vs lit 12.72-14.02 (median 13.49), n_lit=3 [1 SEJ comparator(s) excluded from the score; full range 12.72-20.28] |
...
| Greenland | ssp585 | 2100 | spread_vs_lit | 0.930 x lit spread | **PASS** | ours 11.31 cm vs model-based lit 11.46-17.10 (median 12.15, n=3); ALL comparators 11.46-93.18 |
| Greenland | ssp585 | 2150 | median_vs_lit | 0.910 x lit median | **WARN** | ours 27.18 cm vs lit 27.33-32.40 (median 29.87), n_lit=2 [1 SEJ comparator(s) excluded from the score; full range 27.33-38.13] ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2150 | spread_vs_lit | 0.461 x lit spread | **WARN** | ours 26.74 cm vs model-based lit 24.97-90.97 (median 57.97, n=2); ALL comparators 24.97-121.86; ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| Greenland | ssp585 | 2300 | median_vs_lit | 0.418 x lit median | **WARN** | ours 47.25 cm vs lit 113.01-113.01 (median 113.01), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| Greenland | ssp585 | 2300 | spread_vs_lit | 0.087 x lit spread | **WARN** | ours 59.36 cm vs model-based lit 680.24-680.24 (median 680.24, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| thermal exp. | ssp126 | 2100 | median_vs_lit | 1.087 x lit median | **PASS** | ours 13.66 cm vs lit 11.09-14.05 (median 12.57), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2100 | spread_vs_lit | 0.880 x lit spread | **PASS** | ours 10.21 cm vs model-based lit 11.26-11.97 (median 11.61, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2150 | median_vs_lit | 1.116 x lit median | **PASS** | ours 17.03 cm vs lit 12.68-17.85 (median 15.26), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp126 | 2150 | spread_vs_lit | 0.911 x lit spread | **PASS** | ours 15.04 cm vs model-based lit 16.06-16.96 (median 16.51, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp126 | 2300 | median_vs_lit | 1.331 x lit median | **WARN** | ours 22.27 cm vs lit 16.74-16.74 (median 16.74), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp126 | 2300 | spread_vs_lit | 1.069 x lit spread | **PASS** | ours 27.24 cm vs model-based lit 25.47-25.47 (median 25.47, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2100 | median_vs_lit | 1.009 x lit median | **PASS** | ours 17.89 cm vs lit 16.62-18.84 (median 17.73), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2100 | spread_vs_lit | 0.807 x lit spread | **PASS** | ours 11.70 cm vs model-based lit 13.73-15.26 (median 14.49, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2150 | median_vs_lit | 1.022 x lit median | **PASS** | ours 26.51 cm vs lit 23.23-28.64 (median 25.94), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary |
...
| thermal exp. | ssp245 | 2150 | spread_vs_lit | 0.819 x lit spread | **PASS** | ours 20.38 cm vs model-based lit 23.92-25.87 (median 24.90, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp245 | 2300 | median_vs_lit | 1.130 x lit median | **WARN** | ours 41.01 cm vs lit 36.30-36.30 (median 36.30), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp245 | 2300 | spread_vs_lit | 0.785 x lit spread | **PASS** | ours 42.56 cm vs model-based lit 54.25-54.25 (median 54.25, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2100 | median_vs_lit | 0.947 x lit median | **WARN** | ours 26.83 cm vs lit 27.88-28.82 (median 28.35), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2100 | spread_vs_lit | 0.773 x lit spread | **PASS** | ours 17.01 cm vs model-based lit 21.13-22.88 (median 22.00, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2150 | median_vs_lit | 0.957 x lit median | **WARN** | ours 49.43 cm vs lit 49.94-53.35 (median 51.64), n_lit=2 ⚠ n_lit=2 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2150 | spread_vs_lit | 0.816 x lit spread | **PASS** | ours 36.71 cm vs model-based lit 41.87-48.08 (median 44.98, n=2); ⚠ n=2 < 3 comparators WITH A BAND, so this median is not a summary |
| thermal exp. | ssp585 | 2300 | median_vs_lit | 0.957 x lit median | **WARN** | ours 99.03 cm vs lit 103.49-103.49 (median 103.49), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| thermal exp. | ssp585 | 2300 | spread_vs_lit | 0.790 x lit spread | **PASS** | ours 95.90 cm vs model-based lit 121.40-121.40 (median 121.40, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
...
| TOTAL | ssp126 | 2100 | median_vs_lit | 0.848 x lit median | **WARN** | ours 34.98 cm vs lit 35.59-46.11 (median 41.25), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 35.59-53.47] |
...
| TOTAL | ssp126 | 2100 | spread_vs_lit | 1.816 x lit spread | **PASS** | ours 60.93 cm vs model-based lit 25.25-49.52 (median 33.55, n=7); ALL comparators 25.25-107.65 |
| TOTAL | ssp126 | 2150 | median_vs_lit | 0.688 x lit median | **WARN** | ours 45.48 cm vs lit 45.94-74.90 (median 66.11), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 45.94-83.12] |
...
| TOTAL | ssp126 | 2150 | spread_vs_lit | 1.796 x lit spread | **PASS** | ours 104.69 cm vs model-based lit 53.31-79.31 (median 58.29, n=4); ALL comparators 53.31-200.59 |
...
| TOTAL | ssp126 | 2300 | spread_vs_lit | 2.015 x lit spread | **WARN** | ours 234.99 cm vs model-based lit 116.60-116.60 (median 116.60, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2100 | median_vs_lit | 0.924 x lit median | **PASS** | ours 49.45 cm vs lit 48.68-57.10 (median 53.51), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 48.68-67.90] |
...
| TOTAL | ssp245 | 2100 | spread_vs_lit | 1.396 x lit spread | **PASS** | ours 73.51 cm vs model-based lit 32.00-60.35 (median 52.65, n=7); ALL comparators 32.00-146.33 |
| TOTAL | ssp245 | 2150 | median_vs_lit | 1.110 x lit median | **PASS** | ours 103.39 cm vs lit 80.04-105.22 (median 93.13), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 80.04-111.19] |
...
| TOTAL | ssp245 | 2150 | spread_vs_lit | 1.389 x lit spread | **WARN** | ours 145.44 cm vs model-based lit 59.41-382.80 (median 104.68, n=4); ALL comparators 59.41-382.80; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 1xhigh/2xin/1xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp245 | 2300 | median_vs_lit | 1.326 x lit median | **WARN** | ours 247.61 cm vs lit 186.77-186.77 (median 186.77), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp245 | 2300 | spread_vs_lit | 1.072 x lit spread | **PASS** | ours 364.04 cm vs model-based lit 339.75-339.75 (median 339.75, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary |
| TOTAL | ssp585 | 2100 | median_vs_lit | 1.259 x lit median | **WARN** | ours 99.99 cm vs lit 64.93-97.85 (median 79.41), n_lit=7 [1 SEJ comparator(s) excluded from the score; full range 64.93-97.85] |
...
| TOTAL | ssp585 | 2100 | spread_vs_lit | 1.252 x lit spread | **PASS** | ours 88.04 cm vs model-based lit 41.09-106.79 (median 70.33, n=7); ALL comparators 41.09-197.47 |
| TOTAL | ssp585 | 2150 | median_vs_lit | 0.993 x lit median | **PASS** | ours 205.96 cm vs lit 117.08-310.66 (median 207.31), n_lit=4 [1 SEJ comparator(s) excluded from the score; full range 117.08-310.66] |
...
| TOTAL | ssp585 | 2150 | spread_vs_lit | 0.548 x lit spread | **WARN** | ours 151.85 cm vs model-based lit 77.93-414.71 (median 277.00, n=4); ALL comparators 77.93-631.59; ⚠ THE COMPARATORS DO NOT AGREE -- scored one at a time they give 2xin/2xlow and the median's 'in' is not a majority, so the median is not a summary here; verdict CAPPED at WARN |
| TOTAL | ssp585 | 2300 | median_vs_lit | 0.478 x lit median | **WARN** | ours 485.57 cm vs lit 1015.98-1015.98 (median 1015.98), n_lit=1 ⚠ n_lit=1 < 3: a median of so few is not a summary; verdict CAPPED at WARN |
...
| TOTAL | ssp585 | 2300 | spread_vs_lit | 0.311 x lit spread | **WARN** | ours 429.28 cm vs model-based lit 1379.10-1379.10 (median 1379.10, n=1); ⚠ n=1 < 3 comparators WITH A BAND, so this median is not a summary; verdict CAPPED at WARN |

## [P] Levels — every arm side by side (cm)

| module | ssp | horizon | candidate (joint) | champion (joint) | BRICK 2.0 (fixed) |
|---|---|---|---|---|---|
| AIS | ssp126 | 2100 | 4.59 | 4.29 | 4.21 |
| AIS | ssp126 | 2150 | 7.00 | 6.53 | 6.37 |
| AIS | ssp126 | 2300 | 13.67 | 12.67 | 12.64 |
| AIS | ssp245 | 2100 | 8.78 | 5.51 | 29.21 |
| AIS | ssp245 | 2150 | 46.14 | 11.16 | 74.53 |
| AIS | ssp245 | 2300 | 158.43 | 79.23 | 207.88 |
| AIS | ssp585 | 2100 | 42.90 | 35.05 | 48.98 |
| AIS | ssp585 | 2150 | 102.18 | 92.13 | 104.07 |
| AIS | ssp585 | 2300 | 303.11 | 277.34 | 290.17 |
| glaciers | ssp126 | 2100 | 7.70 | 7.73 | 12.00 |
| glaciers | ssp126 | 2150 | 9.43 | 9.42 | 17.18 |
| glaciers | ssp126 | 2300 | 11.91 | 11.80 | 27.26 |
| glaciers | ssp245 | 2100 | 9.73 | 9.77 | 13.48 |
| glaciers | ssp245 | 2150 | 13.47 | 13.49 | 20.82 |
| glaciers | ssp245 | 2300 | 18.22 | 18.19 | 32.41 |
| glaciers | ssp585 | 2100 | 13.86 | 14.00 | 16.47 |
| glaciers | ssp585 | 2150 | 21.39 | 21.45 | 27.14 |
| glaciers | ssp585 | 2300 | 27.13 | 27.01 | 35.20 |
| Greenland | ssp126 | 2100 | 6.26 | 6.25 | 6.60 |
| Greenland | ssp126 | 2150 | 7.55 | 7.58 | 9.92 |
| Greenland | ssp126 | 2300 | 9.43 | 9.47 | 18.79 |
| Greenland | ssp245 | 2100 | 8.23 | 8.19 | 7.09 |
| Greenland | ssp245 | 2150 | 11.96 | 11.96 | 11.43 |
| Greenland | ssp245 | 2300 | 17.04 | 17.12 | 23.76 |
| Greenland | ssp585 | 2100 | 13.43 | 13.35 | 8.24 |
| Greenland | ssp585 | 2150 | 27.18 | 26.99 | 15.57 |
| Greenland | ssp585 | 2300 | 47.25 | 47.48 | 40.35 |
| thermal exp. | ssp126 | 2100 | 13.66 | 13.51 | 13.76 |
| thermal exp. | ssp126 | 2150 | 17.03 | 16.88 | 17.22 |
| thermal exp. | ssp126 | 2300 | 22.27 | 22.08 | 22.80 |
| thermal exp. | ssp245 | 2100 | 17.89 | 17.73 | 18.03 |
| thermal exp. | ssp245 | 2150 | 26.51 | 26.26 | 26.68 |
| thermal exp. | ssp245 | 2300 | 41.01 | 40.67 | 42.05 |
| thermal exp. | ssp585 | 2100 | 26.83 | 26.60 | 27.05 |
| thermal exp. | ssp585 | 2150 | 49.43 | 49.06 | 49.95 |
| thermal exp. | ssp585 | 2300 | 99.03 | 98.47 | 100.22 |
...
| TOTAL | ssp126 | 2100 | 34.98 | 34.33 | 39.24 |
| TOTAL | ssp126 | 2150 | 45.48 | 44.64 | 55.17 |
| TOTAL | ssp126 | 2300 | 65.82 | 64.44 | 91.18 |
| TOTAL | ssp245 | 2100 | 49.45 | 44.92 | 70.87 |
| TOTAL | ssp245 | 2150 | 103.39 | 71.57 | 137.98 |
| TOTAL | ssp245 | 2300 | 247.61 | 162.84 | 317.51 |
| TOTAL | ssp585 | 2100 | 99.99 | 92.45 | 104.68 |
| TOTAL | ssp585 | 2150 | 205.96 | 195.59 | 202.83 |
| TOTAL | ssp585 | 2300 | 485.57 | 461.72 | 482.40 |

## [S] Scenario separation — ssp585/ssp126 median ratio

| module | horizon | ours | verdict | literature |
|---|---|---|---|---|
| AIS | 2100 | 9.34x | **PASS** | FACTS 0.63-3.20 (n=5); MAGICC-SLR 10.69-10.69 (n=1) |
| AIS | 2150 | 14.60x | **PASS** | FACTS 0.48-7.55 (n=4); MAGICC-SLR 28.79-28.79 (n=1) |
| AIS | 2300 | 22.17x | **WARN** | MAGICC-SLR 81.77-81.77 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| glaciers | 2300 | 2.28x | **WARN** | MAGICC-SLR 2.11-2.11 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
| Greenland | 2100 | 2.14x | **PASS** | FACTS 1.55-2.33 (n=3); MAGICC-SLR 2.11-2.11 (n=1) |
| Greenland | 2150 | 3.60x | **PASS(edge)** | FACTS 1.72-2.07 (n=2); MAGICC-SLR 3.48-3.48 (n=1); 0.12 outside the bracket = 7% of its own range |
| Greenland | 2300 | 5.01x | **WARN** | MAGICC-SLR 7.54-7.54 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| thermal exp. | 2300 | 4.45x | **WARN** | MAGICC-SLR 6.18-6.18 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |
...
| TOTAL | 2100 | 2.86x | **PASS(edge)** | FACTS 1.63-2.23 (n=7); MAGICC-SLR 2.75-2.75 (n=1); 0.11 outside the bracket = 10% of its own range |
| TOTAL | 2150 | 4.53x | **PASS** | FACTS 1.94-4.15 (n=4); MAGICC-SLR 5.72-5.72 (n=1) |
| TOTAL | 2300 | 7.38x | **WARN** | MAGICC-SLR 15.28-15.28 (n=1)  [NO UPPER COMPARATOR AT THIS HORIZON] |

---

*Machine-readable: `outputs/bench_ladrillo_L18.csv`. Regenerate: `python python/bench_ladrillo.py --tag=L18`.*
