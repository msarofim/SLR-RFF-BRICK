...
SUPERSEDED 2026-08-10 by python/ladrillo_data.py, which does the same job as a
readable module with no exec-prefix chain. python/test_ladrillo_data.py asserts
the two produce byte-identical artifacts, so this file is kept only as
provenance for how they were originally generated — build from ladrillo_data.py.
