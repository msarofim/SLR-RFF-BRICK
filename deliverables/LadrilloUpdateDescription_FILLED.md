...
Two features of FIGs 2–4 and 7 are worth highlighting. MAGICC-SLR's Greenland band for the Low-to-Negative scenario reaches 144 cm at 2300 (95th percentile) compared to 25 cm for the Low scenario, although the medians are 13 and 14 cm: for MAGICC's own climate the Low-to-Negative scenario cools below preindustrial by 2300, and MAGICC's Greenland surface-mass-balance parameterisation, fitted for warming, turns positive there — the members with the strongest cooling (−1.5 to −2 K) give the largest Greenland melt (up to +343 cm from surface mass balance alone). And only part of FACTS responds to the climate after 2100: its thermal expansion, AR5 glacier and LARMIP Antarctic modules do, and the AR5 Antarctic surface mass balance does; but its Greenland module (FittedISMIP) extrapolates the 2080–2100 rate linearly to 2300, the AR5 Antarctic dynamics term is a prescribed function of time, and the DeConto and Bamber modules choose their projections from the temperature integrated over 2000–2099 (High and High-to-Low give identical Antarctic values at 2300). At 2150 and 2300, therefore, FACTS is a climate-responsive comparator for thermal expansion, glaciers and the LARMIP Antarctic module only.
