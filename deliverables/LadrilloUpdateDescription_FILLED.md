...
Two features of FIGs 2–4 and 7 are properties of the comparators rather than of the climate response. MAGICC-SLR's Greenland band at the Low-to-Negative marker reaches 144 cm at 2300 (95th percentile) against 25 cm at the Low marker, although the medians are 13 and 14 cm: on MAGICC's own climate that marker cools below preindustrial by 2300 in 597 of 600 members, and MAGICC's Greenland surface-mass-balance parameterisation, fitted for warming, turns positive there — the members with the strongest cooling (−1.5 to −2 K) give the largest Greenland rise (up to +343 cm from surface mass balance alone). And the FACTS DeConto and Bamber modules select their projections from the integrated 2000–2099 temperature, so their post-2100 values do not respond to the climate path after 2100 (High and High-to-Low give identical Antarctic values at 2300).
...
**Low scenarios.** Ladrillo sits at the low end of the comparison set on level — at vvVL its 2300 total median is 58 cm, above only MAGICC-SLR's 46 cm and below BRICK 2.0's 81 and the FACTS workflows' 107–190. On spread it is narrower than BRICK 2.0 on every component, and narrower than every FACTS module on glaciers, Greenland and thermal expansion; at Antarctica the LARMIP and DeConto modules are narrower (5–95% widths of 103 and 113 cm against Ladrillo's 134). MAGICC-SLR is the narrow outlier throughout (2300 total 5–95% width 67 cm against Ladrillo's 163, BRICK 2.0's 182 and 144–561 across the FACTS workflows).
