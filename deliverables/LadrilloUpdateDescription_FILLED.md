...
**FAST — 13 other RGI regions.** Ice volume at 2000: 9.4 ± 2.4 cm SLE. Smaller, faster-responding bodies with weak amplification (prior 1.45). It equilibrates quickly enough that its committed volume is close to its realised volume through most of the record.
...
**Compared with BRICK 2.0 and MAGICC.** BRICK 2.0 and Ladrillo now have completely different glacier modules. MAGICC and Ladrillo both use the formulation from Nauels 2017 Eq. 3; where they differ is the three regions used in Ladrillo. MAGICC's committed 1850 melt is 2.8–13.6 cm, Ladrillo's 6.3–14.6 cm. The two models also start from different total glacier inventories. BRICK 2.0's calibrated initial volume, at its 1850 start, centres on 42 cm SLE (5–95% 32–52), inherited from Wigley and Raper (2005), whose assumed initial volume is 40 cm (2σ 30–50). 38 cm remain in 2000 after 4 cm of melt; Ladrillo constrains the remaining glacier ice at 2000 to 29.0 ± 6.0 cm SLE on its target scope (Farinotti 2019 excluding RGI region 5, with Millan 2022 agreeing). The full-RGI Farinotti value is 32.4 ± 8.4 cm. Other emulators' inventories at 2000: FACTS's AR5 glacier module caps cumulative melt at 31.6 cm SLE, which every SSP5-8.5 sample reaches by 2300; MAGICC's equilibrium curves imply roughly 26–36 cm across their 15 tunes, net of its own 9.4 cm of melt over 1850–2000. These figures are not on a single scope, since not every model covers all 19 RGI regions — MAGICC's Marzeion 2012 basis omits the Antarctic periphery (RGI 19) and Ladrillo the Greenland periphery (RGI 05) — so small differences between them should not be over-read.
