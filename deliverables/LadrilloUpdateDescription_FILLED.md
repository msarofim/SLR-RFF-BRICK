...
| Glacier inventory (cm SLE) and its epoch | 42 at 1850⁷ | 31.6 at ~2000⁸ | n.d. | 35.6–45.1 at 1850 (≈26–36 at 2000)⁹ | n.d. | n.d. | 50, preindustrial | 29.0 ± 6.0 at 2000¹⁰ |
...
⁷ Initial volume at the model start; Wigley–Raper assumed maximum 41. ⁸ Cumulative-melt cap from AR5 Table 4.2, less the Antarctic periphery. ⁹ Across the 15 glacier tunes; MAGICC's own 1850–2000 melt is 9.4 cm (5–95% 4.7–13.2), so the 2000-basis range is approximate. ¹⁰ Farinotti 2019 on Ladrillo's scope, which excludes RGI 05 (3.4 cm, carried in the Greenland mask). ¹¹ Two channels (SMB, discharge) in each of two basins. ¹² AR5 (parametric), LARMIP (response functions), DeConto (sampled), Bamber (expert judgement).
